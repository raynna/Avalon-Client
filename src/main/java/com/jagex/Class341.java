package com.jagex;/* com.jagex.Class341 - Decompiled by JODE
...
public class Class341 {
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = GameClient.aBooleanArray8950[i_4_] ? 1 : 0;
	    else
	...
	try {
		...
		i_24_ += 15;
		long l_28_ = GameClient.aClass25_8711.aClass124_340.method1384(1026179047);
		String string = "N/A";
		if (-1L != l_28_) {
		...
		Class343.aClass264_3673.method2474(new StringBuilder().append("Game: In:").append(-1705791507 * GameClient.aClass25_8711.anInt343).append("B/s ").append("Out:").append(GameClient.aClass25_8711.anInt327 * 1114720205).append("B/s ").append("Ping:").append(string).toString(), i_23_, i_24_, -256, -1, (byte) -47);
		i_24_ += 15;
		long l_29_ = GameClient.aClass25_8693.aClass124_340.method1384(529918549);
		...
		Class343.aClass264_3673.method2474(new StringBuilder().append("Lobby: In:").append(GameClient.aClass25_8693.anInt343 * -1705791507).append("B/s ").append("Out:").append(1114720205 * GameClient.aClass25_8693.anInt327).append("B/s ").append("Ping:").append(string_30_).toString(), i_23_, i_24_, -256, -1, (byte) -30);
		i_24_ += 15;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("of.com.jagex.i(").append(')').toString());
	}
    }
