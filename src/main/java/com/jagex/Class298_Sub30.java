package com.jagex;/* com.jagex.Class298_Sub30 - Decompiled by JODE
...
public class Class298_Sub30 extends Class298 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("abo.com.jagex.a(").append(')').toString());
	}
    }
