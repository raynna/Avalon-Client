package com.jagex;/* com.jagex.Class116 - Decompiled by JODE
...
public class Class116 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("es.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		for (int i_10_ = 0; i_10_ < class365_sub1_sub1_sub2.anIntArray10092.length; i_10_++) {
			...
			if (-1073741824 == (i_11_ & ~0x3fffffff)) {
			    ...
			    Player class365_sub1_sub1_sub2_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_19_]);
			    ...
			    Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(i_11_));
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2640((byte) 54).method4324(286817156);
