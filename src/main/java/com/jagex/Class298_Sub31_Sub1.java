package com.jagex;/* com.jagex.Class298_Sub31_Sub1 - Decompiled by JODE
...
public abstract class Class298_Sub31_Sub1 extends Class298_Sub31 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("afb.com.jagex.i(").append(')').toString());
	}
    }
