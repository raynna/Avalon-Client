...
public class Shortcut implements Interface19 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ov.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = GameClient.aClass283_8716.method2641(-1837734772).getObjectDefinitions(i_10_).method5770(i_11_, class497.aString6101, 1595133323);
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = (GameClient.aClass283_8716.method2641(767453715).getObjectDefinitions(i_10_).method5776(i_11_, class497.anInt6100 * -388931549, (byte) 2));
	}
	catch (RuntimeException runtimeexception) {
