package com.jagex;/* com.jagex.Class82_Sub12 - Decompiled by JODE
...
public class Class82_Sub12 extends Class82 {
	...
	try {
	    if (GameClient.aBoolean8835 && (-112110875 * Class298.anInt3192 & 0x18) != 0) {
		boolean bool = false;
		int i_0_ = 1168366243 * Class10.anInt129;
		int[] is = Class10.anIntArray135;
		for (int i_1_ = 0; i_1_ < i_0_; i_1_++) {
		    Player class365_sub1_sub1_sub2_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_1_]]);
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.INTERFACE_ON_PLAYER, (GameClient.aClass25_8711.aClass449_330), (byte) 25);
