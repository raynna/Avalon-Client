package com.jagex;/* com.jagex.Class445 - Decompiled by JODE
...
public class Class445 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sj.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		//class_ra.B(com.jagex.Class462.anInt5683 * -2110394505 - 16, i_5_, 12, i_4_, com.jagex.Class8.anInt98 * 256666041 << 24 | 0xFF99FF, 4);
		...
		int i_10_ = -1;
		if (443738891 * GameClient.ticketCycle % 30 > 15)
		    i_10_ = 16777215;
