package com.jagex;/* com.jagex.Class205 - Decompiled by JODE
...
public class Class205 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("iq.com.jagex.a(").append(')').toString());
	}
    }
