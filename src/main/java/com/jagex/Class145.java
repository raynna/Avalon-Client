package com.jagex;/* com.jagex.Class145 - Decompiled by JODE
...
public class Class145 implements Interface5 {
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.anInt8844 * 827374123;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -548972447 * GameClient.anInt8952;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		return false;
	    int i_4_ = GameClient.aClass283_8716.method2629(-2086391246);
	    int i_5_ = GameClient.aClass283_8716.method2630(-867392122);
	    Class244 class244 = GameClient.aClass283_8716.method2654(-202336440);
	    ...
	    GameClient.aClass283_8716.method2640((byte) 105).method4326((byte) -128);
		...
		for (int i_21_ = i_8_; i_21_ < i_5_ + i_8_; i_21_ += i_6_) {
		    ...
		    if (Class3.aBoolean65) {
			Class289 class289 = GameClient.aClass283_8716.getSceneClipDataPlane(i);
	    ...
	    Class433 class433 = GameClient.aClass283_8716.method2641(-106767927);
	    Class3.anInt67 = 0;
		...
		for (int i_42_ = i_7_; i_42_ < i_4_ + i_7_; i_42_++) {
			...
			for (int i_44_ = i; i_44_ <= 1 + i && i_44_ <= 3; i_44_++) {
				...
				if (interface3 == null)
				    interface3 = ((Interface3) (class331.method4035(i_44_, i_42_, i_43_, GameClient.anInterface17_8960, -858481229)));
				if (interface3 == null)
				...
				if (interface3 != null) {
					...
					if (i_45_ >= 0) {
					    ...
					    int i_50_ = i_43_;
					    if (bool_48_) {
						int[][] is_51_ = (GameClient.aClass283_8716.getSceneClipDataPlane(i_44_).anIntArrayArray3155);
						int i_52_ = ((GameClient.aClass283_8716.getSceneClipDataPlane(i_44_).anInt3151) * 1487776559);
						int i_53_ = ((GameClient.aClass283_8716.getSceneClipDataPlane(i_44_).anInt3152) * 1415525851);
		...
		MapKeys class296 = GameClient.aClass283_8716.method2631(1336735501);
		if (null != class296) {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("fw.com.jagex.i(").append(')').toString());
	}
    }
}
