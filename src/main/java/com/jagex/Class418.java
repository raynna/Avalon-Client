package com.jagex;/* com.jagex.Class418 - Decompiled by JODE
...
public final class Class418 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ri.com.jagex.h(").append(')').toString());
	}
    }
