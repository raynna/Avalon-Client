package com.jagex;/* com.jagex.Class277 - Decompiled by JODE
...
public class Class277 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("lm.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) GameClient.aFloat8949 >> 3;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (0 == type)
		packet = Class18.method359(OutcommingPacket.WALKING_PACKET, GameClient.aClass25_8711.aClass449_330, (byte) 51);
	    if (type == 1)
		packet = Class18.method359(OutcommingPacket.MINI_WALKING_PACKET, GameClient.aClass25_8711.aClass449_330, (byte) 28);
