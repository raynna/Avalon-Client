...
public abstract class Entity extends Class365_Sub1_Sub1 {
	...
	try {
		...
		GameClient.method2800(aClass119_10131, aClass119_10131.method1295((byte) 20), -1, i, i_0_, i_1_, i_2_, i_3_, i_4_, i_5_, i_6_);
	}
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("akn.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("akn.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    if (null != aClass331_7722 && i_48_ >= 1 && i_49_ >= 1 && i_48_ <= GameClient.aClass283_8716.method2629(-2008930035) - 1 && i_49_ <= GameClient.aClass283_8716.method2630(-33342416) - 1) {
	...
	if (null != aClass331_7722 && i_111_ >= 1 && i_112_ >= 1 && i_111_ <= GameClient.aClass283_8716.method2629(-2022187323) - 1 && i_112_ <= GameClient.aClass283_8716.method2630(1908645218) - 1) {
	...
	if (null != aClass331_7722 && i_113_ >= 1 && i_114_ >= 1 && i_113_ <= GameClient.aClass283_8716.method2629(-2141154955) - 1 && i_114_ <= GameClient.aClass283_8716.method2630(145346949) - 1) {
	...
	try {
		...
		if ((this.aClass351_10067 == null || (this.aClass351_10067.aBoolean3772)) && (i_127_ > 0 || i_129_ > 0))
		    this.aClass351_10067 = Class351.method4232(GameClient.ticketCycle * 443738891, true);
		if (this.aClass351_10067 != null) {
		    ...
		    this.aClass351_10067.method4231(class_ra, 443738891 * GameClient.ticketCycle, class85s_133_, class68s_137_, false);
		    this.aBoolean10128 = true;
		}
	    } else if (this.aClass351_10067 != null)
		this.aClass351_10067.method4233(GameClient.ticketCycle * 443738891);
