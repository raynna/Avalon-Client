package com.jagex;/* com.jagex.Class143 - Decompiled by JODE
...
public class Class143 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("fu.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    byte[][][] is = GameClient.aClass283_8716.method2642(1330177323);
	    byte i_5_ = (bool ? (byte) 1 : (byte) (-1953789277 * GameClient.anInt8777 & 0xff));
	    if (i_5_ == is[1855729883 * Class99.anInt952][i_2_][i_3_])
		return false;
	    Class244 class244 = GameClient.aClass283_8716.method2654(-334353018);
		...
		if (bool_14_) {
		    int i_24_ = GameClient.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[1855729883 * Class99.anInt952 + 1].method6341(i_8_, i_11_, (byte) -36);
		...
		if (bool_13_) {
		    ...
		    if (++i_11_ < GameClient.aClass283_8716.method2630(-1603394405)) {
			...
			if ((1 + i_8_ < GameClient.aClass283_8716.method2629(-1968040539)) && i_5_ != (is[Class99.anInt952 * 1855729883][1 + i_8_][i_11_]) && ((class244.aByteArrayArrayArray2731[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) == 0 && ((class244.aByteArrayArrayArray2731[1855729883 * Class99.anInt952][1 + i_8_][i_11_ - 1]) & 0x4) == 0) {
		    ...
		    i_11_--;
		    if ((1 + i_8_ < GameClient.aClass283_8716.method2629(-1881854697)) && i_5_ != (is[1855729883 * Class99.anInt952][i_8_ + 1][i_11_])) {
			...
			if ((1 + i_8_ < GameClient.aClass283_8716.method2629(-1909288528)) && (is[1855729883 * Class99.anInt952][i_8_ + 1][i_11_]) != i_5_ && ((class244.aByteArrayArrayArray2731[Class99.anInt952 * 1855729883][i_8_][i_11_]) & 0x4) == 0 && ((class244.aByteArrayArrayArray2731[Class99.anInt952 * 1855729883][i_8_ + 1][i_11_ + 1]) & 0x4) == 0) {
