package com.jagex;
/* com.jagex.Class242_Sub1 - Decompiled by JODE
...
public class Class242_Sub1 extends Class242 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aaz.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aaz.com.jagex.m(").append(')').toString());
	}
    }
	...
	try {
	    for (Class298 class298 = GameClient.aClass437_8896.method5816(2109381941); null != class298; class298 = GameClient.aClass437_8896.method5815((byte) -58)) {
	...
	try {
	    ...
	    Class346.method4172(url, bool, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-1851684401) == 5, GameClient.aBoolean8867, GameClient.aBoolean8651, (byte) 49);
	}
	catch (RuntimeException runtimeexception) {
