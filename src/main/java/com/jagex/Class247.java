package com.jagex;
/* com.jagex.Class247 - Decompiled by JODE
...
public abstract class Class247 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ki.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ki.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		if (18 == -1233866115 * GameClient.anInt8752) {
	...
	try {
		...
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_1994, GameClient.aClass25_8711.aClass449_330, (byte) 79);
		class298_sub36.out.writeShort(2089055308 * GameClient.anInt8687, 16711935);
		for (int i_9_ = 0; i_9_ < GameClient.anInt8687 * -1625219821; i_9_++) {
		    Interface16 interface16 = GameClient.anInterface16Array8688[i_9_];
		...
		GameClient.aClass25_8711.method390(class298_sub36, (byte) -79);
	    }
	    if (ClientScriptsExecutor.anInt4120 * -2116412357 > 0)
		ClientScriptsExecutor.anInt4120 -= -1604952845;
	    if (GameClient.aBoolean8763 && ClientScriptsExecutor.anInt4120 * -2116412357 <= 0) {
		ClientScriptsExecutor.anInt4120 = -2034285828;
		GameClient.aBoolean8763 = false;
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.MOVE_CAMERA_PACKET, GameClient.aClass25_8711.aClass449_330, (byte) 50);
		class298_sub36.out.writeShort128((int) GameClient.aFloat8757 >> 3);
		class298_sub36.out.writeShortLE((int) GameClient.aFloat8949 >> 3, 1908840395);
		GameClient.aClass25_8711.method390(class298_sub36, (byte) -20);
	    }
		...
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2063, GameClient.aClass25_8711.aClass449_330, (byte) 90);
		class298_sub36.out.writeByte(Class422_Sub7.aBoolean8385 ? 1 : 0);
		GameClient.aClass25_8711.method390(class298_sub36, (byte) -44);
	    }
	    if (!GameClient.aBoolean8666) {
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2003, GameClient.aClass25_8711.aClass449_330, (byte) 9);
		...
		GameClient.aClass25_8711.method390(class298_sub36, (byte) -84);
