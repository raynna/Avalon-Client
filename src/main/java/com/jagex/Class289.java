package com.jagex;/* com.jagex.Class289 - Decompiled by JODE
...
public class Class289 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("lz.com.jagex.i(").append(')').toString());
	}
    }
