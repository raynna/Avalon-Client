package com.jagex;
/* com.jagex.Class255 - Decompiled by JODE
...
public class Class255 implements Runnable {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kr.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kr.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.aCalendar8758.setTime(new Date(Class122.method1319((byte) 1)));
