...
public class IPAddress {
	...
	try {
	    ...
	    return new Socket(InetAddress.getByName((Loader.hosted ? Loader.IP : "localhost")), Loader.PORT);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tk.com.jagex.a(").append(')').toString());
	}
    }
    ...
    /* static final void method6059(com.jagex.Class403 class403, int com.jagex.i) {
    try {
        int i_1_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
        class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (com.jagex.Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_1_).anInt5721) * 785788887;
    }
    catch (RuntimeException runtimeexception) {
        throw com.jagex.Class346.method4175(runtimeexception, new StringBuilder().append("tk.aad(").append(')').toString());
    }
    }*/
