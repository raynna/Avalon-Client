package com.jagex;/* com.jagex.Class298_Sub32_Sub26 - Decompiled by JODE
...
public class Class298_Sub32_Sub26 extends Class298_Sub32 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aho.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		if (class298_sub51 != null && !class298_sub51.method3573(364199740))
		    ...
		    GameClient.method2800(class119, class119.method1295((byte) -55), -1, i_258_, i_259_, i_260_, i_261_, i_262_, i_263_, i_264_, i_265_);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
