package com.jagex;
/* com.jagex.Class481_Sub1 - Decompiled by JODE
...
public class Class481_Sub1 extends Class481 {
	...
	try {
		...
		try {
		    ...
		    Method method = (var_class.getDeclaredMethod("getProxyAuth", new Class[] { String.class, Integer.TYPE }));
			...
			if (((Boolean) method_6_.invoke(object, new Object[0])).booleanValue()) {
			    ...
			    Method method_8_ = (var_class.getDeclaredMethod("getHeaderValue", (new Class[] { URL.class, String.class })));
