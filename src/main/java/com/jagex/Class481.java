package com.jagex;
/* com.jagex.Class481 - Decompiled by JODE
...
public abstract class Class481 {
	...
	try {
	    RsBitsBuffer stream = GameClient.aClass25_8711.aClass298_Sub53_Sub2_333;
	    for (int i_0_ = 0; i_0_ < GameClient.anInt8808 * -976358333; i_0_++) {
		int npcIndex = GameClient.anIntArray8706[i_0_];
		NPC npc = ((NPC) (((Class298_Sub29) GameClient.aClass437_8696.method5812(npcIndex)).anObject7366));
		...
		if ((mask & 0x80000) != 0) { // Unidentified - ordinal 2
		    ...
		    npc.anInt10105 = ((GameClient.ticketCycle * 443738891 + stream.readUnsignedShortLE128(1478539457)) * 1828453179);
		    npc.anInt10106 = ((GameClient.ticketCycle * 443738891 + stream.readUnsignedShortLE128(1478539457)) * -473408095);
		}
		...
		if (0 != (mask & 0x4)) { // Hit ? ordinal 7
			...
			for (int i_11_ = 0; i_11_ < i_10_; i_11_++) {
			    ...
			    npc.method4420(i_15_, i_13_, i_12_, i_14_, GameClient.ticketCycle * 443738891, i_16_, i_17_, (byte) 6);
			}
		    }
		}
		...
		if ((mask & 0x2000000) != 0) { // com.jagex.Graphics 4 ordinal 9
		...
		if ((mask & 0x40) != 0) { // com.jagex.Graphics 1 ordinal 10
		...
		if ((mask & 0x100) != 0) { // com.jagex.Graphics 2 ordinal 11
		...
		if ((mask & 0x400) != 0) {// ordinal 13 other bar thing
		    ...
		    npc.anInt10086 = (npc.anInt10088 * 1195117671 + (GameClient.ticketCycle * 1208636921 + (-1132907677 * npc.anInt10087)));
		}
		...
		if ((mask & 0x800) != 0) {// Force movement ordinal 15
		    ...
		    npc.anInt10095 = (stream.readUnsignedShortLE((byte) -54) + 443738891 * GameClient.ticketCycle) * 996079737;
		    npc.anInt10103 = (stream.readUnsignedShortLE128(1478539457) + GameClient.ticketCycle * 443738891) * 1000906529;
		...
		if (0 != (mask & 0x1000000)) { // com.jagex.Graphics 3 ordinal 17
		    int graphicId = stream.readUnsignedShortLE128(1478539457);
		...
		if ((mask & 0x1) != 0) {// Transform com.jagex.NPC id - ordinal 22
