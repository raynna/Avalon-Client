package com.jagex;/* com.jagex.Class346 - Decompiled by JODE
...
public class Class346 {
	...
	try {
		...
		Player class365_sub1_sub1_sub2_sub2 = GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_5_]];
		if (null != class365_sub1_sub1_sub2_sub2 && class365_sub1_sub1_sub2_sub2.method4477(526198823) && !class365_sub1_sub1_sub2_sub2.hidden && (class365_sub1_sub1_sub2_sub2 != Class287.myPlayer) && (class365_sub1_sub1_sub2_sub2.plane == (Class287.myPlayer.plane))) {
			...
			if (class365_sub1_sub1_sub2_sub2.aString10195.equals(GameClient.aStringArray8704[i_8_]) && GameClient.anIntArray8946[i_8_] != 0) {
			    bool = true;
			    break;
			}
		    }
	...
	try {
	    ...
	    throw method4175(runtimeexception, new StringBuilder().append("ol.com.jagex.a(").append(')').toString());
	}
    }
