package com.jagex;/* com.jagex.Class480 - Decompiled by JODE
...
public class Class480 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tu.com.jagex.a(").append(')').toString());
	}
    }
