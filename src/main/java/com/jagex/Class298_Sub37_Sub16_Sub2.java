package com.jagex;/* com.jagex.Class298_Sub37_Sub16_Sub2 - Decompiled by JODE
...
public class Class298_Sub37_Sub16_Sub2 extends Class298_Sub37_Sub16 {
    ...
    @Override
    byte[] method3469() {
	if (this.aBoolean9670)
	    throw new RuntimeException();
	return this.aByteArray10011;
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aks.com.jagex.a(").append(')').toString());
	}
    }
