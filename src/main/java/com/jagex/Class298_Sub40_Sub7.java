package com.jagex;/* com.jagex.Class298_Sub40_Sub7 - Decompiled by JODE
...
public class Class298_Sub40_Sub7 extends Class298_Sub40 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("agm.com.jagex.a(").append(')').toString());
	}
    }
