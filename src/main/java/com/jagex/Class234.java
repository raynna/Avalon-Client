package com.jagex;
/* com.jagex.Class234 - Decompiled by JODE
...
public class Class234 {
	...
	try {
		...
		i = i != -1 ? i : GameClient.anInt8937 * -1808468501;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jw.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.GRAND_EXCHANGE_SLOTS[i_11_].anInt2768 * 535421071;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		PathStrategy.method4093((GameClient.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3518), 234916861);
		if ((GameClient.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3520) != null)
		    PathStrategy.method4093((GameClient.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3520), -1747837187);
		Class21.aBoolean274 = true;
	    }
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jw.com.jagex.a(").append(')').toString());
	}
    }
