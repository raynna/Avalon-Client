package com.jagex;/* com.jagex.Class507 - Decompiled by JODE
...
public class Class507 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("uy.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("uy.com.jagex.i(").append(')').toString());
	}
    }
