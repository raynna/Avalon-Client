package com.jagex;
/* com.jagex.Class323_Sub1 - Decompiled by JODE
...
public final class Class323_Sub1 extends Class323 implements KeyListener, FocusListener {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acn.com.jagex.h(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acn.com.jagex.i(").append(')').toString());
	}
    }
