package com.jagex;/* com.jagex.Class133 - Decompiled by JODE
...
public class Class133 {
	...
	try {
	    ...
	    if (i_4_ < 0)
		i_4_ = 0;
	    else if (i_4_ >= GameClient.aClass283_8716.method2629(-1870653657))
		i_4_ = GameClient.aClass283_8716.method2629(-2106000427);
	    i_5_ -= class341.gameSceneBaseY * 283514611;
	    if (i_5_ < 0)
		i_5_ = 0;
	    else if (i_5_ >= GameClient.aClass283_8716.method2630(787275205))
		i_5_ = GameClient.aClass283_8716.method2630(11403406);
