package com.jagex;/* com.jagex.Class322 - Decompiled by JODE
...
public class Class322 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nk.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    Class152.method1652(Class373.aClass_ra4071, 443738891 * GameClient.ticketCycle);
	    if (-1 != -257444687 * GameClient.WINDOW_PANE_ID)
		Class443.method5884(-257444687 * GameClient.WINDOW_PANE_ID, -333860368);
	    ...
	    GameClient.anInt8832 = GameClient.ticketCycle * -1390800553;
	    ...
	    Class341.method4144((Class287.myPlayer.plane), i_3_ + (int) class217.aFloat2451, (int) class217.aFloat2454 + i_3_, GameClient.anInt8961 * 614680345, (short) 8192);
	    GameClient.anInt8961 = 0;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nk.com.jagex.ia(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nk.com.jagex.m(").append(')').toString());
	}
    }
}
