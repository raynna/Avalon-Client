package com.jagex;/* com.jagex.Class365_Sub1_Sub1_Sub6 - Decompiled by JODE
...
public class Class365_Sub1_Sub1_Sub6 extends Class365_Sub1_Sub1 implements Interface3 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wf.com.jagex.i(").append(')').toString());
	}
    }
	...
	if (null != class454) {
		...
		if (class432.aBoolean5441) {
		    Class287 class287 = GameClient.aClass283_8716.method2632(-1997873817);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wf.com.jagex.a(").append(')').toString());
	}
    }

    static void method4494(GraphicsToolkit class_ra, int i) {
	try {
	    if ((Class287.myPlayer.plane != -1694437021 * Class3.anInt57) && GameClient.aClass283_8716.method2675(-1611682495) != null) {
