...
/* com.jagex.NPCDefinitions - Decompiled by JODE
...
public class NPCDefinitions {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("uu.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("uu.com.jagex.i(").append(')').toString());
	}
    }
