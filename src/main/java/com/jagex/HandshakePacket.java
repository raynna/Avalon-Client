package com.jagex;/* Class211 - Decompiled by JODE
...
public class HandshakePacket {
	...
	try {
	    if (-1233866115 * GameClient.anInt8752 == 14 && (!Class315.method3837((byte) 46) && !Class489.method6167(-391880689)))
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ix.com.jagex.a(").append(')').toString());
	}
    }
}
