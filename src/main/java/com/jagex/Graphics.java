...
/* com.jagex.Graphics - Decompiled by JODE
...
public class Graphics {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("cg.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2032, GameClient.aClass25_8711.aClass449_330, (byte) 26);
		class298_sub36.out.writeInt(-1256171511 * Class300.anInt3207, -1115837876);
		GameClient.aClass25_8711.method390(class298_sub36, (byte) -48);
	...
	try {
		...
		if (shiftDrop && GameClient.shiftDrop) {
		...
		if (Class436.aBoolean5478) {
		    ...
		    if ((bool || bool_45_) && ((1 == 2089115297 * GameClient.anInt8830 && -278777595 * Class436.anInt5506 > 2) || Class58.method694(-1173724343)))
			bool_46_ = true;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("cg.com.jagex.i(").append(')').toString());
	}
    }
