package com.jagex;/* com.jagex.Class249 - Decompiled by JODE
...
public class Class249 implements Interface_ma {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kk.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kk.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		case 708:
		    ...
		    break;
		case 326:
		    GameClient.method2811(class403, -295386469);
		    break;
		case 19:
