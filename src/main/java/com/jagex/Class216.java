package com.jagex;
/* com.jagex.Class216 - Decompiled by JODE
...
public class Class216 implements Interface24 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jc.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jc.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2666(-2101576654);
