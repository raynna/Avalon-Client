package com.jagex;/* com.jagex.Class271 - Decompiled by JODE
...
public class Class271 {
	...
	try {
	    ...
	    interface3 = (Interface3) class331.method4035(i, i_0_, i_1_, GameClient.anInterface17_8960, 664102063);
	    if (interface3 != null)
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("lg.com.jagex.i(").append(')').toString());
	}
    }
