package com.jagex;
/* com.jagex.Class264 - Decompiled by JODE
...
public abstract class Class264 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("l.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("l.com.jagex.h(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("l.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		GameClient.currentPlayer = string;
