package com.jagex;/* com.jagex.Class417 - Decompiled by JODE
...
public class Class417 {
	...
	this.anInt5335 = 752250551 * i;
	this.anInt5336 = i_0_ * 1840099775;
	this.aBoolean5338 = bool;
    }

    public int method5592(int i) {
	try {
	    return 839597631 * this.anInt5336;
	}
	...
	try {
	    return -1521758457 * this.anInt5335;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rh.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class287.method2722(string, -1704738682) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
