package com.jagex;/* com.jagex.Class23 - Decompiled by JODE
...
public class Class23 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ax.com.jagex.h(").append(')').toString());
	}
    }
