package com.jagex;/* com.jagex.Class325 - Decompiled by JODE
...
public class Class325 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("no.com.jagex.a(").append(')').toString());
	}
    }
