package com.jagex;/* com.jagex.Class348 - Decompiled by JODE
...
public final class Class348 {
	...
	try {
		...
		this.anInt3704 += -1044171843 * class298_sub37_sub9.anInt9600;
	    }
	}
	...
	try {
	    int i_0_ = 0;
	    for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) this.aClass461_3703.method5984(1659179977); class298_sub37_sub9 != null; class298_sub37_sub9 = (Class298_Sub37_Sub9) this.aClass461_3703.method5985(1776119940)) {
	...
	try {
	    Class298_Sub37_Sub9 class298_sub37_sub9 = ((Class298_Sub37_Sub9) this.aClass437_3702.method5812(l));
	    if (null == class298_sub37_sub9)
		return null;
		...
		this.anInt3704 += (class298_sub37_sub9.anInt9600 * -1044171843);
		return null;
	    }
		...
		this.aClass437_3702.method5817(class298_sub37_sub9_sub1, class298_sub37_sub9.hash * 7051297995265073167L);
		this.aClass461_3703.method5982(class298_sub37_sub9_sub1, (byte) -4);
		class298_sub37_sub9_sub1.aLong7406 = 0L;
		class298_sub37_sub9.method2839(-1460969981);
		class298_sub37_sub9.method3402(1072331765);
	    } else {
		this.aClass461_3703.method5982(class298_sub37_sub9, (byte) -40);
		class298_sub37_sub9.aLong7406 = 0L;
	    }
	    return object;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("on.com.jagex.a(").append(')').toString());
	}
    }

    public void method4185(Object object, long l, int i, byte i_1_) {
	try {
	    if (i > this.anInt3705 * 2087531591)
		throw new IllegalStateException();
	    method4193(l);
	    this.anInt3704 -= -1846372093 * i;
	    while (1177262507 * this.anInt3704 < 0) {
		Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) this.aClass461_3703.method5983(-2130209329);
	    ...
	    this.aClass437_3702.method5817(class298_sub37_sub9_sub1, l);
	    this.aClass461_3703.method5982(class298_sub37_sub9_sub1, (byte) -108);
	    class298_sub37_sub9_sub1.aLong7406 = 0L;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("on.com.jagex.i(").append(')').toString());
	}
    }

    public void method4186(int i, int i_2_) {
	try {
	    for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) this.aClass461_3703.method5984(-1737359401); class298_sub37_sub9 != null; class298_sub37_sub9 = (Class298_Sub37_Sub9) this.aClass461_3703.method5985(1372068776)) {
		if (class298_sub37_sub9.method3438(504566053)) {
		    ...
		    this.aClass437_3702.method5817(class298_sub37_sub9_sub2, 7051297995265073167L * class298_sub37_sub9.hash);
	...
	try {
	    this.aClass461_3703.method5988(1649887220);
	    this.aClass437_3702.method5811((byte) -88);
	    this.anInt3704 = 1537477589 * this.anInt3705;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.anInt3705 * 2087531591;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) this.aClass461_3703.method5984(-1664121892); null != class298_sub37_sub9; class298_sub37_sub9 = (Class298_Sub37_Sub9) this.aClass461_3703.method5985(-1665993458)) {
	...
	try {
	    Class298_Sub37_Sub9 class298_sub37_sub9 = ((Class298_Sub37_Sub9) this.aClass437_3702.method5816(2018189704));
	    while_82_: do {
		Object object;
		for (;;) {
		    if (null == class298_sub37_sub9)
		    ...
		    class298_sub37_sub9 = (Class298_Sub37_Sub9) this.aClass437_3702.method5815((byte) 18);
		    class298_sub37_sub9_3_.method2839(-1460969981);
		    class298_sub37_sub9_3_.method3402(600406320);
		    this.anInt3704 += -1044171843 * class298_sub37_sub9_3_.anInt9600;
		}
		return object;
	    }
	    while (false);
	...
	try {
	    Class298_Sub37_Sub9 class298_sub37_sub9 = ((Class298_Sub37_Sub9) this.aClass437_3702.method5815((byte) 37));
	    while_83_: do {
		Object object;
		for (;;) {
		    if (null == class298_sub37_sub9)
		    ...
		    class298_sub37_sub9 = (Class298_Sub37_Sub9) this.aClass437_3702.method5815((byte) 35);
		    class298_sub37_sub9_4_.method2839(-1460969981);
		    class298_sub37_sub9_4_.method3402(538286919);
		    this.anInt3704 += -1044171843 * class298_sub37_sub9_4_.anInt9600;
		}
		return object;
	    }
	    while (false);
	...
	try {
	    return this.anInt3704 * 1177262507;
	}
	catch (RuntimeException runtimeexception) {
	...
	this.anInt3705 = i * -1371130505;
	this.anInt3704 = -1846372093 * i;
	int i_6_;
	for (i_6_ = 1; i_6_ + i_6_ < i && i_6_ < i_5_; i_6_ += i_6_) {
	    /* empty */
	}
	this.aClass437_3702 = new HashTable(i_6_);
    }
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2667(458039847);
    ...
    static final void method4198(Class403 class403, int i) {
	try {
