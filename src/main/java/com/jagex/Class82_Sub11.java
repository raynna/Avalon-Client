package com.jagex;/* com.jagex.Class82_Sub11 - Decompiled by JODE
...
public class Class82_Sub11 extends Class82 {
	...
	try {
	    if (577335585 * GameClient.anInt8870 != -1)
		Class70.method803(577335585 * GameClient.anInt8870, this.aString6860, 607881685 * this.anInt6859, 2017220990);
	}
	...
	if (577335585 * GameClient.anInt8870 != -1)
	    Class70.method803(577335585 * GameClient.anInt8870, this.aString6860, 607881685 * this.anInt6859, 1486270976);
    }

    @Override
    public void method869() {
	if (577335585 * GameClient.anInt8870 != -1)
	    Class70.method803(577335585 * GameClient.anInt8870, this.aString6860, 607881685 * this.anInt6859, 1478832260);
    }

    public static final void method906(int i) {
	try {
	    for (int i_0_ = 0; i_0_ < 5; i_0_++)
		GameClient.aBooleanArray8684[i_0_] = false;
	...
	try {
		...
		Class65.aClass264_664 = (Class264) (Class497.aClass197_6105.method1883(GameClient.anInterface10_8700, Class242.anInt2710 * -2085188617, true, true, -2063324548));
		HandshakePacket.aClass505_2420 = (Class497.aClass197_6105.method1879(GameClient.anInterface10_8700, -2085188617 * Class242.anInt2710, -203887938));
