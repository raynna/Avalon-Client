package com.jagex;/* com.jagex.Class422_Sub7 - Decompiled by JODE
...
public class Class422_Sub7 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adh.com.jagex.a(").append(')').toString());
	}
    }
