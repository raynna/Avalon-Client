package com.jagex;
/* com.jagex.Class422_Sub2 - Decompiled by JODE
...
public class Class422_Sub2 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adc.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2667(1422757720);
