package com.jagex;/* com.jagex.Class365_Sub1_Sub1_Sub3 - Decompiled by JODE
...
public class Class365_Sub1_Sub1_Sub3 extends Class365_Sub1_Sub1 {
	...
	try {
		...
		this.aClass351_10137 = Class351.method4232(GameClient.ticketCycle * 443738891, true);
	    if (null != this.aClass351_10137) {
		this.aClass351_10137.method4231(class_ra, 443738891 * GameClient.ticketCycle, class85s, class68s, false);
		this.aClass351_10137.method4227(plane, aShort9798, aShort9796, aShort9795, aShort9797);
	    }
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("akr.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("akr.com.jagex.a(").append(')').toString());
	}
    }
