package com.jagex;/* com.jagex.Class98_Sub4 - Decompiled by JODE
...
public class Class98_Sub4 extends Class98 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("yy.com.jagex.a(").append(')').toString());
	}
    }
