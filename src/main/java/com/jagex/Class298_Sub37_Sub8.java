package com.jagex;/* com.jagex.Class298_Sub37_Sub8 - Decompiled by JODE
...
public class Class298_Sub37_Sub8 extends Class298_Sub37 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ain.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ain.com.jagex.i(").append(')').toString());
	}
    }
