package com.jagex;/* com.jagex.Class163 - Decompiled by JODE
...
public class Class163 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("gq.com.jagex.a(").append(')').toString());
	}
    }

    static final void method1774(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 443738891 * GameClient.ticketCycle;
	}
	catch (RuntimeException runtimeexception) {
