package com.jagex;
/* com.jagex.Class308 - Decompiled by JODE
...
public abstract class Class308 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("mu.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("mu.com.jagex.a(").append(')').toString());
	}
    }
}
