package com.jagex;/* com.jagex.Class298_Sub37_Sub4 - Decompiled by JODE
...
public class Class298_Sub37_Sub4 extends Class298_Sub37 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aih.com.jagex.i(").append(')').toString());
	}
    }
