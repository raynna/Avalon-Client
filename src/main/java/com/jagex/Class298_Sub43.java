package com.jagex;/* com.jagex.Class298_Sub43 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public final class Class298_Sub43 extends Class298 implements Interface16 {
    static int anInt6505 = -1;
    int anInt6506;
    int anInt6507;
    int anInt6508;
    long aLong6509;
	...
	return 122236875 * this.anInt6508;
    }

    @Override
    public int method227(int i) {
	try {
	    return this.anInt6506 * 1490207653;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acb.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    return 4761371342045314899L * this.aLong6509;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return 1312925659 * this.anInt6507;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acb.com.jagex.i(").append(')').toString());
	}
    }
    ...
    static final void method3525(Class403 class403, int i) {
	try {
	    int i_0_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.anIntArray8924[i_0_];
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3526(Class403 class403, int i) {
	try {
    ...
    static final void method3527(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
	    class105.anInt1210 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) * -2074006897;
	    Tradution.method6054(class105, -542693615);
	    if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
		Class82_Sub20.method934(class105.ihash * -440872681, (byte) 7);
	}
	catch (RuntimeException runtimeexception) {
