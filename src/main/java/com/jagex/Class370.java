package com.jagex;/* com.jagex.Class370 - Decompiled by JODE
...
public class Class370 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pj.com.jagex.a(").append(')').toString());
	}
    }
