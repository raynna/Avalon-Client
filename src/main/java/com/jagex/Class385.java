package com.jagex;/* com.jagex.Class385 - Decompiled by JODE
...
public class Class385 {
    ...
    public static GameClient aClient4141;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pz.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pz.com.jagex.a(").append(')').toString());
	}
    }
