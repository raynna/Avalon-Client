package com.jagex;/* com.jagex.Class293 - Decompiled by JODE
...
public class Class293 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("me.com.jagex.aa(").append(')').toString());
	}
    }
