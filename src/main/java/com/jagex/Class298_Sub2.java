package com.jagex;/* com.jagex.Class298_Sub2 - Decompiled by JODE
...
public class Class298_Sub2 extends Class298 {
	...
	try {
	    if (i - i_1_ >= Class372.anInt4051 * -1424479739 && i_1_ + i <= Class372.anInt4048 * 1135094847 && i_0_ - i_1_ >= Class372.anInt4049 * 1155384281 && i_0_ + i_1_ <= Class372.anInt4050 * -1062447355)
    ...
    static final void method2848(Class403 class403, int i) {
	try {
    ...
    static final void method2849(Class403 class403, int i) {
	try {
    ...
    static final void method2850(Class403 class403, int i) {
	try {
	    int i_5_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = Integer.toString(i_5_);
	}
	catch (RuntimeException runtimeexception) {
