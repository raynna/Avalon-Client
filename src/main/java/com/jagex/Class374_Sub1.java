package com.jagex;/* com.jagex.Class374_Sub1 - Decompiled by JODE
...
public class Class374_Sub1 extends Class374 {
	...
	try {
	    return ((Class298_Sub50) GameClient.aClass453_8827.method5939(1766612795));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return Class18.method359(OutcommingPacket.aClass198_1995, GameClient.aClass25_8711.aClass449_330, (byte) 89);
	}
	catch (RuntimeException runtimeexception) {
	...
	if (class298_sub50 != null) {
		...
		i_2_ = 1;
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2008, GameClient.aClass25_8711.aClass449_330, (byte) 77);
	    class298_sub36.out.writeInt(i_1_ | i_0_ << 16, -1426845039);
	    class298_sub36.out.writeShort128(i | i_2_ << 15);
	    GameClient.aClass25_8711.method390(class298_sub36, (byte) -38);
	}
    }
	...
	if (class298_sub50 != null) {
	    ...
	    if (class298_sub50.method3546(-1372966703) == 2)
		i_5_ = 1;
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2008, GameClient.aClass25_8711.aClass449_330, (byte) 71);
	    class298_sub36.out.writeInt(i_4_ | i_3_ << 16, -1629465959);
	    class298_sub36.out.writeShort128(i | i_5_ << 15);
	    GameClient.aClass25_8711.method390(class298_sub36, (byte) -6);
	}
    }
	...
	try {
		...
		if (class298_sub50.method3546(-1372966703) == 2)
		    i_9_ = 1;
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2008, GameClient.aClass25_8711.aClass449_330, (byte) 8);
		class298_sub36.out.writeInt(i_8_ | i_7_ << 16, 121434419);
		class298_sub36.out.writeShort128(i_6_ | i_9_ << 15);
		GameClient.aClass25_8711.method390(class298_sub36, (byte) -44);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	return Class18.method359(OutcommingPacket.aClass198_1995, GameClient.aClass25_8711.aClass449_330, (byte) 126);
    }

    @Override
    Class298_Sub36 method4631() {
	return Class18.method359(OutcommingPacket.aClass198_1995, GameClient.aClass25_8711.aClass449_330, (byte) 67);
    }
	...
	if (class298_sub50 != null) {
	    ...
	    if (class298_sub50.method3546(-1372966703) == 2)
		i_12_ = 1;
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2008, GameClient.aClass25_8711.aClass449_330, (byte) 43);
	    class298_sub36.out.writeInt(i_11_ | i_10_ << 16, -611244662);
	    class298_sub36.out.writeShort128(i | i_12_ << 15);
	    GameClient.aClass25_8711.method390(class298_sub36, (byte) -78);
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adi.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adi.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.anInt8831 = (class403.anIntArray5244[class403.anInt5239 * 681479919]) * 443563833;
	    GameClient.anInt8690 = ((class403.anIntArray5244[1 + class403.anInt5239 * 681479919]) * -802224543);
	}
	catch (RuntimeException runtimeexception) {
