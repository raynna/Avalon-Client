package com.jagex;/* com.jagex.Class500 - Decompiled by JODE
...
public class Class500 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ur.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    Player class365_sub1_sub1_sub2_sub2 = GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i];
	    if (0 == i_2_) {
		if (bool)
		    ...
		    GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i] = null;
		...
		if (0 == i_9_) {
		    ...
		    if (GameClient.aClass283_8716.method2654(-232228879).method2320(i_14_, i_15_, 1039567132))
		    ...
		    if (GameClient.aClass283_8716.method2654(934483887).method2320(i_20_, i_21_, 624472586))
			class365_sub1_sub1_sub2_sub2.aByte7724++;
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ur.com.jagex.i(").append(')').toString());
	}
    }
}
