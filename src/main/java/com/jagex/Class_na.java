package com.jagex;/* com.jagex.Class_na - Decompiled by JODE
...
public abstract class Class_na extends Class298_Sub37 {
	...
	try {
		...
		GameClient.aBooleanArray8684[i_1_] = false;
	    ...
	    GameClient.anInt8921 = 727655629 * GameClient.ticketCycle;
	    ...
	    Class21.anInt277 = 905514481 * GameClient.anInt8756;
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.anInt8845 * -363202459;
	}
	catch (RuntimeException runtimeexception) {
