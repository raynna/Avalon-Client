...
public class Routes {
	...
	try {
	    if (GameClient.gametype != Class411.game_stellardawn) {
		//if (!findRoute(dstX, dstY, false, com.jagex.Routes.createRectOverlapStrategy(dstX, dstY, 1, 1))) disable this = better
	...
	try {
		...
		ObjectDefinitions definitions = GameClient.aClass283_8716.method2641(-1208362615).getObjectDefinitions(objid);
		int sizeX;
		int sizeY;
	    ...
	    com.jagex.GameObjectType typedef = ((com.jagex.GameObjectType) com.jagex.Class422_Sub20.method5701(com.jagex.ExactStrategy.method4108(114624527), type, (byte) 2));
	    com.jagex.ObjectDefinitions definition = com.jagex.client.aClass283_8716.method2641(-1208362615).getObjectDefinitions(id);
	    ...
	    com.jagex.PathStrategy strategy;
	    if (com.jagex.GameObjectType.T10 == typedef || com.jagex.GameObjectType.T11 == typedef || com.jagex.GameObjectType.T22 == typedef) {
	    int sizeX;
	    int sizeY;
	    ...
	    strategy = com.jagex.Routes.createEntityStrategy(dstX, dstY, sizeX, sizeY, cflag_rot);
	    } else if (com.jagex.Class82_Sub9.isWall(-1976050083 * typedef.type, (byte) 28)) {
	    strategy = com.jagex.Routes.createObjectCloseStrategy(dstX, dstY, 0, 0, typedef, rotation);
	    }
	    else
	    strategy = com.jagex.Routes.createObjectExactStrategy(dstX, dstY, 0, 0, typedef, rotation);
	    com.jagex.Routes.findRoute(dstX, dstY, true, strategy);
	...
	try {
	    ...
	    if (srcX < 0 || srcX >= GameClient.aClass283_8716.method2629(-2029828730) || srcY < 0 || srcY >= GameClient.aClass283_8716.method2630(911412275))
		return false;
	    if (dstX < 0 || dstX >= GameClient.aClass283_8716.method2629(-2140756422) || dstY < 0 || dstY >= GameClient.aClass283_8716.method2630(1432313507))
		return false;
	    int steps = GameClient.lastPathStepsCount = (Class298_Sub37.calculateRoute(srcX, srcY, Class287.myPlayer.getSize(), strategy, (GameClient.aClass283_8716.getSceneClipDataPlane(Class287.myPlayer.plane)), findAlternative, GameClient.pathBufferX, GameClient.pathBufferY));
	    if (steps < 1)
		return false;
	    // minimap flag update
	    Class3.anInt62 = GameClient.pathBufferX[steps - 1] * -1129029761;
	    Class3.anInt54 = GameClient.pathBufferY[steps - 1] * -1835291189;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acp.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("op.com.jagex.a(").append(')').toString());
	}
    }
	...
	if (!Loader.useRoute)
	    return;
	int stepsCount = GameClient.lastPathStepsCount;
	if (stepsCount > 0) { // dont need to waste bw by sending empty packets
	    Class298_Sub36 packet = Class18.method359(OutcommingPacket.WALKING_PACKET, GameClient.aClass25_8711.aClass449_330, (byte) 51);
	    ...
	    GameClient.aClass25_8711.method390(packet, (byte) -115);
	}
    }
	...
	int stepsCount = GameClient.lastPathStepsCount;
	if (stepsCount > 0) { // dont need to waste bw by sending empty packets
	    Class298_Sub36 packet = Class18.method359(OutcommingPacket.MINI_WALKING_PACKET, GameClient.aClass25_8711.aClass449_330, (byte) 28);
	    packet.out.writeByte(5 + stepsCount * 2);
	    Class341 class341 = GameClient.aClass283_8716.method2628(681479919);
	    packet.out.writeShort128(class341.gameSceneBaseX * -1760580017);
	    packet.out.write128Byte(Class151.method1644(-545107710) ? 1 : 0, (byte) 1);
