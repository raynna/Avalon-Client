package com.jagex;
/* com.jagex.Class501 - Decompiled by JODE
...
public final class Class501 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("us.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("us.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		for (Interface class298_sub51 = ((Interface) GameClient.aClass437_8841.method5816(1741120464)); null != class298_sub51; class298_sub51 = ((Interface) GameClient.aClass437_8841.method5815((byte) 42))) {
		    if (!class298_sub51.method2840(-629325116)) {
			class298_sub51 = ((Interface) GameClient.aClass437_8841.method5816(1941104676));
	    ...
	    Class287.myPlayer.method4341(GameClient.aClass283_8716.method2629(-1895849411) * 512 / 2, 0.0F, GameClient.aClass283_8716.method2630(501771104) * 512 / 2);
	    Class287.myPlayer.scenePositionXQueue[0] = GameClient.aClass283_8716.method2629(-1873805931) / 2;
	    Class287.myPlayer.scenePositionYQueue[0] = GameClient.aClass283_8716.method2630(2001443939) / 2;
	    ...
	    GameClient.aClass283_8716.method2640((byte) -45).method4324(-1834713428);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (null != GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i])
		    throw new RuntimeException();
		Class410 class410 = Class10.aClass410Array138[i];
		Player class365_sub1_sub1_sub2_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i] = (new Player(GameClient.aClass283_8716.method2675(-1611682495))));
		...
		if (GameClient.aClass283_8716.method2654(1040339757).method2320(i_22_, i_23_, -937818147))
