package com.jagex;/* com.jagex.Class485 - Decompiled by JODE
...
public class Class485 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tz.com.jagex.a(").append(')').toString());
	}
    }
