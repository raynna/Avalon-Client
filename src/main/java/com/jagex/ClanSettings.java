...
public class ClanSettings {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("gp.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("gp.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("gp.com.jagex.h(").append(')').toString());
	}
    }
	...
	try {
		...
		throw new RuntimeException("Unsupported com.jagex.ClanSettings version: " + version);
	...
	try {
		...
		Player class365_sub1_sub1_sub2_sub2 = GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_53_]];
