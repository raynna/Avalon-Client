package com.jagex;/* com.jagex.Class113 - Decompiled by JODE
...
public class Class113 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ep.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    Interface class298_sub51_45_ = (Interface) GameClient.aClass437_8841.method5812(parentHash);
	    ...
	    GameClient.aClass437_8841.method5817(class298_sub51, parentHash);
	    ...
	    if (null != GameClient.aClass105_8652) {
		Tradution.method6054(GameClient.aClass105_8652, 961005010);
		...
		Class82_Sub10.method903(GameClient.WINDOW_PANE_ID * -257444687, 1, -2018560763);
