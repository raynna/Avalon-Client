package com.jagex;
/* com.jagex.Class123_Sub2 - Decompiled by JODE
...
public class Class123_Sub2 extends Class123 {
	...
	if ((this.aClass_ra_Sub3_Sub1_6952.aClass110_Sub2_9832) != this.aClass110_Sub2_6953) {
	    if (this.aClass110_Sub2_6953 == null)
		throw new RuntimeException_Sub1();
	    OpenGL.glUseProgram(this.anInt6951);
	    this.aClass_ra_Sub3_Sub1_6952.aClass110_Sub2_9832 = this.aClass110_Sub2_6953;
	}
    }
	...
	if (this.aClass110_Sub2_6953 == class110)
	    return true;
	if (!class110.method1221())
	    return false;
	boolean bool = method1374();
	this.aClass110_Sub2_6953 = (Class110_Sub2) class110;
	...
	return ((this.aClass_ra_Sub3_Sub1_6952.aClass110_Sub2_9832) == this.aClass110_Sub2_6953);
    }
	...
	super(class_ra_sub3_sub1, class109);
	this.aClass_ra_Sub3_Sub1_6952 = class_ra_sub3_sub1;
    }
