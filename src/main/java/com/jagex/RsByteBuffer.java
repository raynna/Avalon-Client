package com.jagex;
/* com.jagex.RsByteBuffer - Decompiled by JODE
...
public class RsByteBuffer extends Class298 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acx.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acx.com.jagex.ba(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acx.com.jagex.aa(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acx.com.jagex.m(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acx.com.jagex.za(").append(')').toString());
	}
    }
}
