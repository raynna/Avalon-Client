...
public abstract class GraphicsToolkit {
	...
	try {
	    ...
	    class264.method2480(string, 3 + i_485_, i_489_, i_490_, 0, GameClient.aRandom8702, Class368.anInt4005 * 1401020893, Class436.aClass57Array5501, Class422_Sub3.anIntArray8372, 65280);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ra.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		if (2 != -64305285 * Class3.anInt56 && 5 != Class3.anInt56 * -64305285 && null != Class384.aClass57_4127) {
			...
			i_500_ = (int) -GameClient.aFloat8949 & 0x3fff;
			i_501_ = 4096;
		    } else {
			...
			i_500_ = (GameClient.anInt8801 * 1227356013 + (int) -GameClient.aFloat8949) & 0x3fff;
			i_501_ = 4096 - 1412674352 * GameClient.anInt8749;
		    }
		    int i_502_ = i_498_ / 128 + 48;
		    int i_503_ = (48 + GameClient.aClass283_8716.method2630(789210081) * 4 - i_499_ / 128);
		    ...
		    MapKeys class296 = GameClient.aClass283_8716.method2631(-337725639);
			...
			ObjectDefinitions class432 = (GameClient.aClass283_8716.method2641(2011176396).getObjectDefinitions(Class3.anIntArray60[i_509_]));
		    ...
		    for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) GameClient.aClass437_8685.method5816(1742338274)); class298_sub2 != null; class298_sub2 = ((Class298_Sub2) GameClient.aClass437_8685.method5815((byte) 24))) {
