package com.jagex;/* com.jagex.Class73 - Decompiled by JODE
...
public final class Class73 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("cz.com.jagex.a(").append(')').toString());
	}
    }
