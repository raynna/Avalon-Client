package com.jagex;/* com.jagex.Class52_Sub2 - Decompiled by JODE
...
public abstract class Class52_Sub2 extends Class52 {
	...
	try {
	    ...
	    try {
		class476 = Class86.method962("2", GameClient.gametype.aString5317, true, -1804643872);
		RsByteBuffer class298_sub53 = new RsByteBuffer(GameClient.anInt8890 * 260699542 + 3);
	    ...
	    GameClient.aLong8892 = Class122.method1319((byte) 1) * 5732957771927789473L;
