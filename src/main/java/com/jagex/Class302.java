package com.jagex;/* com.jagex.Class302 - Decompiled by JODE
...
public class Class302 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("mo.com.jagex.a(").append(')').toString());
	}
    }
