package com.jagex;/* com.jagex.Class317 - Decompiled by JODE
...
public class Class317 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nf.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nf.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = GameClient.aString8656;
	    else
