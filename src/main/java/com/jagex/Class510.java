package com.jagex;/* com.jagex.Class510 - Decompiled by JODE
...
public class Class510 {
    ...
    static final void method6288(Class403 class403, int i) {
        try {
            ...
            Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2093, GameClient.aClass25_8693.aClass449_330, (byte) 102);
            ...
            GameClient.aClass25_8693.method390(class298_sub36, (byte) -104);
        } catch (RuntimeException runtimeexception) {
    ...
    public static IncommingPacket[] method6290(int i) {
        try {
            ...
            throw Class346.method4175(runtimeexception, new StringBuilder().append("vc.com.jagex.a(").append(')').toString());
        }
    }
}
