package com.jagex;/* com.jagex.Class194 - Decompiled by JODE
...
public class Class194 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("if.com.jagex.oa(").append(')').toString());
	}
    }
