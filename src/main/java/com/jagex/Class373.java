package com.jagex;
/* com.jagex.Class373 - Decompiled by JODE
...
public class Class373 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pn.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = GameClient.anIntArray8705[i_2_];
	    else
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2641(134727545).method5795(1599239758);
	...
	try {
	    ...
	    int i_6_ = GameClient.GRAND_EXCHANGE_SLOTS[i_5_].method2400(-574288948);
