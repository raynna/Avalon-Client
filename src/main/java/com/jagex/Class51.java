...
/* com.jagex.Class51 - Decompiled by JODE
...
public class Class51 {
	...
	try {
	    ...
	    Player player = (Class287.myPlayer = GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[myPlayerIndex] = (new Player(GameClient.aClass283_8716.method2675(-1611682495))));
	    ...
	    if (GameClient.aClass283_8716.method2654(1740552362).method2320(player.scenePositionXQueue[0], player.scenePositionYQueue[0], -14939637))
		player.aByte7724++;
	    ...
	    // com.jagex.Class10.slotFlags[myPlayerIndex] = (byte) 0;
	    Class10.anInt130 = 0;
		...
		if (myPlayerIndex == i_6_) {
		    ...
		    // com.jagex.Class10.slotFlags[i_6_] = (byte) 0;
		}
	    }
	    class298_sub53_sub2.finishBitAccess((byte) 109);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ca.com.jagex.a(").append(')').toString());
	}
    }
