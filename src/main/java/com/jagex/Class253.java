package com.jagex;
/* com.jagex.Class253 - Decompiled by JODE
...
public final class Class253 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kp.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kp.com.jagex.i(").append(')').toString());
	}
    }
