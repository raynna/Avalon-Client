package com.jagex;/* com.jagex.Class118 - Decompiled by JODE
...
public final class Class118 {
	...
	try {
	    ...
	    if ((class403.anIntArray5244[681479919 * class403.anInt5239]) < (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]))
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_2_).anInt5735) * 1671807857;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 1675394033 * class353.anInt3820;
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (class403.aClass162_5252.getMemberID((String) (class403.anObjectArray5240[((class403.anInt5241 -= 969361751) * -203050393)]), 131072));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class301_Sub1.anInt7632 = (i - Class301.anInt3245) * -433609607;
	    Class301_Sub1.anInt7627 = (i_3_ - Class301.anInt3238) * -789877945;
	}
	catch (RuntimeException runtimeexception) {
