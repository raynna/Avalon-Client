package com.jagex;/* com.jagex.Class112 - Decompiled by JODE
...
public class Class112 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eo.com.jagex.a(").append(')').toString());
	}
    }
