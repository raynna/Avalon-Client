package com.jagex;/* com.jagex.Class487 - Decompiled by JODE
...
public class Class487 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ub.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ub.com.jagex.i(").append(')').toString());
	}
    }
