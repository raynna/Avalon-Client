package com.jagex;/* com.jagex.Class111 - Decompiled by JODE
...
public class Class111 {
	...
	try {
	    ...
	    int i_1_ = GameClient.GRAND_EXCHANGE_SLOTS[i_0_].method2400(-574288948);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("en.com.jagex.a(").append(')').toString());
	}
    }
}
