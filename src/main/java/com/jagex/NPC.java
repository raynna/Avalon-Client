...
public class NPC extends Entity {
	...
	try {
		...
		i |= 0x7;
	    boolean bool = (0 != aByte10130 && 443738891 * GameClient.ticketCycle >= anInt10105 * 1920148979 && GameClient.ticketCycle * 443738891 < anInt10106 * 1953154657);
	    if (bool)
		i |= 0x80000;
	...
	try {
	    ...
	    if (GameClient.aClass283_8716.method2654(1132456995).method2320(i_20_, i_21_, 1587070733))
		aByte7724++;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ake.com.jagex.h(").append(')').toString());
	}
    }
