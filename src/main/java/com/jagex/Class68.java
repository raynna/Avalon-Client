package com.jagex;/* com.jagex.Class68 - Decompiled by JODE
...
public class Class68 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ct.com.jagex.a(").append(')').toString());
	}
    }
