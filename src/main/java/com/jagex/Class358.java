package com.jagex;/* com.jagex.Class358 - Decompiled by JODE
...
public class Class358 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("oy.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("oy.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("oy.com.jagex.h(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("oy.com.jagex.fa(").append(')').toString());
	}
    }
	...
	try {
		...
		i_15_ = (int) GameClient.aFloat8949 & 0x3fff;
	    else
		i_15_ = (GameClient.anInt8801 * 1227356013 + (int) GameClient.aFloat8949 & 0x3fff);
