package com.jagex;
/* com.jagex.Class300 - Decompiled by JODE
...
public class Class300 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("mm.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    class302_sub4.anInt7655 = (i_11_ + GameClient.ticketCycle * 443738891) * -1019659005;
	    class302_sub4.anInt7654 = i_10_ * 274200991;
	    class302_sub4.aString7657 = string;
	    class302_sub4.anInt7651 = i_12_ * 334332979;
	    GameClient.aClass442_8650.method5870(class302_sub4, 1639821588);
	}
	catch (RuntimeException runtimeexception) {
