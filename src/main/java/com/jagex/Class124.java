package com.jagex;
/* com.jagex.Class124 - Decompiled by JODE
...
public class Class124 implements Runnable {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("f.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    int i_5_ = (class365_sub1_sub1_sub2.anInt10095 * -412225079 - GameClient.ticketCycle * 443738891);
