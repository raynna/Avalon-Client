package com.jagex;/* com.jagex.Class98_Sub2 - Decompiled by JODE
...
public class Class98_Sub2 extends Class98 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("yh.com.jagex.a(").append(')').toString());
	}
    }
