package com.jagex;/* com.jagex.Class309_Sub1 - Decompiled by JODE
...
public class Class309_Sub1 extends Class309 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aaf.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aaf.com.jagex.a(").append(')').toString());
	}
    }
}
