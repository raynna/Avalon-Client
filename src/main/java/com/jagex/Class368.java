package com.jagex;/* com.jagex.Class368 - Decompiled by JODE
...
public class Class368 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ph.com.jagex.ba(").append(')').toString());
	}
    }
