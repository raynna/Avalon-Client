package com.jagex;/* com.jagex.Class82_Sub5 - Decompiled by JODE
...
public class Class82_Sub5 extends Class82 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("xj.com.jagex.i(").append(')').toString());
	}
    }
