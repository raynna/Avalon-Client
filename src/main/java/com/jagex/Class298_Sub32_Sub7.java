package com.jagex;/* com.jagex.Class298_Sub32_Sub7 - Decompiled by JODE
...
public class Class298_Sub32_Sub7 extends Class298_Sub32 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("agt.com.jagex.i(").append(')').toString());
	}
    }
