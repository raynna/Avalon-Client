package com.jagex;
/* com.jagex.Class52_Sub2_Sub1 - Decompiled by JODE
...
public abstract class Class52_Sub2_Sub1 extends Class52_Sub2 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("afi.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("afi.com.jagex.a(").append(')').toString());
	}
    }
