package com.jagex;/* com.jagex.Class136 - Decompiled by JODE
...
public class Class136 implements Interface6 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("fm.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    if (bool) {
		int i_0_ = ((this.aClass158_6386.aClass139_6360.method1545(this.aClass57_6385.method271(), GameClient.anInt8794 * 775068819, -2059315000)) + (-245579987 * this.aClass158_6386.anInt6362));
		int i_1_ = ((this.aClass158_6386.aClass133_6363.method1482(this.aClass57_6385.method626(), GameClient.anInt8803 * -791746413, -1363619703)) + (this.aClass158_6386.anInt6359 * -1426302101));
	...
	if (bool) {
	    int i = ((this.aClass158_6386.aClass139_6360.method1545(this.aClass57_6385.method271(), GameClient.anInt8794 * 775068819, -2133654536)) + -245579987 * this.aClass158_6386.anInt6362);
	    int i_2_ = ((this.aClass158_6386.aClass133_6363.method1482(this.aClass57_6385.method626(), GameClient.anInt8803 * -791746413, -1742244574)) + this.aClass158_6386.anInt6359 * -1426302101);
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aShort8928;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aShort8929;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("fm.com.jagex.i(").append(')').toString());
	}
    }
