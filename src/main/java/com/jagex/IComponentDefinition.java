...
/* com.jagex.IComponentDefinition - Decompiled by JODE
...
public class IComponentDefinition {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.com.jagex.aa(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    if (GameClient.drag)
		anInt1235 = GameClient.dragValue * -978869921;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.com.jagex.h(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.com.jagex.m(").append(')').toString());
	}
    }
    ...
    static final void method1132(Class403 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2057, GameClient.aClass25_8711.aClass449_330, (byte) 37);
			class298_sub36.out.writeShort(i_67_, 16711935);
			GameClient.aClass25_8711.method390(class298_sub36, (byte) -67);
		} catch (RuntimeException runtimeexception) {
