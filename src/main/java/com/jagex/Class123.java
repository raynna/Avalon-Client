package com.jagex;/* com.jagex.Class123 - Decompiled by JODE
...
public abstract class Class123 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ez.com.jagex.h(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ez.com.jagex.aa(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ez.com.jagex.m(").append(')').toString());
	}
    }
