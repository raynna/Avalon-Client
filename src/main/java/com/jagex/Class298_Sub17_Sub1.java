package com.jagex;/* com.jagex.Class298_Sub17_Sub1 - Decompiled by JODE
...
public class Class298_Sub17_Sub1 extends Class298_Sub17 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("agh.com.jagex.a(").append(')').toString());
	}
    }
