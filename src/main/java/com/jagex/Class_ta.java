package com.jagex;/* com.jagex.Class_ta - Decompiled by JODE
...
public abstract class Class_ta {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ta.com.jagex.a(").append(')').toString());
	}
    }
