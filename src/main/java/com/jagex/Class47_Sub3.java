package com.jagex;
/* com.jagex.Class47_Sub3 - Decompiled by JODE
...
public class Class47_Sub3 extends Class47 {
	...
	if (this.aBoolean6768) {
	    ...
	    this.aClass_ra_Sub2_491.method5256(this.aClass30_Sub1Array6761[i - 1]);
	...
	if (this.aClass28_6765 != null && bool) {
		...
		this.aClass_ra_Sub2_491.method5255(2);
	...
	if (class_ra_sub2.aBoolean8178) {
		...
		for (int i_6_ = 0; i_6_ < 64; i_6_++) {
		    float f = 2.0F * i_6_ / 64.0F - 1.0F;
		    float f_7_ = 2.0F * i_5_ / 64.0F - 1.0F;
		    float f_8_ = (float) (1.0 / Math.sqrt(f * f + 1.0F + f_7_ * f_7_));
		    f *= f_8_;
		    f_7_ *= f_8_;
			...
			int i_13_;
			if (f_10_ > 0.0F) {
			    i_13_ = (int) (Math.pow(f_10_, 96.0) * i);
			    i_12_ = (int) (Math.pow(f_10_, 36.0) * i);
			    i_11_ = (int) (Math.pow(f_10_, 12.0) * i);
			} else {
			    i_11_ = 0;
			    i_12_ = 0;
			    i_13_ = 0;
	    ...
	    this.aClass30_Sub1Array6761[0] = new Class30_Sub1(this.aClass_ra_Sub2_491, Class55.aClass55_567, Class77.aClass77_717, 64, false, is_2_, Class55.aClass55_567);
	    this.aClass30_Sub1Array6761[1] = new Class30_Sub1(this.aClass_ra_Sub2_491, Class55.aClass55_567, Class77.aClass77_717, 64, false, is_3_, Class55.aClass55_567);
	    this.aClass30_Sub1Array6761[2] = new Class30_Sub1(this.aClass_ra_Sub2_491, Class55.aClass55_567, Class77.aClass77_717, 64, false, is, Class55.aClass55_567);
	    method521();
	}
    }
    ...
    void method521() {
	this.aClass28_6765 = new Class28(this.aClass_ra_Sub2_491, 2);
	...
	if (!this.aBoolean6766) {
	    this.aClass_ra_Sub2_491.method5258(7681, 8448);
	    this.aClass_ra_Sub2_491.method5259(0, 34168, 768);
	    this.aClass_ra_Sub2_491.method5255(2);
	    this.aClass_ra_Sub2_491.method5258(260, 7681);
	    this.aClass_ra_Sub2_491.method5259(0, 34168, 768);
	    this.aClass_ra_Sub2_491.method5259(1, 34168, 770);
	    this.aClass_ra_Sub2_491.method5286(0, 34167, 770);
	} else {
	    this.aClass_ra_Sub2_491.method5258(260, 7681);
	    this.aClass_ra_Sub2_491.method5259(0, 5890, 770);
	    this.aClass_ra_Sub2_491.method5286(0, 34167, 770);
	}
	this.aClass_ra_Sub2_491.method5255(0);
	...
	if (!this.aBoolean6766) {
	    ...
	    this.aClass_ra_Sub2_491.method5258(8448, 8448);
	    this.aClass_ra_Sub2_491.method5259(0, 5890, 768);
	    this.aClass_ra_Sub2_491.method5259(1, 34168, 768);
	    this.aClass_ra_Sub2_491.method5286(0, 5890, 770);
	} else {
	    this.aClass_ra_Sub2_491.method5258(8448, 8448);
	    this.aClass_ra_Sub2_491.method5259(0, 5890, 768);
