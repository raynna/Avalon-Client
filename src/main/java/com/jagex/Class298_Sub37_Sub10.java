package com.jagex;/* com.jagex.Class298_Sub37_Sub10 - Decompiled by JODE
...
public class Class298_Sub37_Sub10 extends Class298_Sub37 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aiq.com.jagex.a(").append(')').toString());
	}
    }
