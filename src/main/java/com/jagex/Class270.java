package com.jagex;/* com.jagex.Class270 - Decompiled by JODE
...
public class Class270 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("lf.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -1333485389 * GameClient.anInt8932;
	    else
