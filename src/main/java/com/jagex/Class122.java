package com.jagex;/* com.jagex.Class122 - Decompiled by JODE
...
public class Class122 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ey.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    if (i_18_ != -1) {
		Object object = null;
		Class57 class57 = (Class57) GameClient.aClass348_8697.method4184(i_18_);
		if (null == class57) {
		    ...
		    GameClient.aClass348_8697.method4194(class57, i_18_);
		}
		...
		int i_19_ = (int) (i_11_ + GameClient.aFloatArray8891[0] - 18.0F);
		int i_20_ = (int) (i_12_ + GameClient.aFloatArray8891[1] - 16.0F - 54.0F);
		i_19_ += i / 4 * 18;
		i_20_ += 18 * (i % 4);
