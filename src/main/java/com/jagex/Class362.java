package com.jagex;
/* com.jagex.Class362 - Decompiled by JODE
...
public class Class362 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pb.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    int i_4_ = GameClient.GRAND_EXCHANGE_SLOTS[i_3_].method2400(-574288948);
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = GameClient.anIntArray8946[i_5_];
	    else
