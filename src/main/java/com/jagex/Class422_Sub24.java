package com.jagex;/* com.jagex.Class422_Sub24 - Decompiled by JODE
...
public class Class422_Sub24 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aei.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		if (class105 == null) {
		    ...
		    int i_11_;
		    if (-1 == i_8_) {
			GameClient.aRectangleArray8902[GameClient.anInt8686 * -112139815].setBounds(i_6_ + 1354508417 * class105.anInt1143, i_7_ + class105.anInt1155 * -749038817, class105.anInt1156 * -2093041337, 457937409 * class105.anInt1162);
			i_11_ = ((GameClient.anInt8686 += 1339395689) * -112139815 - 1);
		    } else
			i_11_ = i_8_;
		    class105.anInt1303 = 1339690151 * i_11_;
		    class105.anInt1133 = 488606259 * GameClient.ticketCycle;
			...
			if (GameClient.qa_op && ((GameClient.method2801(class105).anInt7416 * -1266165749) != 0 || class105.type * -1215239439 == 0) && i_14_ > 127)
			    i_14_ = 127;
			if (GameClient.aClass105_8850 == class105) {
				...
				if (-2093041337 * class105.anInt1156 + i_15_ > (GameClient.anInt8856 * -343518257 + GameClient.anInt8858 * -1221279965))
				    i_15_ = (GameClient.anInt8858 * -1221279965 + -343518257 * GameClient.anInt8856 - class105.anInt1156 * -2093041337);
				if (i_16_ < GameClient.anInt8800 * 1325631359)
				    i_16_ = GameClient.anInt8800 * 1325631359;
				if (i_16_ + class105.anInt1162 * 457937409 > (-609231901 * GameClient.anInt8966 + 1325631359 * GameClient.anInt8800))
				    i_16_ = (GameClient.anInt8966 * -609231901 + GameClient.anInt8800 * 1325631359 - 457937409 * class105.anInt1162);
			...
			if (i_17_ < i_19_) {
				...
				if (0 != 907611645 * class105.anInt1145) {
				    ...
				    if ((IComponentDefinition.anInt1265 * 310968271 == 907611645 * class105.anInt1145) && (GameClient.anInt8724 * 1596783995 == 3)) {
					...
					if (GameClient.FPS || GameClient.aBoolean8668) {
				...
				if (-1215239439 * class105.type == 0) {
				    ...
				    Interface class298_sub51 = ((Interface) (GameClient.aClass437_8841.method5812(class105.ihash * -440872681)));
					...
					if (0 == 1596783995 * GameClient.anInt8724) {
					    ...
					    if (443738891 * GameClient.ticketCycle < (-230034171 * GameClient.anInt8737)) {
						float f = ((((GameClient.ticketCycle) * 443738891) - (1757243277 * (GameClient.anInt8728))) * 1.0F / (((GameClient.anInt8737) * -230034171) - ((GameClient.anInt8728) * 1757243277)));
						i_23_ = (int) (((1.0F - f) * ((Class256.anInt2801) * -503104833)) + ((GameClient.anInt8681) * -876396183 * f));
						i_24_ = (int) (((GameClient.anInt8731) * 549822343 * f) + ((1.0F - f) * (2068723003 * Class108.anInt1321)));
						i_25_ = (int) (((1.0F - f) * ((Class474.anInt5980) * 2047797063)) + (127441797 * (GameClient.anInt8732) * f));
						i_26_ = (int) (((1.0F - f) * (669602755 * (Class115.anInt1389))) + (-1276156339 * (GameClient.anInt8720) * f));
					    }
					    if (i_23_ > 0)
				...
				if (!GameClient.aBooleanArray8901[i_11_] && GameClient.anInt8956 * 2067224717 <= 1) {
				    ...
				    GameClient.aClass283_8716.method2640((byte) -16).method4326((byte) -24);
					...
					if (i_37_ >= 0 && i_37_ < 2048) {
					    Player class365_sub1_sub1_sub2_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_37_]);
					    if ((null != class365_sub1_sub1_sub2_sub2) && (((-442628795 * GameClient.playerIndex) == i_37_) || ((Class525.method6379((class365_sub1_sub1_sub2_sub2.aString10195), (byte) 125)) == (1148770405 * (class105.anInt1140))))) {
					...
					if (i_38_ >= 0 && i_38_ < 2048) {
					    Player class365_sub1_sub1_sub2_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_38_]);
					    if ((class365_sub1_sub1_sub2_sub2 != null) && (i_38_ == (GameClient.playerIndex * -442628795) || ((Class525.method6379((class365_sub1_sub1_sub2_sub2.aString10195), (byte) 127)) == (class105.anInt1140 * 1148770405))))
					...
					int i_43_ = GameClient.aClass283_8716.method2634((byte) -21);
					int i_44_ = GameClient.aClass283_8716.method2635(-176106849);
					...
					if (class105.aBoolean1187) {
					    ...
					    GameClient.aClass222_8968.method2064(class105.anInt1193 * 1412474881, class105.anInt1194 * -1674106223, -1491626287 * (class105.anInt1282));
					} else {
					    ...
					    GameClient.aClass222_8968.method2064((class105.anInt1297 * -407676483) << 2, i_36_ + (i_45_ + ((-1523987341 * (class105.anInt1248)) << 2)), i_46_ + (((class105.anInt1248) * -1523987341) << 2));
					    GameClient.aClass222_8968.method2071(1.0F, 0.0F, 0.0F, (Class220.method2049(class105.anInt1190 * 7329457 << 3)));
					}
					class105.method1114(Class373.aClass_ra4071, class387, GameClient.aClass222_8968, 443738891 * GameClient.ticketCycle, 1739448532);
					if (GameClient.aBoolean8849)
					    Class373.aClass_ra4071.o(i_12_, i_13_, (i_12_ + (-2093041337 * class105.anInt1156)), i_13_ + (class105.anInt1162 * 457937409));
					class387.method4739((GameClient.aClass222_8968), null, 1);
