package com.jagex;/* com.jagex.Class12 - Decompiled by JODE
...
public class Class12 implements Interface8_Impl1_Impl2 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("am.com.jagex.a(").append(')').toString());
	}
    }
    ...
    static final void method333(Class403 class403, int i) {
	try {
    ...
    static final void method334(Class403 class403, int i) {
	try {
	    ...
	    class298_sub36.out.writeByte(3);
	    class298_sub36.out.writeShort(class403.aClass177_5243.anInt1787 * -2034569943, 16711935);
	    class403.aClass177_5243.aClass298_Sub37_Sub14_1788.method3464(class298_sub36.out, class403.aClass177_5243.anIntArray1789, 1205733536);
	    class298_sub36.out.method3649((class298_sub36.out.index * 385051775) - i_8_, (byte) -42);
    ...
    static final void method335(Class403 class403, int i) {
	try {
	    String string = null;
    ...
    static final void method336(Class403 class403, int i) {
	try {
	    Class302_Sub3.method3722((short) 31086);
	    GameClient.aClass283_8716.method2667(1321707085);
    ...
    static final void method337(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
		...
		Class325.method3966(-440872681 * class105.ihash, 1038434674);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (GameClient.anInt8952 * -548972447 >= 100)
			...
			if (Class173.method1824((Class287.myPlayer.aString10195), 675816100).equals(string_10_))
			    ...
			    class298_sub36.out.writeByte(Class58.method693(string, 1022662846) + 1);
			    class298_sub36.out.writeString(string, 2142299789);
    ...
    static final void method339(Class403 class403, int i) {
	try {
	    Class390 class390 = (class403.aBoolean5261 ? class403.aClass390_5247 : class403.aClass390_5246);
	    IComponentDefinition class105 = class390.aClass105_4168;
    ...
    static final void method340(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8835 ? 1 : 0;
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = GameClient.aString8754 == null ? "" : GameClient.aString8754;
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = GameClient.aString8838 == null ? "" : GameClient.aString8838;
	}
	catch (RuntimeException runtimeexception) {
