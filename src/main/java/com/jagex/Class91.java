package com.jagex;/* com.jagex.Class91 - Decompiled by JODE
...
public class Class91 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ds.com.jagex.fa(").append(')').toString());
	}
    }
	...
	try {
	    float f1 = 1104.0F;
	    float f2 = 2874.0F;
	    if (GameClient.aFloat8757 < f1)
		GameClient.aFloat8757 = f1;
	    if (GameClient.aFloat8757 > f2)
		GameClient.aFloat8757 = f2;
	    for (/**/; GameClient.aFloat8949 >= 16384.0F; GameClient.aFloat8949 -= 16384.0F) {
		/* empty */
	    }
	    for (/**/; GameClient.aFloat8949 < 0.0F; GameClient.aFloat8949 += 16384.0F) {
		/* empty */
	    }
	    Class244 class244 = GameClient.aClass283_8716.method2654(1252790814);
	    ...
	    int i_6_ = 0;
	    if (i_3_ > 3 && i_4_ > 3 && i_3_ < GameClient.aClass283_8716.method2629(-1981660153) - 4 && i_4_ < GameClient.aClass283_8716.method2630(1904630701) - 4) {
		for (int i_7_ = i_3_ - 4; i_7_ <= 4 + i_3_; i_7_++) {
			...
			if (i_9_ < 3 && class244.method2320(i_7_, i_8_, -316177210))
			    i_9_++;
			int i_10_ = 0;
			byte[][] is = GameClient.aClass283_8716.method2637(i_9_, 300700071);
			if (null != is)
	    ...
	    if (i_12_ < 262144)
		i_12_ = 262144;
	    if (i_12_ > GameClient.anInt8764 * -523207831)
		GameClient.anInt8764 += ((i_12_ - -523207831 * GameClient.anInt8764) / 24 * 1746126041);
	    else if (i_12_ < -523207831 * GameClient.anInt8764)
		GameClient.anInt8764 += 1746126041 * ((i_12_ - GameClient.anInt8764 * -523207831) / 80);
	}
	catch (RuntimeException runtimeexception) {
