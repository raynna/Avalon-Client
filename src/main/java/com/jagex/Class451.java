package com.jagex;/* com.jagex.Class451 - Decompiled by JODE
...
public class Class451 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sp.com.jagex.a(").append(')').toString());
	}
    }
