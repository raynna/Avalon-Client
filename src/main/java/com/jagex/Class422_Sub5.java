package com.jagex;/* com.jagex.Class422_Sub5 - Decompiled by JODE
...
public class Class422_Sub5 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adf.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.ITEM_ON_ITEM, GameClient.aClass25_8711.aClass449_330, (byte) 35);
		...
		GameClient.aClass25_8711.method390(class298_sub36, (byte) -64);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (1 == opcode) {
		    ...
		    GameClient.aBoolean8736 |= Class254.aBooleanArray2790[(int) hash];
		    GameClient.anIntArray8876[((GameClient.anInt8877 += 163718667) * 116700579) - 1 & 0x1f] = (int) hash;
		} else if (2 == opcode) {
		    ClientScriptsExecutor.aStringArray4126[(int) hash] = (class298_sub37_sub12.aString9611);
		    GameClient.anIntArray8787[((GameClient.anInt8879 += -646054651) * -466597939) - 1 & 0x1f] = (int) hash;
		} else if (opcode == 3) {
	    ...
	    /*
	     * throw com.jagex.Class346.method4175(runtimeexception, new StringBuilder()
