package com.jagex;/* com.jagex.Class298_Sub39 - Decompiled by JODE
...
public class Class298_Sub39 extends Class298 {
	...
	try {
	    ...
	    if (i_23_ > 3072)
		i_23_ = 3072;
	    if (GameClient.anInt8756 * -104436553 < i_23_) {
		GameClient.anInt8756 += ((((i_23_ - GameClient.anInt8756 * -104436553 >> 3) * (1179258959 * Class427.cameraLookSpeed2) / 1000) + Class128_Sub1.cameraLookSpeed1 * 298687157) << 3) * -648269561;
		if (GameClient.anInt8756 * -104436553 > i_23_)
		    GameClient.anInt8756 = i_23_ * -648269561;
	    }
	    if (-104436553 * GameClient.anInt8756 > i_23_) {
		GameClient.anInt8756 -= (-648269561 * ((1179258959 * Class427.cameraLookSpeed2 * (GameClient.anInt8756 * -104436553 - i_23_ >> 3) / 1000) + 298687157 * Class128_Sub1.cameraLookSpeed1 << 3));
		if (-104436553 * GameClient.anInt8756 < i_23_)
		    GameClient.anInt8756 = i_23_ * -648269561;
	    }
