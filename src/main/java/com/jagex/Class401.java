package com.jagex;/* com.jagex.Class401 - Decompiled by JODE
...
public class Class401 implements Interface21 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qq.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		if (23 == i_34_) { // walk
			...
			/*
			    ...
			    com.jagex.Class298_Sub36 class298_sub36 = com.jagex.Class277.createWalkPacket(i_32_, i_33_, i_35_);
			    if (1 == i_35_) {
				class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(-1);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(-1);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeShort((int) com.jagex.client.aFloat8949, 16711935);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(57);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(1227356013 * com.jagex.client.anInt8801);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(356727603 * com.jagex.client.anInt8749);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(89);
				com.jagex.Class217 class217 = (com.jagex.Class287.myPlayer.method4337().aClass217_2599);
				...
				com.jagex.client.anInt8784 = com.jagex.i * 143636043;
				com.jagex.client.anInt8785 = i_30_ * 381532777;
				com.jagex.client.anInt8748 = 277162405;
				com.jagex.client.anInt8786 = 0;
			    }
			    com.jagex.client.aClass25_8711.method390(class298_sub36, (byte) -115);
			    com.jagex.Routes.findRoute(i_32_, i_33_, true, com.jagex.Routes.createExactStrategy(i_32_, i_33_, (short) 808), -1776617382);*/
		...
		if (class198 != null) {
		    ...
		    GameClient.anInt8786 = 0;
		    Class298_Sub36 class298_sub36 = Class18.method359(class198, GameClient.aClass25_8711.aClass449_330, (byte) 23);
		    ...
		    GameClient.aClass25_8711.method390(class298_sub36, (byte) -56);
		...
		if (59 == i_34_) { // ?????
		    ...
		    GameClient.anInt8748 = 277162405;
		    GameClient.anInt8786 = 0;
		    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2087, GameClient.aClass25_8711.aClass449_330, (byte) 6);
		    class298_sub36.out.writeInt(1262526353 * Class379.anInt4099, 969641873);
		    class298_sub36.out.writeShort(392084321 * GameClient.anInt8836, 16711935);
		    class298_sub36.out.writeShort(class341.gameSceneBaseY * 283514611 + dstY, 16711935);
		    class298_sub36.out.writeShort128(GameClient.anInt8906 * 1408085039);
		    class298_sub36.out.writeShortLE(class341.gameSceneBaseX * -1760580017 + dstX, 1993411127);
		    GameClient.aClass25_8711.method390(class298_sub36, (byte) -125);
		}
		...
		if (2 == i_34_) { // widget on object
		    ...
		    GameClient.anInt8748 = 554324810;
		    GameClient.anInt8786 = 0;
		    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.INTERFACE_ON_OBJECT, GameClient.aClass25_8711.aClass449_330, (byte) 52);
		    class298_sub36.out.write128Byte(Class151.method1644(-427290804) ? 1 : 0, (byte) 1);
		    class298_sub36.out.writeShortLE128(GameClient.anInt8906 * 1408085039);
		    ...
		    class298_sub36.out.writeShortLE(GameClient.anInt8836 * 392084321, 462918069);
		    class298_sub36.out.writeShort128(dstX + -1760580017 * class341.gameSceneBaseX);
		    GameClient.aClass25_8711.method390(class298_sub36, (byte) -39);
		}
		if (i_34_ == 30 && GameClient.aClass105_8652 == null) {
		    ...
		    Tradution.method6054(GameClient.aClass105_8652, 194587581);
		}
		...
		if (class198_36_ != null) {
		    Player player = GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[walktype];
		    if (null != player) {
			...
			GameClient.anInt8748 = 554324810;
			GameClient.anInt8786 = 0;
			Class298_Sub36 class298_sub36 = Class18.method359(class198_36_, (GameClient.aClass25_8711.aClass449_330), (byte) 74);
			class298_sub36.out.writeByte(Class151.method1644(1625676244) ? 1 : 0);
			class298_sub36.out.writeShortLE128(walktype);
			GameClient.aClass25_8711.method390(class298_sub36, (byte) -105);
		...
		if (i_34_ == 16) { // widget on self player, no path needed
		    ...
		    GameClient.anInt8748 = 554324810;
		    GameClient.anInt8786 = 0;
		    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.INTERFACE_ON_PLAYER, GameClient.aClass25_8711.aClass449_330, (byte) 82);
		    class298_sub36.out.writeShort(1408085039 * GameClient.anInt8906, 16711935);
		    ...
		    class298_sub36.out.writeShortLE128(GameClient.anInt8836 * 392084321);
		    class298_sub36.out.write128Byte(Class151.method1644(-1804963392) ? 1 : 0, (byte) 1);
		    GameClient.aClass25_8711.method390(class298_sub36, (byte) -113);
		}
		if (i_34_ == 17) { // widget on ground item???
		    ...
		    GameClient.anInt8748 = 554324810;
		    GameClient.anInt8786 = 0;
		    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2062, GameClient.aClass25_8711.aClass449_330, (byte) 15);
		    class298_sub36.out.method3617(Class151.method1644(1934855379) ? 1 : 0, 1961724405);
		    class298_sub36.out.writeShortLE128(1408085039 * GameClient.anInt8906);
		    ...
		    class298_sub36.out.writeShort128(GameClient.anInt8836 * 392084321);
		    class298_sub36.out.writeShortLE128(walktype);
		    GameClient.aClass25_8711.method390(class298_sub36, (byte) -59);
		}
		if (58 == i_34_) {
		...
		if (null != class198_37_) {
		    Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(walktype));
			...
			GameClient.anInt8748 = 554324810;
			GameClient.anInt8786 = 0;
			Class298_Sub36 class298_sub36 = Class18.method359(class198_37_, (GameClient.aClass25_8711.aClass449_330), (byte) 15);
			class298_sub36.out.writeShort128(walktype);
			class298_sub36.out.write128Byte(Class151.method1644(1824393579) ? 1 : 0, (byte) 1);
			GameClient.aClass25_8711.method390(class298_sub36, (byte) -120);
		...
		if (packet != null) {
		    ...
		    Class298_Sub36 class298_sub36 = Class18.method359(packet, GameClient.aClass25_8711.aClass449_330, (byte) 94);
		    ...
		    GameClient.aClass25_8711.method390(class298_sub36, (byte) -13);
		}
		if (8 == i_34_) { // widget on npc
			...
			GameClient.anInt8748 = 554324810;
			GameClient.anInt8786 = 0;
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.INTERFACE_ON_NPC, (GameClient.aClass25_8711.aClass449_330), (byte) 103);
			...
			class298_sub36.out.writeShortLE128(GameClient.anInt8836 * 392084321);
			class298_sub36.out.writeShortLE(1408085039 * GameClient.anInt8906, 249731045);
			GameClient.aClass25_8711.method390(class298_sub36, (byte) -11);
		...
		if (25 == i_34_) {
			...
			Class298_Sub38 class298_sub38 = GameClient.method2801(class105);
			...
			if (null != player) {
			    ...
			    GameClient.anInt8748 = 554324810;
			    GameClient.anInt8786 = 0;
			    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.INTERFACE_ON_PLAYER, (GameClient.aClass25_8711.aClass449_330), (byte) 92);
			    class298_sub36.out.writeShort(GameClient.anInt8906 * 1408085039, 16711935);
			    class298_sub36.out.writeShort(walktype, 16711935);
			    class298_sub36.out.writeIntV2(Class379.anInt4099 * 1262526353);
			    class298_sub36.out.writeShortLE128(392084321 * GameClient.anInt8836);
			...
			if (GameClient.playerRights * 1806357379 > 0 && Class434.method5802(838408640))
			    ...
			    GameClient.anInt8748 = 277162405;
			    GameClient.anInt8786 = 0;
			    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2082, (GameClient.aClass25_8711.aClass449_330), (byte) 98);
			    class298_sub36.out.writeShort(class341.gameSceneBaseY * 283514611 + dstY, 16711935);
			    class298_sub36.out.writeShort128(-1760580017 * class341.gameSceneBaseX + dstX);
			    GameClient.aClass25_8711.method390(class298_sub36, (byte) -43);
			}
		    }
