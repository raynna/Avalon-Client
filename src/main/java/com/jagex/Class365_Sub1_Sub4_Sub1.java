package com.jagex;/* com.jagex.Class365_Sub1_Sub4_Sub1 - Decompiled by JODE
...
public class Class365_Sub1_Sub4_Sub1 extends Class365_Sub1_Sub4 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("akc.com.jagex.a(").append(')').toString());
	}
    }
