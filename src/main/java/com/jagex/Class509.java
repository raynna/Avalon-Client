package com.jagex;/* com.jagex.Class509 - Decompiled by JODE
...
public class Class509 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("va.com.jagex.a(").append(')').toString());
	}
    }
