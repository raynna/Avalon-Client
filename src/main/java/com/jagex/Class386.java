package com.jagex;
/* com.jagex.Class386 - Decompiled by JODE
...
public class Class386 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("q.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("q.com.jagex.i(").append(')').toString());
	}
    }
