package com.jagex;/* com.jagex.Class264_Sub2 - Decompiled by JODE
...
public class Class264_Sub2 extends Class264 {
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2666(-2068923271);
	    for (int i_108_ = 0; i_108_ < GameClient.aClass19Array8869.length; i_108_++)
		GameClient.aClass19Array8869[i_108_] = null;
		...
		GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_110_] = null;
	    GameClient.anInt8703 = 0;
	    GameClient.aClass437_8696.method5811((byte) -66);
	    GameClient.anInt8772 = 0;
	    GameClient.aClass437_8685.method5811((byte) -127);
