package com.jagex;
/* com.jagex.Class298_Sub19_Sub3 - Decompiled by JODE
...
public class Class298_Sub19_Sub3 extends Class298_Sub19 {
	...
	try {
	    for (int i_11_ = 0; i_11_ < -1230451913 * GameClient.anInt8703; i_11_++) {
		int i_12_ = GameClient.anIntArray8699[i_11_];
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(i_12_));
