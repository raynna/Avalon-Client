...
public class RSApplet extends Class319 implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aci.com.jagex.i(").append(')').toString());
	}
    }
	...
	GameClient.zoomDelta = mousewheelevent.isControlDown() ? 40 : 12;
	if (mousewheelevent.getWheelRotation() == 1) {
		GameClient.zoomDelta = -GameClient.zoomDelta;
		}
    }
