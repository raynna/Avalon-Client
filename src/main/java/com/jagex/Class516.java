package com.jagex;/* com.jagex.Class516 - Decompiled by JODE
...
public class Class516 {
	...
	try {
	    if (i_2_ >= 1 && i_3_ >= 1 && i_2_ <= GameClient.aClass283_8716.method2629(-1894377459) - 2 && i_3_ <= GameClient.aClass283_8716.method2630(793681614) - 2) {
		if (GameClient.aClass283_8716.method2675(-1611682495) != null) {
		    Interface3 interface3 = GameClient.aClass283_8716.method2644(112641684).method2241(i, i_1_, i_2_, i_3_, 2002986961);
		    if (interface3 != null) {
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2667(1924605464);
