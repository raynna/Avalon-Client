package com.jagex;
/* com.jagex.Class422_Sub30 - Decompiled by JODE
...
public class Class422_Sub30 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aez.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		} else if ((GameClient.aClass283_8716.method2675(-1611682495) != null) && class365_sub1_sub1_sub3.method4481((byte) -116))
		    GameClient.aClass283_8716.method2675(-1611682495).method4022(class365_sub1_sub1_sub3, true, (byte) 0);
	    }
	}
	catch (RuntimeException runtimeexception) {
