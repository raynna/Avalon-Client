package com.jagex;/* com.jagex.Class422_Sub3 - Decompiled by JODE
...
public class Class422_Sub3 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("add.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		Player class365_sub1_sub1_sub2_sub2 = GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_2_]];
		if (class365_sub1_sub1_sub2_sub2 != null)
		    class365_sub1_sub1_sub2_sub2.method4428(-586581534);
	    }
	    for (int i_3_ = 0; i_3_ < -1230451913 * GameClient.anInt8703; i_3_++) {
		long l = GameClient.anIntArray8699[i_3_];
		Class298_Sub29 class298_sub29 = (Class298_Sub29) GameClient.aClass437_8696.method5812(l);
