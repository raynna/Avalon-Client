package com.jagex;
/* com.jagex.Class404 - Decompiled by JODE
...
public class Class404 implements Runnable {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qu.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.aBoolean8736 |= Class254.aBooleanArray2790[i_0_];
	}
	catch (RuntimeException runtimeexception) {
