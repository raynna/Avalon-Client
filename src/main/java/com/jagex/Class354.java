package com.jagex;
/* com.jagex.Class354 - Decompiled by JODE
...
public final class Class354 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ot.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.method2801(class105).method3497((byte) 14);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (!((Class221) Class479.aClass479_6009.method6101(-1994130525)).method2050(104668639))
		    GameClient.aBoolean8806 = Class385.aClient4141.method2767(-2027084439);
