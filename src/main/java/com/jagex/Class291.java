package com.jagex;
/* com.jagex.Class291 - Decompiled by JODE
...
public abstract class Class291 extends Loader implements Interface14, Runnable, FocusListener, WindowListener {
    ...
    final void method2751(Class311 class311, String string, String string_0_, int i, int i_1_, int i_2_, int i_3_, boolean bool, byte i_4_) {
        try {
            ...
            throw Class346.method4175(runtimeexception, new StringBuilder().append("mc.com.jagex.a(").append(')').toString());
        }
    }
    ...
    void method2755(File file, File file_18_, int i) {
        try {
            ...
            throw Class346.method4175(runtimeexception, new StringBuilder().append("mc.com.jagex.i(").append(')').toString());
        }
    }
    ...
    final boolean method2758(int i) {
        try {
            ...
            if (string.equals("stellardawn.com") || string.endsWith(".stellardawn.com"))
                return true;
            if (string.endsWith("127.0.0.1") || string.endsWith(Loader.hosted ? Loader.IP : "localhost"))
                return true;
    ...
    void method2759(byte i) {
        try {
            GameClient.currentThread = Thread.currentThread();
            GameClient.executorService = Executors.newSingleThreadExecutor();
    ...
    void method2764(byte i) {
        try {
            ...
            throw Class346.method4175(runtimeexception, new StringBuilder().append("mc.com.jagex.m(").append(')').toString());
        }
    }
    ...
    void method2777(Container container, int i) {
        try {
            ...
            throw Class346.method4175(runtimeexception, new StringBuilder().append("mc.com.jagex.h(").append(')').toString());
        }
    }
    ...
    File method2783(String string, String string_27_, int i, short i_28_) {
        try {
            ...
            if (string_30_ == null && 0 == i) {
                while_74_:
                for (int i_34_ = 0; i_34_ < Class68.aStringArray679.length; i_34_++) {
    ...
    static void method2791(int i, String string, String string_44_, int i_45_) {
        try {
            if (null != GameClient.aClass25_8711) {
                Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2088, GameClient.aClass25_8711.aClass449_330, (byte) 94);
