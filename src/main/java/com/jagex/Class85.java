package com.jagex;/* com.jagex.Class85 - Decompiled by JODE
...
public class Class85 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("dl.com.jagex.a(").append(')').toString());
	}
    }
