package com.jagex;/* com.jagex.Class298_Sub38 - Decompiled by JODE
...
public final class Class298_Sub38 extends Class298 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("abw.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("abw.com.jagex.i(").append(')').toString());
	}
    }
    ...
    static final void method3499(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -1289394455 * Class301_Sub1.anInt7624 == 100 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static void method3501(Class403 class403, short i) {
	try {
	    class403.anIntArray5244[681479919 * class403.anInt5239 - 2] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[class403.anInt5239 * 681479919 - 2]), 245040087).method4566(Class128.aClass148_6331, (class403.anIntArray5244[class403.anInt5239 * 681479919 - 1]), 910416159)) ? 1 : 0;
	...
	try {
	    ...
	    class298_sub36.out.writeByte(1 + Class58.method693(string, 986937694));
	    class298_sub36.out.writeString(string, 2107789256);
	    class298_sub36.out.writeByte128(i, 1999137832);
