package com.jagex;/* com.jagex.Class298_Sub32_Sub14 - Decompiled by JODE
...
public class Class298_Sub32_Sub14 extends Class298_Sub32 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ahc.com.jagex.i(").append(')').toString());
	}
    }
