package com.jagex;/* com.jagex.Class396 - Decompiled by JODE
...
public final class Class396 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qk.com.jagex.a(").append(')').toString());
	}
    }
}
