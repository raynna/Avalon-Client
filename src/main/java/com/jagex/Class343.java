package com.jagex;/* com.jagex.Class343 - Decompiled by JODE
...
public abstract class Class343 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("oh.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    GameClient.anInt8713 += -75983735;
	    GameClient.aBoolean8714 = true;
	    return true;
	}
	catch (RuntimeException runtimeexception) {
