package com.jagex;/* com.jagex.Class161_Sub1_Sub1 - Decompiled by JODE
...
public class Class161_Sub1_Sub1 extends Class161_Sub1 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("afj.com.jagex.a(").append(')').toString());
	}
    }
}
