package com.jagex;/* com.jagex.Class375 - Decompiled by JODE
...
public class Class375 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pp.com.jagex.a(").append(')').toString());
	}
    }
