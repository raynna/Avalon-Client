...
public class ObjectDefinitions {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rw.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rw.com.jagex.h(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rw.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rw.com.jagex.aa(").append(')').toString());
	}
    }
}
