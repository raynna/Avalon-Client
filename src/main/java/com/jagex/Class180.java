package com.jagex;
/* com.jagex.Class180 - Decompiled by JODE
...
public class Class180 implements Interface20 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("hn.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8647 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
