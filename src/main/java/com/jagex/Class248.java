package com.jagex;
/* com.jagex.Class248 - Decompiled by JODE
...
public class Class248 implements Runnable {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kj.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kj.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2673((byte) 25);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2068, GameClient.aClass25_8693.aClass449_330, (byte) 47);
	    ...
	    GameClient.aClass25_8693.method390(class298_sub36, (byte) -123);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (class352.anIntArray3803 != null) {
			...
			if (-863531439 * Class298_Sub1.anInt7164 == 2)
			    i_12_ = (int) GameClient.aFloat8949 & 0x3fff;
			else
			    i_12_ = (GameClient.anInt8801 * 1227356013 + (int) GameClient.aFloat8949) & 0x3fff;
