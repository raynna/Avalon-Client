package com.jagex;/* com.jagex.Class298_Sub17_Sub4 - Decompiled by JODE
...
public class Class298_Sub17_Sub4 extends Class298_Sub17 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ags.com.jagex.a(").append(')').toString());
	}
    }
