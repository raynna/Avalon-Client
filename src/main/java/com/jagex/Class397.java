package com.jagex;/* com.jagex.Class397 - Decompiled by JODE
...
public class Class397 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ql.com.jagex.m(").append(')').toString());
	}
    }
	...
	try {
		...
		if (GameClient.anInt8857 * 892197957 >= 65535) {
		    ...
		    if (!GameClient.aBoolean8776)
			GameClient.aBoolean8775 = true;
		    else
		...
		float f = GameClient.anInt8857 * 892197957 / 65535.0F;
		...
		GameClient.anInt8756 = ((int) (Math.atan2(f_21_, d) * 2607.5945876176133) & 0x3fff) * -648269561;
		Class135.anInt6384 = ((int) (-Math.atan2(f_20_, f_22_) * 2607.5945876176133) & 0x3fff) * -1587695039;
		Class229.anInt6458 = ((GameClient.anIntArrayArrayArray8767[-591434031 * GameClient.anInt8768][i_1_][3]) + ((((GameClient.anIntArrayArrayArray8767[-591434031 * GameClient.anInt8768][2 + i_1_][3]) - (GameClient.anIntArrayArrayArray8767[GameClient.anInt8768 * -591434031][i_1_][3])) * (892197957 * GameClient.anInt8857)) >> 16)) * -851711283;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (Class298_Sub1.anInt7164 * -863531439 == 2)
		    i_28_ = (int) GameClient.aFloat8949 & 0x3fff;
		else
		    i_28_ = (1227356013 * GameClient.anInt8801 + (int) GameClient.aFloat8949) & 0x3fff;
