package com.jagex;/* com.jagex.Class522 - Decompiled by JODE
...
public class Class522 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("w.com.jagex.a(").append(')').toString());
	}
    }
