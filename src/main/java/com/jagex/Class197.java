package com.jagex;
/* com.jagex.Class197 - Decompiled by JODE
...
public class Class197 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ii.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ii.com.jagex.a(").append(')').toString());
	}
    }
