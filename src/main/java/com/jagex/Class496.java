package com.jagex;/* com.jagex.Class496 - Decompiled by JODE
...
public class Class496 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ul.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ul.com.jagex.i(").append(')').toString());
	}
    }
