package com.jagex;/* com.jagex.Class349 - Decompiled by JODE
...
public class Class349 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("oo.com.jagex.a(").append(')').toString());
	}
    }
