package com.jagex;
/* com.jagex.Class93 - Decompiled by JODE
...
final class Class93 implements Interface23 {
	...
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = Class227.method2114(GameClient.aString8804, 864183945);
	    else
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("du.com.jagex.a(").append(')').toString());
	}
    }

    public static void method1012(Class298_Sub50 class298_sub50, int i) {
	try {
	    if (!Class435.method5804(GameClient.anInt8752 * -1233866115, (byte) -26))
