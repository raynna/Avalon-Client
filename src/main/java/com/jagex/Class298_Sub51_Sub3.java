package com.jagex;/* com.jagex.Class298_Sub51_Sub3 - Decompiled by JODE
...
public class Class298_Sub51_Sub3 extends Interface {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ajl.com.jagex.a(").append(')').toString());
	}
    }
