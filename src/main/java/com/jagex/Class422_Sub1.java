package com.jagex;/* com.jagex.Class422_Sub1 - Decompiled by JODE
...
public class Class422_Sub1 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ada.com.jagex.a(").append(')').toString());
	}
    }
