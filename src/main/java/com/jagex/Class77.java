package com.jagex;/* com.jagex.Class77 - Decompiled by JODE
...
public class Class77 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("dc.com.jagex.i(").append(')').toString());
	}
    }
