package com.jagex;/* com.jagex.Class455 - Decompiled by JODE
...
public class Class455 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("st.com.jagex.a(").append(')').toString());
	}
    }
