...
public class ConfigDefinitions {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nq.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    Class436.aClass298_Sub37_Sub15_5466 = (new Class298_Sub37_Sub15(Tradution.aClass470_5934.method6049(Class321.aClass429_3357, -875414210), "", -1808468501 * GameClient.anInt8937, 1006, -1, 0L, 0, 0, true, false, 0L, true));
	}
	catch (RuntimeException runtimeexception) {
