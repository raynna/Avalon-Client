package com.jagex;/* com.jagex.Class82_Sub22 - Decompiled by JODE
...
public class Class82_Sub22 extends Class82 {
	...
	Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(GameClient.aClass283_8716.method2675(-1611682495), this.anInt6908 * 1632084697, i_4_, i_4_, i, i_3_, this.anInt6916 * 266943569 << 2, GameClient.ticketCycle * 443738891, (929559909 * this.anInt6904 + GameClient.ticketCycle * 443738891), -1300008271 * this.anInt6915, i_7_, this.anInt6905 * -153670819 + 1, 1 + -1629854861 * this.anInt6909, this.anInt6912 * 172590773 << 2, false, 0));
	class365_sub1_sub1_sub1.method4405(i_5_, i_6_, 172590773 * this.anInt6912 << 2, (GameClient.ticketCycle * 443738891 + 929559909 * this.anInt6904), -414343918);
	...
	class365_sub1_sub1_sub1.method4405(i_10_, i_11_, 172590773 * this.anInt6912 << 2, (GameClient.ticketCycle * 443738891 + 929559909 * this.anInt6904), 1238518641);
	GameClient.aClass453_8824.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1));
    }
	...
	try {
	    ...
	    class365_sub1_sub1_sub1.method4405(i_16_, i_17_, 172590773 * this.anInt6912 << 2, (GameClient.ticketCycle * 443738891 + 929559909 * this.anInt6904), 1057769456);
	    GameClient.aClass453_8824.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1));
	}
	catch (RuntimeException runtimeexception) {
