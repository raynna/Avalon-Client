package com.jagex;/* com.jagex.Class79 - Decompiled by JODE
...
public class Class79 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("de.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    if (GameClient.drag)
		class105.anInt1235 = GameClient.dragValue * -978869921;
	}
	catch (RuntimeException runtimeexception) {
