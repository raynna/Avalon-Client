package com.jagex;/* com.jagex.Class298_Sub51_Sub2 - Decompiled by JODE
...
public class Class298_Sub51_Sub2 extends Interface {
	...
	Class298_Sub29 class298_sub29 = ((Class298_Sub29) (GameClient.aClass437_8696.method5812(119655585 * this.anInt9777)));
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ajj.com.jagex.a(").append(')').toString());
	}
    }
}
