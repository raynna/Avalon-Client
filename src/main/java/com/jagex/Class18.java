...
public class Class18 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("as.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    if (GameClient.anInt8752 * -1233866115 == 8) {
		Class298_Sub36 class298_sub36 = method359(OutcommingPacket.aClass198_2072, GameClient.aClass25_8693.aClass449_330, (byte) 19);
		...
		GameClient.aClass25_8693.method390(class298_sub36, (byte) -20);
		if (i < 13) {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("as.com.jagex.i(").append(')').toString());
	}
    }
}
