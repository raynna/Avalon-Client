package com.jagex;/* com.jagex.Class219 - Decompiled by JODE
...
public class Class219 implements Runnable {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jf.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jf.com.jagex.i(").append(')').toString());
	}
    }
