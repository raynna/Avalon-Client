package com.jagex;/* com.jagex.Class365_Sub1_Sub2_Sub1 - Decompiled by JODE
...
public class Class365_Sub1_Sub2_Sub1 extends Class365_Sub1_Sub2 implements Interface3 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wm.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wm.com.jagex.i(").append(')').toString());
	}
    }
