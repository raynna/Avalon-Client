package com.jagex;
/* com.jagex.Class288_Sub1 - Decompiled by JODE
...
public class Class288_Sub1 extends Class288 implements Runnable {
	...
	try {
		...
		try {
			...
			class298_sub36.out.writeString(GameClient.aString8655, 2134259589);
			class298_sub36.out.writeShort(GameClient.anInt8665 * -1154804873, 16711935);
			class298_sub36.out.writeLong(GameClient.aLong8645 * -5648129435911399733L);
			class298_sub36.out.writeByte(Class321.aClass429_3357.getType(694163818));
			class298_sub36.out.writeByte(GameClient.gametype.gameType * -937307905);
			...
			GameClient.aClass25_8693.method390(class298_sub36, (byte) -37);
			...
			if (GameClient.aClass25_8693.method387(537308016).isAvailable(1, (byte) -109)) {
			    GameClient.aClass25_8693.method387(537308016).readBytes((GameClient.aClass25_8693.aClass298_Sub53_Sub2_333.buffer), 0, 1, (byte) -97);
			    Class525.aClass412_6299 = ((Class412) (Class422_Sub20.method5701(Class400.method4928((short) 4505), (GameClient.aClass25_8693.aClass298_Sub53_Sub2_333.buffer[0]) & 0xff, (byte) 2)));
				...
				GameClient.aClass25_8693.aClass449_334 = new IsaacCipher(is);
				new IsaacCipher(is);
				GameClient.aClass25_8693.aClass298_Sub53_Sub2_333.method3665((GameClient.aClass25_8693.aClass449_334), (byte) 81);
				Class439.method5851(8, 1887293413);
				GameClient.aClass25_8693.method383((short) 8191);
				GameClient.aClass25_8693.aClass298_Sub53_Sub2_333.index = 0;
				GameClient.aClass25_8693.aClass202_344 = null;
				GameClient.aClass25_8693.aClass202_345 = null;
				GameClient.aClass25_8693.aClass202_348 = null;
				GameClient.aClass25_8693.anInt338 = 0;
			    } else
				GameClient.aClass25_8693.method384((byte) 83);
			    GameClient.aClass25_8693.INCOMMING_PACKET = null;
