package com.jagex;
/* com.jagex.Class140 - Decompiled by JODE
...
public class Class140 implements Runnable {
    ...
    Class142 method1552(int i, int i_0_) {
        try {
            ...
            throw Class346.method4175(runtimeexception, new StringBuilder().append("fr.com.jagex.a(").append(')').toString());
        }
    }
    ...
    public void run() {
        try {
            try {
                ...
                BufferedReader bufferedreader = (new BufferedReader(new InputStreamReader(new DataInputStream(new URL(new StringBuilder().append("http://").append(Class474.aClass471_5976.address).append(":").append(i).append("/news.ws?game=").append(-937307905 * (GameClient.gametype.gameType)).toString()).openStream()))));
