package com.jagex;/* com.jagex.Class272 - Decompiled by JODE
...
public class Class272 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("lh.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2027, GameClient.aClass25_8711.aClass449_330, (byte) 34);
	    class298_sub36.out.writeByte(string.length() + 1);
	    class298_sub36.out.writeString(string, 2114518021);
	    GameClient.aClass25_8711.method390(class298_sub36, (byte) -1);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (i_11_ < 0)
		    i_11_ = 0;
		else if (i_11_ >= GameClient.aClass283_8716.method2629(-1866822819))
		    i_11_ = GameClient.aClass283_8716.method2629(-1973847066);
		i_12_ -= 283514611 * class341.gameSceneBaseY;
		if (i_12_ < 0)
		    i_12_ = 0;
		else if (i_12_ >= GameClient.aClass283_8716.method2630(922370140))
		    i_12_ = GameClient.aClass283_8716.method2630(271939870);
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2667(2089019629);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("lh.com.jagex.i(").append(')').toString());
	}
    }
}
