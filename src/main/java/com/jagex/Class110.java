package com.jagex;/* com.jagex.Class110 - Decompiled by JODE
...
public abstract class Class110 implements Interface8 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("em.com.jagex.a(").append(')').toString());
	}
    }
