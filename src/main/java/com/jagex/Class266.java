package com.jagex;/* com.jagex.Class266 - Decompiled by JODE
...
public class Class266 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("lb.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("lb.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		if (class365_sub1_sub1_sub2.anInt10090 * 1433412323 < 32768) {
		    Class298_Sub29 class298_sub29 = ((Class298_Sub29) (GameClient.aClass437_8696.method5812(1433412323 * class365_sub1_sub1_sub2.anInt10090)));
		    ...
		    class365_sub1_sub1_sub2_7_ = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[(1433412323 * class365_sub1_sub1_sub2.anInt10090 - 32768)]);
