...
public class SubIncommingPacket {
	...
	try {
	    ...
	    try {
		class476 = Class86.method962("2", GameClient.gametype.aString5317, false, -1804643872);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ir.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		Class422_Sub21.aClass318_8414 = GameClient.aClass25_8711.method387(537308016);
		GameClient.aClass25_8711.method385(865497912);
