package com.jagex;
/* com.jagex.Class365_Sub1_Sub5_Sub2 - Decompiled by JODE
...
public class Class365_Sub1_Sub5_Sub2 extends Class365_Sub1_Sub5 implements Interface3 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wr.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wr.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2648(-818859939);
	    ...
	    GameClient.aClass283_8716.method2647(526823496);
	    GameClient.aClass283_8716.method2640((byte) 64).method4324(-1897479103);
	...
	try {
		...
		// if (0 == (com.jagex.Class10.slotFlags[i_32_] & 0x1)) {
		if (i_30_ > 0) {
		    i_30_--;
		    // com.jagex.Class10.slotFlags[i_32_] |= 0x2;
		} else {
	     ...
	     * 0; i_34_ < com.jagex.Class10.anInt129 * 1168366243; i_34_++) { int i_35_ =
	     * com.jagex.Class10.anIntArray135[i_34_]; if (0 != (com.jagex.Class10.slotFlags[i_35_]
	     * & 0x1)) { if (i_30_ > 0) { i_30_--; com.jagex.Class10.slotFlags[i_35_] |=
	     * 0x2; } else { int i_36_ = class298_sub53_sub2.readBits(1); if
	     * (i_36_ == 0) { i_30_ = com.jagex.Class127_Sub3.method1431(
	     * class298_sub53_sub2, 2076159127); com.jagex.Class10.slotFlags[i_35_] |=
	     * 0x2; } else com.jagex.Class500.method6221(class298_sub53_sub2, i_35_,
		...
		// if ((com.jagex.Class10.slotFlags[i_38_] & 0x1) != 0) {
		if (i_30_ > 0) {
		    i_30_--;
		    // com.jagex.Class10.slotFlags[i_38_] |= 0x2;
		} else {
	     ...
	     * i_40_ < com.jagex.Class10.anInt130 * 1430471535; i_40_++) { int i_41_ =
	     * com.jagex.Class10.anIntArray134[i_40_]; if ((com.jagex.Class10.slotFlags[i_41_] &
	     * 0x1) == 0) { if (i_30_ > 0) { i_30_--; com.jagex.Class10.slotFlags[i_41_]
	     * |= 0x2; } else { int i_42_ = class298_sub53_sub2.readBits(1); if
	     * (i_42_ == 0) { i_30_ = com.jagex.Class127_Sub3.method1431(
	     * class298_sub53_sub2, 2129494225); com.jagex.Class10.slotFlags[i_41_] |=
	     * 0x2; } else if (com.jagex.Class501.method6229(class298_sub53_sub2, i_41_,
	     * -1080126826)) com.jagex.Class10.slotFlags[i_41_] |= 0x2; } } }
		...
		// com.jagex.Class10.slotFlags[i_43_] >>= 1;
		Player class365_sub1_sub1_sub2_sub2 = GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_43_];
