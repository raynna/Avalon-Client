package com.jagex;
/* com.jagex.Class492 - Decompiled by JODE
...
public class Class492 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ug.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		if (class19 != null) {
			...
			if (GameClient.aFloatArray8891[0] > -1.0F && 443738891 * GameClient.ticketCycle % 20 < 10) {
			    Class57 class57 = (Class128_Sub2.aClass57Array8560[-92466201 * class19.anInt258]);
			    int i_9_ = (int) (i + GameClient.aFloatArray8891[0] - 12.0F);
			    int i_10_ = (int) (i_2_ + GameClient.aFloatArray8891[1] - 28.0F);
