package com.jagex;/* com.jagex.Class422_Sub27 - Decompiled by JODE
...
public class Class422_Sub27 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aep.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		GameClient.aClass453_8893.add(class298_sub46);
	    }
	}
	catch (RuntimeException runtimeexception) {
