package com.jagex;/* com.jagex.Class165 - Decompiled by JODE
...
public class Class165 implements Interface5 {
	...
	try {
	    // disable equipids
	    /*
	    int[] is = new int[(com.jagex.Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength * -888767613)];
	    int i_9_ = 0;
	    for (int i_10_ = 0; i_10_ < (-888767613 * com.jagex.Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength); i_10_++) {
	    com.jagex.ItemDefinitions class468 = com.jagex.Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_10_, true);
	    if (1343198193 * class468.maleEquipModelId1 >= 0 || 1585491093 * class468.femaleEquipModelId1 >= 0)
	        is[i_9_++] = i_10_;
	    }
	    com.jagex.Class519.anIntArray6274 = new int[i_9_];
	    for (int i_11_ = 0; i_11_ < i_9_; i_11_++)
	    com.jagex.Class519.anIntArray6274[i_11_] = is[i_11_];*/
