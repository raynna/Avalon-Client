package com.jagex;/* com.jagex.Class114 - Decompiled by JODE
...
public class Class114 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eq.com.jagex.a(").append(')').toString());
	}
    }
