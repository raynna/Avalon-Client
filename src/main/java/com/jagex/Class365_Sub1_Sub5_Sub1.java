package com.jagex;
/* com.jagex.Class365_Sub1_Sub5_Sub1 - Decompiled by JODE
...
public class Class365_Sub1_Sub5_Sub1 extends Class365_Sub1_Sub5 implements Interface3 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wg.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wg.com.jagex.a(").append(')').toString());
	}
    }
	...
	if (class454 != null) {
		...
		if (class432.aBoolean5441) {
		    Class287 class287 = GameClient.aClass283_8716.method2632(-2131923625);
