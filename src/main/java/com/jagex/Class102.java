package com.jagex;/* com.jagex.Class102 - Decompiled by JODE
...
public class Class102 {
	...
	try {
	    ...
	    anInt1085 = -1698852737 * GameClient.ticketCycle;
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ed.com.jagex.a(").append(')').toString());
	}
    }

    Class102(int i, int i_7_, String string, String string_8_, String string_9_, String string_10_, int i_11_, String string_12_) {
	anInt1085 = GameClient.ticketCycle * -1698852737;
	anInt1087 = i * 392659741;
