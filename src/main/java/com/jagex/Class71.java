package com.jagex;/* com.jagex.Class71 - Decompiled by JODE
...
public class Class71 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("cw.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("cw.com.jagex.i(").append(')').toString());
	}
    }
