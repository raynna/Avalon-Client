package com.jagex;/* com.jagex.Class422_Sub10 - Decompiled by JODE
...
public class Class422_Sub10 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adl.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    for (int i_6_ = 0; i_6_ < GameClient.anInt8703 * -1230451913; i_6_++) {
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(GameClient.anIntArray8699[i_6_]));
