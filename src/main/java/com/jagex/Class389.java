package com.jagex;/* com.jagex.Class389 - Decompiled by JODE
...
public class Class389 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qc.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qc.com.jagex.a(").append(')').toString());
	}
    }
