package com.jagex;/* com.jagex.Class117 - Decompiled by JODE
...
public class Class117 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("et.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class435.method5804(-1233866115 * GameClient.anInt8752, (byte) -20) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class346.method4172(string, false, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-2014540467) == 5, GameClient.aBoolean8867, GameClient.aBoolean8651, (byte) 37);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.DIALOGUE_CONTINUE_PACKET, GameClient.aClass25_8711.aClass449_330, (byte) 84);
	    class298_sub36.out.writeInt(i, -1769259974);
	    class298_sub36.out.writeShort128(i_11_);
	    GameClient.aClass25_8711.method390(class298_sub36, (byte) -5);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		for (int i_16_ = 0; i_16_ < i_15_; i_16_++) {
		    Player class365_sub1_sub1_sub2_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_16_]]);
		    if (class365_sub1_sub1_sub2_sub2 != null)
			class365_sub1_sub1_sub2_sub2.method4442(i_13_, i_14_, bool, 1554634008);
		}
		for (int i_17_ = 0; i_17_ < GameClient.anInt8703 * -1230451913; i_17_++) {
		    int i_18_ = GameClient.anIntArray8699[i_17_];
		    Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(i_18_));
	...
	try {
		...
		if (2 == -431456739 * class298_sub1.anInt7157)
		    interface3 = ((Interface3) (class331.method4035((2108312995 * class298_sub1.anInt7151), class298_sub1.anInt7150 * 634196087, -2146829167 * class298_sub1.anInt7155, GameClient.anInterface17_8960, -2076271452)));
