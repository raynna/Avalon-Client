package com.jagex;/* com.jagex.Class310 - Decompiled by JODE
...
public class Class310 implements Interface17 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("mw.com.jagex.a(").append(')').toString());
	}
    }
