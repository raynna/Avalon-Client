package com.jagex;
/* com.jagex.Class223 - Decompiled by JODE
...
public class Class223 implements Interface24 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jl.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jl.com.jagex.ia(").append(')').toString());
	}
    }
	...
	static Class57 method2081(byte[] is, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("jl.com.jagex.i(").append(')').toString());
		}
	}
	...
	try {
		...
		GameClient.aClass283_8716.method2641(1825433072).method5793(1390466939);
		...
		GameClient.aClass283_8716.method2640((byte) 31).method4317((byte) 24);
	...
	try {
	    for (Class302_Sub4 class302_sub4 = ((Class302_Sub4) GameClient.aClass442_8650.method5868(-16777216)); null != class302_sub4; class302_sub4 = (Class302_Sub4) GameClient.aClass442_8650.method5872(1278684124)) {
		if (GameClient.ticketCycle * 443738891 >= 591467947 * class302_sub4.anInt7655)
		    ...
		    Class101.aClass264_1084.method2490(class302_sub4.aString7657, (int) (i + GameClient.aFloatArray8891[0]), (int) (GameClient.aFloatArray8891[1] + i_6_), ~0xffffff | 1160845051 * class302_sub4.anInt7651, 0, 8619684);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
