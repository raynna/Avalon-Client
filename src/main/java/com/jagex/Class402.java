package com.jagex;/* com.jagex.Class402 - Decompiled by JODE
...
public class Class402 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qr.com.jagex.a(").append(')').toString());
	}
    }
}
