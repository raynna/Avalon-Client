package com.jagex;
/* com.jagex.Class476 - Decompiled by JODE
...
public final class Class476 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tp.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tp.com.jagex.i(").append(')').toString());
	}
    }
