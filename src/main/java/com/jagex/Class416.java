package com.jagex;/* com.jagex.Class416 - Decompiled by JODE
...
public class Class416 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rg.com.jagex.a(").append(')').toString());
	}
    }
