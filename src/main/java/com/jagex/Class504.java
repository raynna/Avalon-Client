package com.jagex;/* com.jagex.Class504 - Decompiled by JODE
...
public class Class504 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("uv.com.jagex.a(").append(')').toString());
	}
    }
