package com.jagex;/* com.jagex.Class442 - Decompiled by JODE
...
public class Class442 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sg.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sg.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8646 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2641(1725751477).method5794(5, (byte) 49);
	    ...
	    GameClient.aClass348_8780.method4186(5, -1305461493);
	    GameClient.aClass348_8898.method4186(5, -659243138);
	    GameClient.aClass348_8697.method4186(5, -2138729636);
