package com.jagex;
/* com.jagex.Class121 - Decompiled by JODE
...
final class Class121 implements Interface4 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ex.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    Class298_Sub48 class298_sub48 = new Class298_Sub48(GameClient.gametype, 0);
	    try {
		class476 = Class86.method962("", GameClient.gametype.aString5317, false, -1804643872);
		...
		class298_sub48 = new Class298_Sub48(new RsByteBuffer(is), GameClient.gametype, 0);
	    }
