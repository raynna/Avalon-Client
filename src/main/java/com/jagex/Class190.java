package com.jagex;/* com.jagex.Class190 - Decompiled by JODE
...
public class Class190 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("hy.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = GameClient.aStringArray8859[i_5_];
		if (null != GameClient.aStringArray8955[i_5_])
		    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = GameClient.aStringArray8955[i_5_];
		else
