package com.jagex;/* com.jagex.Class443 - Decompiled by JODE
...
public class Class443 {
	...
	try {
	    ...
	    int checkSnow = GameClient.Snow ? -255 : 255;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sh.com.jagex.a(").append(')').toString());
	}
    }
