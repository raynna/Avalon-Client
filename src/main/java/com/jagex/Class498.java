package com.jagex;/* com.jagex.Class498 - Decompiled by JODE
...
public class Class498 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("up.com.jagex.a(").append(')').toString());
	}
    }
