package com.jagex;/* com.jagex.Class303 - Decompiled by JODE
...
public class Class303 {
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.GRAND_EXCHANGE_SLOTS[i_5_].anInt2771 * 5713347;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (i_10_ >= 0 && i_10_ < GameClient.aClass283_8716.method2629(-2022633621) && i_11_ >= 0 && i_11_ < GameClient.aClass283_8716.method2630(211521322) && (i >= 0 && i < GameClient.aClass283_8716.method2629(-2074801405) && i_7_ >= 0 && i_7_ < GameClient.aClass283_8716.method2630(1180671988))) {
		int i_12_ = (Class298_Sub37.calculateRoute(i_10_, i_11_, class365_sub1_sub1_sub2_sub2.getSize(), Routes.createExactStrategy(i, i_7_), (GameClient.aClass283_8716.getSceneClipDataPlane(class365_sub1_sub1_sub2_sub2.plane)), true, GameClient.pathBufferX, GameClient.pathBufferY));
		if (i_12_ >= 1 && i_12_ <= 3) {
		    for (int i_13_ = 0; i_13_ < i_12_ - 1; i_13_++)
			class365_sub1_sub1_sub2_sub2.method4473(GameClient.pathBufferX[i_13_], GameClient.pathBufferY[i_13_], i_8_, (byte) 55);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
