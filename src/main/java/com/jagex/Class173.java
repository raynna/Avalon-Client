package com.jagex;/* com.jagex.Class173 - Decompiled by JODE
...
public class Class173 {
	...
	try {
	    ...
	    if (GameClient.aClass283_8716.method2675(-1611682495) != null && (GameClient.aClass283_8716.method2674(-257896295) != Class266.aClass266_2846) && i_5_ >= 0 && i_6_ >= 0 && i_5_ < GameClient.aClass283_8716.method2629(-1890552944) && i_6_ < GameClient.aClass283_8716.method2630(-1685955624)) {
		long l = i << 28 | i_9_ << 14 | i_8_;
		Class298_Sub2 class298_sub2 = (Class298_Sub2) GameClient.aClass437_8685.method5812(l);
		if (class298_sub2 == null)
		    GameClient.aClass283_8716.method2675(-1611682495).method4059(i, i_5_, i_6_, (byte) 86);
		else {
		    Class298_Sub12 class298_sub12 = (Class298_Sub12) class298_sub2.aClass453_7166.method5939(1766612795);
		    if (class298_sub12 == null)
			GameClient.aClass283_8716.method2675(-1611682495).method4059(i, i_5_, i_6_, (byte) 28);
		    else {
			Class365_Sub1_Sub4_Sub1 class365_sub1_sub4_sub1 = ((Class365_Sub1_Sub4_Sub1) GameClient.aClass283_8716.method2675(-1611682495).method4059(i, i_5_, i_6_, (byte) 119));
			if (class365_sub1_sub4_sub1 == null)
			    class365_sub1_sub4_sub1 = (new Class365_Sub1_Sub4_Sub1(GameClient.aClass283_8716.method2675(-1611682495), i_5_ << 265, GameClient.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[i].method6341(i_5_, i_6_, (byte) -15), i_6_ << 265, i, i));
			else {
			    ...
			    class365_sub1_sub4_sub1.aClass331_7722 = GameClient.aClass283_8716.method2675(-1611682495);
			}
			...
			if (GameClient.aClass283_8716.method2654(361928521).method2320(i_5_, i_6_, -1635198415))
			    class365_sub1_sub4_sub1.aByte7724++;
			GameClient.aClass283_8716.method2675(-1611682495).method4053(i, i_5_, i_6_, i_13_, class365_sub1_sub4_sub1, 1648403764);
		    }
		}
	    }
	}
	...
	try {
		...
		GameClient.anInt8756 = ((int) (Math.atan2(i_28_, i_30_) * 2607.5945876176133) & 0x3fff) * -648269561;
		Class135.anInt6384 = ((int) (Math.atan2(i_27_, i_29_) * -2607.5945876176133) & 0x3fff) * -1587695039;
		Class229.anInt6458 = 0;
		if (-104436553 * GameClient.anInt8756 < 1024)
		    GameClient.anInt8756 = 1891900416;
		if (GameClient.anInt8756 * -104436553 > 3072)
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("he.com.jagex.i(").append(')').toString());
	}
    }
