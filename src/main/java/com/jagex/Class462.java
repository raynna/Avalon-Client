package com.jagex;/* com.jagex.Class462 - Decompiled by JODE
...
public class Class462 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("t.com.jagex.a(").append(')').toString());
	}
    }
