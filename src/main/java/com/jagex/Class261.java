package com.jagex;/* com.jagex.Class261 - Decompiled by JODE
...
public final class Class261 implements Comparable {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kx.com.jagex.a(").append(')').toString());
	}
    }
