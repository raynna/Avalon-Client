package com.jagex;/* com.jagex.Class320 - Decompiled by JODE
...
public class Class320 implements Interface21 {
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2640((byte) -42).method4324(-1416696139);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ni.com.jagex.a(").append(')').toString());
	}
    }
}
