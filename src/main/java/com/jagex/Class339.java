package com.jagex;/* com.jagex.Class339 - Decompiled by JODE
...
public class Class339 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("od.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("od.com.jagex.i(").append(')').toString());
	}
    }
