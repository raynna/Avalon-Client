package com.jagex;/* com.jagex.Class207 - Decompiled by JODE
...
public class Class207 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("is.com.jagex.a(").append(')').toString());
	}
    }
