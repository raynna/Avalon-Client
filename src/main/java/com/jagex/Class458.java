package com.jagex;/* com.jagex.Class458 - Decompiled by JODE
...
public class Class458 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sw.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sw.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2041, GameClient.aClass25_8711.aClass449_330, (byte) 19);
	    class298_sub36.out.writeByte(string.length() + 1);
	    class298_sub36.out.writeString(string, 2140741369);
	    GameClient.aClass25_8711.method390(class298_sub36, (byte) -70);
	}
	catch (RuntimeException runtimeexception) {
