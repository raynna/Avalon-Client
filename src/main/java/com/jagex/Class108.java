...
/* com.jagex.Class108 - Decompiled by JODE
...
public class Class108 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ek.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.CLOSE_INTERFACE_PACKET, GameClient.aClass25_8711.aClass449_330, (byte) 111);
	    GameClient.aClass25_8711.method390(class298_sub36, (byte) -21);
	    for (Interface class298_sub51 = ((Interface) GameClient.aClass437_8841.method5816(1892786919)); null != class298_sub51; class298_sub51 = ((Interface) GameClient.aClass437_8841.method5815((byte) -93))) {
		...
		Tradution.method6054(GameClient.aClass105_8652, -1209330591);
