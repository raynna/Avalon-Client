package com.jagex;/* com.jagex.Class422_Sub16 - Decompiled by JODE
...
public class Class422_Sub16 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adu.com.jagex.a(").append(')').toString());
	}
    }
