package com.jagex;/* com.jagex.Class107 - Decompiled by JODE
...
public class Class107 {
	...
	try {
	    ...
	    Interface class298_sub51 = ((Interface) GameClient.aClass437_8841.method5812(i_0_));
	...
	try {
		...
		GameClient.aBoolean8725 = false;
		Class228.method2117(1960223809);
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2011, GameClient.aClass25_8711.aClass449_330, (byte) 30);
		class298_sub36.out.writeByte(bool ? 1 : 0);
		GameClient.aClass25_8711.method390(class298_sub36, (byte) -61);
	    }
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ej.com.jagex.i(").append(')').toString());
	}
    }
}
