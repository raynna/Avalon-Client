package com.jagex;/* com.jagex.Class298_Sub40_Sub3 - Decompiled by JODE
...
public class Class298_Sub40_Sub3 extends Class298_Sub40 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aga.com.jagex.a(").append(')').toString());
	}
    }
