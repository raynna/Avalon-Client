package com.jagex;/* com.jagex.Class378 - Decompiled by JODE
...
public class Class378 {
	...
	try {
	    ...
	    Class255.errorPrint(runtimeexception.toString() + "\n" + new StringBuilder().append("ps.com.jagex.i(").append(')').toString());
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ps.com.jagex.i(").append(')').toString());
	}
    }
}
