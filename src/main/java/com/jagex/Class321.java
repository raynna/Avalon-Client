package com.jagex;/* com.jagex.Class321 - Decompiled by JODE
...
public class Class321 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nj.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		if (i == 1)
		    ...
		    Class333 class333 = (GameClient.aClass283_8716.method2675(-1611682495).aClass333_3512);
		    ...
		    GameClient.aClass283_8716.aLong3045 = Class122.method1319((byte) 1) * 3385627052850178407L;
		    GameClient.aClass283_8716.aBoolean3008 = true;
		    ...
		    Class217 class217 = (Class287.myPlayer.method4337().aClass217_2599);
		    Class255.method2435(new StringBuilder().append("").append(GameClient.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[(Class287.myPlayer.plane)].method6341((int) class217.aFloat2451 >> 9, (int) class217.aFloat2454 >> 9, (byte) -102)).toString(), 417961088);
		} else if (i == 3) {
		    ...
		    Class373.aClass_ra4071.method5061(GameClient.aBoolean8668);
		    Class422_Sub1.method5626(-1727592457);
		} else if (11 == i) {
		    GameClient.anInt8814 = 0;
		    GameClient.aClass283_8716.method2667(72202504);
		} else if (9 == i) {
		    GameClient.anInt8814 = 1482609571;
		    GameClient.aClass283_8716.method2667(418889356);
		} else if (28 == i) {
		    GameClient.anInt8814 = -1329748154;
		    GameClient.aClass283_8716.method2667(989855246);
		}
	    }
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nj.com.jagex.h(").append(')').toString());
	}
    }
}
