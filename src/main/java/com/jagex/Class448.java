package com.jagex;/* com.jagex.Class448 - Decompiled by JODE
...
public final class Class448 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sm.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sm.com.jagex.i(").append(')').toString());
	}
    }
