package com.jagex;/* com.jagex.Class422_Sub17 - Decompiled by JODE
...
public class Class422_Sub17 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adw.com.jagex.a(").append(')').toString());
	}
    }
