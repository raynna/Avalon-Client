package com.jagex;/* com.jagex.Class97_Sub1 - Decompiled by JODE
...
final class Class97_Sub1 extends Class97 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("yz.com.jagex.a(").append(')').toString());
	}
    }
