package com.jagex;/* com.jagex.Class359 - Decompiled by JODE
...
public class Class359 implements Interface19 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("oz.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) GameClient.aFloatArray8891[0];
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) GameClient.aFloatArray8891[1];
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) GameClient.aFloatArray8891[2];
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2641(2004012946).method5791(i_12_, -1760580017);
	    ...
	    GameClient.aClass283_8716.method2667(1301460504);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2028, GameClient.aClass25_8693.aClass449_330, (byte) 66);
		...
		GameClient.aClass25_8693.method390(class298_sub36, (byte) -40);
	    }
	}
	catch (RuntimeException runtimeexception) {
