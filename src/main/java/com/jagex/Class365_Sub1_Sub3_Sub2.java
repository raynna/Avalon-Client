package com.jagex;/* com.jagex.Class365_Sub1_Sub3_Sub2 - Decompiled by JODE
...
public class Class365_Sub1_Sub3_Sub2 extends Class365_Sub1_Sub3 implements Interface3 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wq.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wq.com.jagex.i(").append(')').toString());
	}
    }
	...
	if (null != class454) {
		...
		if (class432.aBoolean5441) {
		    Class287 class287 = GameClient.aClass283_8716.method2632(-2114342399);
