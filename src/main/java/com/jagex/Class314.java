package com.jagex;/* com.jagex.Class314 - Decompiled by JODE
...
public class Class314 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nb.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nb.com.jagex.a(").append(')').toString());
	}
    }
