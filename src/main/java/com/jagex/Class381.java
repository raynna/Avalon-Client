package com.jagex;/* com.jagex.Class381 - Decompiled by JODE
...
public class Class381 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pv.com.jagex.a(").append(')').toString());
	}
    }
