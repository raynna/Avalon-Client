package com.jagex;
/* com.jagex.Class148 - Decompiled by JODE
...
public class Class148 implements Interface23 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("g.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("g.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.anInt8665 * -1154804873;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8680 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
