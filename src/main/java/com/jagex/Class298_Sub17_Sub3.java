package com.jagex;/* com.jagex.Class298_Sub17_Sub3 - Decompiled by JODE
...
public class Class298_Sub17_Sub3 extends Class298_Sub17 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("agk.com.jagex.a(").append(')').toString());
	}
    }
