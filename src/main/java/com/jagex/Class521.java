package com.jagex;/* com.jagex.Class521 - Decompiled by JODE
...
public class Class521 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("vz.com.jagex.a(").append(')').toString());
	}
    }
}
