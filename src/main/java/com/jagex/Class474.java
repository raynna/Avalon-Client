package com.jagex;/* com.jagex.Class474 - Decompiled by JODE
...
public class Class474 {
	...
	try {
	    if (i > i_0_)
		Class82_Sub22.method940((Class372.anIntArrayArray4047[i_1_]), i_0_, i, i_2_, 1232193960);
	    else
		Class82_Sub22.method940((Class372.anIntArrayArray4047[i_1_]), i, i_0_, i_2_, 583868785);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7553, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]), -877652668);
