package com.jagex;/* com.jagex.Class16 - Decompiled by JODE
...
public class Class16 {
	...
	try {
		...
		if (Class411.game_stellardawn == GameClient.gametype)
		    i_19_ = -1996488705;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aq.com.jagex.a(").append(')').toString());
	}
    }
}
