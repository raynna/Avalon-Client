package com.jagex;/* com.jagex.Class151 - Decompiled by JODE
...
public class Class151 implements Interface5 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("gc.com.jagex.a(").append(')').toString());
	}
    }
