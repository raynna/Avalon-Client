package com.jagex;/* com.jagex.Class356 - Decompiled by JODE
...
public class Class356 {
	...
	try {
	    ...
	    int i_7_ = i >> 9;
	    int i_8_ = i_4_ >> 9;
	    if (i_7_ < 0 || i_8_ < 0 || i_7_ > GameClient.aClass283_8716.method2629(-1956967905) - 1 || i_8_ > GameClient.aClass283_8716.method2630(1920772834) - 1)
		return 0;
	    int i_9_ = i_5_;
	    if (i_9_ < 3 && ((GameClient.aClass283_8716.method2654(2001279106).aByteArrayArrayArray2731[1][i_7_][i_8_]) & 0x2) != 0)
		i_9_++;
	    return GameClient.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[i_9_].method6340(i, i_4_, -1909964281);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8643 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
