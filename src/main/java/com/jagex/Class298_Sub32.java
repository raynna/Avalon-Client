package com.jagex;/* com.jagex.Class298_Sub32 - Decompiled by JODE
...
public abstract class Class298_Sub32 extends Class298 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("abq.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("abq.com.jagex.i(").append(')').toString());
	}
    }
