package com.jagex;
/* com.jagex.Class227 - Decompiled by JODE
...
public class Class227 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jp.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		Rectangle rectangle = GameClient.aRectangleArray8902[i_14_];
	...
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = GameClient.aStringArray8947[i_15_];
	    else
