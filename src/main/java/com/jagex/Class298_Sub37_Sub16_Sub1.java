package com.jagex;/* com.jagex.Class298_Sub37_Sub16_Sub1 - Decompiled by JODE
...
public class Class298_Sub37_Sub16_Sub1 extends Class298_Sub37_Sub16 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("akb.com.jagex.a(").append(')').toString());
	}
    }
