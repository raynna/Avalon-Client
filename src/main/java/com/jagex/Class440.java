package com.jagex;/* com.jagex.Class440 - Decompiled by JODE
...
public final class Class440 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("se.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("se.com.jagex.i(").append(')').toString());
	}
    }
