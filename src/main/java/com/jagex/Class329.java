package com.jagex;
/* com.jagex.Class329 - Decompiled by JODE
...
public final class Class329 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ns.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    String string = (class403.aClass162_5252.method1755(-937307905 * GameClient.gametype.gameType << 16 | i_60_, -1713280768));
	    String string_61_;
	    if (null == string)
		string_61_ = "";
	    else
	...
	try {
	    ...
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2073, GameClient.aClass25_8711.aClass449_330, (byte) 13);
