package com.jagex;/* com.jagex.Class376 - Decompiled by JODE
...
public class Class376 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pq.com.jagex.a(").append(')').toString());
	}
    }
