package com.jagex;/* com.jagex.Class298_Sub17_Sub2 - Decompiled by JODE
...
public class Class298_Sub17_Sub2 extends Class298_Sub17 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("agj.com.jagex.a(").append(')').toString());
	}
    }
