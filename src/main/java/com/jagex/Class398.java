package com.jagex;/* com.jagex.Class398 - Decompiled by JODE
...
public class Class398 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qm.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qm.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    if (i_23_ >= 1 && i_24_ >= 1 && i_23_ <= GameClient.aClass283_8716.method2629(-1936425983) - 2 && (i_24_ <= GameClient.aClass283_8716.method2630(-1245034974) - 2)) {
		int i_30_ = i;
		if (i_30_ < 3 && GameClient.aClass283_8716.method2654(511320643).method2320(i_23_, i_24_, 549965572))
		    i_30_++;
		if (GameClient.aClass283_8716.method2675(-1611682495) != null) {
		    GameClient.aClass283_8716.method2644(-1368274969).method2234(Class373.aClass_ra4071, i, i_22_, i_23_, i_24_, GameClient.aClass283_8716.getSceneClipDataPlane(i), 366084983);
		    if (i_25_ >= 0) {
			...
			GameClient.aClass283_8716.method2644(-630573167).method2243(Class373.aClass_ra4071, i_30_, i, i_23_, i_24_, i_25_, i_26_, i_27_, GameClient.aClass283_8716.getSceneClipDataPlane(i), i_28_, 2073430416);
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2667(1778418334);
	}
	catch (RuntimeException runtimeexception) {
