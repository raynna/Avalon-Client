package com.jagex;/* com.jagex.Class473 - Decompiled by JODE
...
public class Class473 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tm.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		if (-1 != -967533709 * (class365_sub1_sub1_sub2.currentGraphics[i_2_].id)) {
			...
			if (class398.aBoolean5215) {
				...
				if ((1888275831 * class365_sub1_sub1_sub2.anInt10125) > 0 && ((class365_sub1_sub1_sub2.anInt10095 * -412225079) <= GameClient.ticketCycle * 443738891) && ((1450943713 * class365_sub1_sub1_sub2.anInt10103) < 443738891 * GameClient.ticketCycle)) {
				    class438_3_.method5821(-1, -1544973787);
				    class365_sub1_sub1_sub2.currentGraphics[i_2_].id = -1313669563;
				    continue;
				}
			    } else if (1 == class391.anInt4182 * 62820525 && (class365_sub1_sub1_sub2.anInt10125 * 1888275831) > 0 && ((-412225079 * (class365_sub1_sub1_sub2.anInt10095)) <= 443738891 * GameClient.ticketCycle) && ((1450943713 * (class365_sub1_sub1_sub2.anInt10103)) < 443738891 * GameClient.ticketCycle)) {
				if (i <= 0)
				    throw new IllegalStateException();
				continue;
			    }
		...
		if (class438_4_.method5819((byte) -111)) {
			...
			if (1888275831 * class365_sub1_sub1_sub2.anInt10125 > 0 && (class365_sub1_sub1_sub2.anInt10095 * -412225079 <= GameClient.ticketCycle * 443738891) && (class365_sub1_sub1_sub2.anInt10103 * 1450943713 < 443738891 * GameClient.ticketCycle)) {
			    class365_sub1_sub1_sub2.anIntArray10093 = null;
			    class438_4_.method5821(-1, -1775890638);
			    break;
			}
		    } else if (class391.anInt4182 * 62820525 == 1) {
			if (1888275831 * class365_sub1_sub1_sub2.anInt10125 > 0 && (class365_sub1_sub1_sub2.anInt10095 * -412225079 <= 443738891 * GameClient.ticketCycle) && (class365_sub1_sub1_sub2.anInt10103 * 1450943713 < 443738891 * GameClient.ticketCycle)) {
