package com.jagex;/* com.jagex.Class160 - Decompiled by JODE
...
public class Class160 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("gn.com.jagex.a(").append(')').toString());
	}
    }
