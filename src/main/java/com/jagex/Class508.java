package com.jagex;/* com.jagex.Class508 - Decompiled by JODE
...
public class Class508 {
	...
	try {
	    ...
	    for (;;) {
		if (stream.method3660((-866602563 * (GameClient.aClass25_8711.anInt336)), (byte) -70) < 15) {
		    if (i != 596994841)
			break;
		    return;
		}
		...
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(i_3_));
		if (class298_sub29 == null) {
		    NPC class365_sub1_sub1_sub2_sub1 = (new NPC(GameClient.aClass283_8716.method2675(-1611682495)));
		    class365_sub1_sub1_sub2_sub1.anInt10064 = 1714292119 * i_3_;
		    class298_sub29 = new Class298_Sub29(class365_sub1_sub1_sub2_sub1);
		    GameClient.aClass437_8696.method5817(class298_sub29, i_3_);
		    GameClient.aClass298_Sub29Array8816[(GameClient.anInt8772 += -118843751) * 1962237353 - 1] = class298_sub29;
		    bool_4_ = true;
		}
		NPC class365_sub1_sub1_sub2_sub1 = ((NPC) class298_sub29.anObject7366);
		GameClient.anIntArray8699[(GameClient.anInt8703 += -409937273) * -1230451913 - 1] = i_3_;
