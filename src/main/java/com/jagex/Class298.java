package com.jagex;/* com.jagex.Class298 - Decompiled by JODE
...
public class Class298 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("mk.com.jagex.h(").append(')').toString());
	}
    }
