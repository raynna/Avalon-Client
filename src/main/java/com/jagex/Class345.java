package com.jagex;/* com.jagex.Class345 - Decompiled by JODE
...
public class Class345 implements Interface19 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("oj.com.jagex.a(").append(')').toString());
	}
    }
