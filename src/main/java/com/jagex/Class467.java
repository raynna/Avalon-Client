package com.jagex;/* com.jagex.Class467 - Decompiled by JODE
...
public final class Class467 {
	...
	try {
	    ...
	    if (i_0_ < GameClient.anInt8703 * -1230451913) {
		for (int i_1_ = i_0_; i_1_ < -1230451913 * GameClient.anInt8703; i_1_++)
		    GameClient.anIntArray8709[(GameClient.anInt8708 += 107511579) * -1508392173 - 1] = GameClient.anIntArray8699[i_1_];
	    }
	    if (i_0_ > GameClient.anInt8703 * -1230451913)
		throw new RuntimeException();
	    GameClient.anInt8703 = 0;
	    for (int i_2_ = 0; i_2_ < i_0_; i_2_++) {
		int i_3_ = GameClient.anIntArray8699[i_2_];
		NPC class365_sub1_sub1_sub2_sub1 = ((NPC) (((Class298_Sub29) GameClient.aClass437_8696.method5812(i_3_)).anObject7366));
