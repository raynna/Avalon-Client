package com.jagex;/* com.jagex.Class377 - Decompiled by JODE
...
public class Class377 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pr.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = GameClient.aBooleanArray8722[i_5_] ? 1 : 0;
	    else
