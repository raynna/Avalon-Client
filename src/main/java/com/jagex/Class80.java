package com.jagex;/* com.jagex.Class80 - Decompiled by JODE
...
public class Class80 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("df.com.jagex.a(").append(')').toString());
	}
    }
