package com.jagex;
/* com.jagex.Class25 - Decompiled by JODE
...
public class Class25 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("az.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    if (GameClient.ticketCycle * 443738891 % 50 == 0) {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("az.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("az.com.jagex.m(").append(')').toString());
	}
    }
}
