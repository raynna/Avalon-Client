...
public class ItemDefinitions {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("th.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("th.com.jagex.h(").append(')').toString());
	}
    }
	...
	try {
		...
		for (int i_75_ = 0; i_75_ < i_73_; i_75_++) {// com.jagex.client script
							     // map
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("th.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		GameClient.aClass222_8871.method2062(0.0F, 256.0F, 0.0F);
		Class373.aClass_ra4071.method5043(GameClient.aClass222_8871);
		Class233 class233 = Class373.aClass_ra4071.method5036();
		class233.method2152(dimension.width / 2, dimension.height / 2, 512.0F, 512.0F, GameClient.aClass283_8716.method2634((byte) -121), GameClient.aClass283_8716.method2635(1789119116), dimension.width, dimension.height);
		...
		while_107_: for (int i_94_ = 0; i_94_ < 500; i_94_++) {
			...
			for (int i_96_ = 0; i_96_ <= i_95_; i_96_++) {
			    GameClient.aClass222_8968.method2062((int) (512.0F * (i_96_ - i_95_ / 2.0F)), 0.0F, (1 + i_95_) * 512);
			    class387.method4739(GameClient.aClass222_8968, null, 0);
			    i_93_++;
