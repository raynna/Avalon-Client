package com.jagex;/* com.jagex.Class405 - Decompiled by JODE
...
public class Class405 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qv.com.jagex.a(").append(')').toString());
	}
    }

    static final void method4956(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8802 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class443.method5884(-257444687 * GameClient.WINDOW_PANE_ID, 186134073);
	    for (int i_5_ = 0; i_5_ < -112139815 * GameClient.anInt8686; i_5_++) {
		GameClient.aBooleanArray8901[i_5_] = GameClient.aBooleanArray8900[i_5_];
		GameClient.aBooleanArray8900[i_5_] = false;
	    }
	    GameClient.anInt8832 = -1390800553 * GameClient.ticketCycle;
	    ...
	    if (-1 == i_6_)
		i_6_ = GameClient.anInt8937 * -1808468501;
	    if (-1 == i_6_)
