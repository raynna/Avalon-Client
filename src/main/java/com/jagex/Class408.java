package com.jagex;/* com.jagex.Class408 - Decompiled by JODE
...
public class Class408 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qy.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qy.com.jagex.i(").append(')').toString());
	}
    }
