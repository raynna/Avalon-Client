package com.jagex;/* com.jagex.Class237 - Decompiled by JODE
...
public class Class237 implements Interface24 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jz.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.aBoolean8811 && !GameClient.aBoolean8812 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
