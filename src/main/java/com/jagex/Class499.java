package com.jagex;/* com.jagex.Class499 - Decompiled by JODE
...
public class Class499 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("uq.com.jagex.a(").append(')').toString());
	}
    }
