package com.jagex;/* com.jagex.Class131 - Decompiled by JODE
...
public class Class131 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("fh.com.jagex.a(").append(')').toString());
	}
    }
