package com.jagex;/* com.jagex.Class342 - Decompiled by JODE
...
public class Class342 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("og.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    if (0 != 1806357379 * GameClient.playerRights || ((!GameClient.aBoolean8811 || GameClient.aBoolean8812) && !GameClient.aBoolean8802)) {
		Class25 class25 = Class429.method5760((short) 512);
