package com.jagex;
/* com.jagex.Class406 - Decompiled by JODE
...
public final class Class406 {
	...
	try {
		...
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(i_5_));
		...
		GameClient.anInt8772 = (GameClient.aClass437_8696.method5814(1946710966) * -118843751);
		int i_7_ = 0;
	    ...
	    if (385051775 * (GameClient.aClass25_8711.aClass298_Sub53_Sub2_333.index) != GameClient.aClass25_8711.anInt336 * -866602563) {
		/*
		 * throw new RuntimeException( new StringBuilder() .append(
		 * 385051775 * (((com.jagex.Class25)
		 * com.jagex.client.aClass25_8711).aClass298_Sub53_Sub2_333.index))
		 * .append(" ") .append( -866602563 ((com.jagex.Class25)
		 * com.jagex.client.aClass25_8711).anInt336) .toString());
		 */
	    }
	    for (int i_9_ = 0; i_9_ < -1230451913 * GameClient.anInt8703; i_9_++) {
		if (GameClient.aClass437_8696.method5812(GameClient.anIntArray8699[i_9_]) == null) {
		    /*
		     * throw new RuntimeException(new
		     * StringBuilder().append(i_9_)
		     * .append(" ").append(com.jagex.client.anInt8703 * -1230451913)
		     * .toString());
		     */
		}
	    }
	    if (0 != (GameClient.anInt8772 * 1962237353 - -1230451913 * GameClient.anInt8703)) {
		/*
		 * throw new RuntimeException(new StringBuilder().append("")
		 * .append( com.jagex.client.anInt8772 * 1962237353 - (-1230451913 *
		 * com.jagex.client.anInt8703)) .toString());
		 */
	    }
	    for (int i_10_ = 0; i_10_ < GameClient.anInt8772 * 1962237353; i_10_++) {
		if (-1402769421 * ((Entity) (GameClient.aClass298_Sub29Array8816[i_10_].anObject7366)).anInt10075 != 440189755 * GameClient.anInt8707) {
		    /*
		     * throw new RuntimeException( new StringBuilder()
		     * .append("") .append( ((com.jagex.Entity)
		     * (com.jagex.client.aClass298_Sub29Array8816
