package com.jagex;/* com.jagex.Class94 - Decompiled by JODE
...
public final class Class94 {
	...
	try {
		...
		if (1762367763 * anInt909 >= 0) {
		    this.aClass365_Sub1_Sub1_Sub2_Sub1_910 = (new NPC(GameClient.aClass283_8716.method2675(-1611682495), 25));
		    this.aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10064 = this.anInt906 * 302956801;
		    this.aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10075 = GameClient.ticketCycle * -128551287;
		    ...
		    this.aClass365_Sub1_Sub1_Sub2_Sub2_911 = (new Player(GameClient.aClass283_8716.method2675(-1611682495), 25));
		    ...
		    this.aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10075 = -128551287 * GameClient.ticketCycle;
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("dv.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("dv.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2640((byte) -42).method4324(134111872);
	...
	try {
	    if (GameClient.playerRights * 1806357379 >= 2)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 1806357379 * GameClient.playerRights;
	    else
	...
	try {
		...
		if (i_12_ == 0) {
		    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = GameClient.WINDOW_PANE_ID * -257444687;
		    return;
		}
		i_12_--;
	    }
	    Interface class298_sub51 = ((Interface) GameClient.aClass437_8841.method5816(1645730647));
	    while (i_12_-- > 0)
		class298_sub51 = (Interface) GameClient.aClass437_8841.method5815((byte) -33);
