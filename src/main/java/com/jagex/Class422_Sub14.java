package com.jagex;/* com.jagex.Class422_Sub14 - Decompiled by JODE
...
public class Class422_Sub14 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adq.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("adq.com.jagex.h(").append(')').toString());
	}
    }
