package com.jagex;/* com.jagex.Class365_Sub1_Sub2_Sub2 - Decompiled by JODE
...
public class Class365_Sub1_Sub2_Sub2 extends Class365_Sub1_Sub2 implements Interface3 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wo.com.jagex.i(").append(')').toString());
	}
    }
	...
	if (class454 != null) {
		...
		if (class432.aBoolean5441) {
		    Class287 class287 = GameClient.aClass283_8716.method2632(-1945230052);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wo.com.jagex.a(").append(')').toString());
	}
    }
