...
public class ClanChannel extends Class298 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("abj.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("abj.com.jagex.a(").append(')').toString());
	}
    }
