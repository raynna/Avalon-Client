package com.jagex;/* com.jagex.Class119 - Decompiled by JODE
...
public class Class119 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ev.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    ObjectDefinitions class432 = GameClient.aClass283_8716.method2641(-1623210152).getObjectDefinitions(interface3.method32((byte) 18));
