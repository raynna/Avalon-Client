package com.jagex;/* com.jagex.Class420 - Decompiled by JODE
...
public final class Class420 {
	...
	try {
		...
		if (i_0_ >= 0 && i_1_ >= 0 && i_0_ < GameClient.aClass283_8716.method2629(-1908372692) && i_1_ < GameClient.aClass283_8716.method2630(629047644))
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rk.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.GRAND_EXCHANGE_SLOTS[i_8_].anInt2769 * 1383593425;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (!class298_sub1.aBoolean7160) {
		    class298_sub1.aBoolean7159 = true;
		    if (634196087 * class298_sub1.anInt7150 >= 0 && class298_sub1.anInt7155 * -2146829167 >= 0 && (634196087 * class298_sub1.anInt7150 < GameClient.aClass283_8716.method2629(-1871526843)) && (class298_sub1.anInt7155 * -2146829167 < GameClient.aClass283_8716.method2630(-1895886966)))
