package com.jagex;/* com.jagex.Class395 - Decompiled by JODE
...
public class Class395 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qj.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qj.com.jagex.a(").append(')').toString());
	}
    }
