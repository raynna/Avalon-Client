package com.jagex;/* com.jagex.Class491 - Decompiled by JODE
...
public class Class491 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("uf.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    int i = 1734240325 * GameClient.anInt8817 + (int) class217.aFloat2451;
	    int i_3_ = GameClient.anInt8742 * 1874511679 + (int) class217.aFloat2454;
	    ...
	    GameClient.aFloat8949 += l * GameClient.aFloat8759 / 6.0F;
	    GameClient.aFloat8757 += GameClient.aFloat8760 * l / 6.0F;
