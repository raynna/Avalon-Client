...
public class ClientScriptsExecutor {
	...
	try {
	    if (Class151.method1646(GameClient.anInt8752 * -1233866115, -1337586273)) {
		if (GameClient.aClass25_8693.method387(537308016) == null)
		    Class439.method5851(4, 1378010016);
		else
		    Class439.method5851(14, 310060879);
	    } else if (-1233866115 * GameClient.anInt8752 == 4 || GameClient.anInt8752 * -1233866115 == 3)
		Class439.method5851(19, 1879261492);
	    else if (GameClient.anInt8752 * -1233866115 == 6)
