package com.jagex;/* com.jagex.Class256 - Decompiled by JODE
...
public class Class256 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ks.com.jagex.a(").append(')').toString());
	}
    }
