package com.jagex;/* com.jagex.Class422_Sub29 - Decompiled by JODE
...
public class Class422_Sub29 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aer.com.jagex.a(").append(')').toString());
	}
    }
