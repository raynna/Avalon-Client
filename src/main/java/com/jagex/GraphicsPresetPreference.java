package com.jagex;/* Class422_Sub23 - Decompiled by JODE
...
public class GraphicsPresetPreference extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aeg.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		byte[][][] is = GameClient.aClass283_8716.method2642(899241973);
		byte i_2_ = (byte) (-1953789277 * GameClient.anInt8777 - 4 & 0xff);
		int i_3_ = (-1953789277 * GameClient.anInt8777 % GameClient.aClass283_8716.method2629(-2129604944));
		for (int i_4_ = 0; i_4_ < 4; i_4_++) {
		    for (int i_5_ = 0; i_5_ < GameClient.aClass283_8716.method2630(-605085367); i_5_++)
		...
		if (Class99.anInt952 * 1855729883 != 3) {
		    ...
		    Class244 class244 = GameClient.aClass283_8716.method2654(688600578);
			...
			if (Class298_Sub1.anInt7164 * -863531439 == 4 || Class100.anInt1081 * 1329981847 != -1) {
				...
				if (i_12_ > i_10_)
				    ...
				    i_14_ = i_10_ - i_12_;
				if (0 == i_13_ && 0 == i_14_ || i_13_ <= -GameClient.aClass283_8716.method2629(-1952640446) || i_13_ >= GameClient.aClass283_8716.method2629(-2135239698) || i_14_ <= -GameClient.aClass283_8716.method2630(115807107) || i_14_ >= GameClient.aClass283_8716.method2630(-1212701794)) {
