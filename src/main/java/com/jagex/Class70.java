package com.jagex;/* com.jagex.Class70 - Decompiled by JODE
...
public final class Class70 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("cv.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    Class331 class331 = GameClient.aClass283_8716.method2675(-1611682495);
	    Interface3 interface3 = (Interface3) class331.method4031(i, i_7_, i_8_, 987531084);
	    if (null != interface3) {
		ObjectDefinitions class432 = (GameClient.aClass283_8716.method2641(-1178105216).getObjectDefinitions(interface3.method32((byte) 20)));
	    ...
	    interface3 = (Interface3) class331.method4035(i, i_7_, i_8_, GameClient.anInterface17_8960, -1880419927);
	    if (null != interface3) {
		ObjectDefinitions class432 = (GameClient.aClass283_8716.method2641(-258471564).getObjectDefinitions(interface3.method32((byte) -26)));
	    ...
	    if (null != interface3) {
		ObjectDefinitions class432 = (GameClient.aClass283_8716.method2641(541526744).getObjectDefinitions(interface3.method32((byte) 49)));
	...
	try {
		...
		return 0;
	    if (i_29_ < 3) {
		Class244 class244 = GameClient.aClass283_8716.method2654(1767942332);
		int i_31_ = i >> 9;
		int i_32_ = i_26_ >> 9;
		if (i_27_ < 0 || i_28_ < 0 || (i_27_ > GameClient.aClass283_8716.method2629(-1972690353) - 1) || i_28_ > GameClient.aClass283_8716.method2630(-61619148) - 1)
		    return 0;
		if (i_31_ < 1 || i_32_ < 1 || (i_31_ > GameClient.aClass283_8716.method2629(-1988640932) - 1) || (i_32_ > GameClient.aClass283_8716.method2630(-694658273) - 1))
		    return 0;
	    ...
	    return GameClient.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[i_29_].method6340(i, i_26_, -1371980258);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("cv.com.jagex.ja(").append(')').toString());
	}
    }
