package com.jagex;
/* com.jagex.Class461 - Decompiled by JODE
...
public class Class461 implements Iterable {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sz.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sz.com.jagex.a(").append(')').toString());
	}
    }
