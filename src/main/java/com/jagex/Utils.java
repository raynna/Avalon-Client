...
public class Utils {
	...
	hours -= days * 24;
	if (days > 0)
	    return days + "d:" + hours + "com.jagex.h:" + minutes + "com.jagex.m:" + seconds + "s";
	else if (hours > 0)
	    return hours + "com.jagex.h:" + minutes + "com.jagex.m:" + seconds + "s";
	else if (minutes > 0)
	    return minutes + "com.jagex.m:" + seconds + "s";
	return seconds + "s";
    }
	...
	Date date = new Date();
	SimpleDateFormat sdf = new SimpleDateFormat("hh:mm com.jagex.a");
