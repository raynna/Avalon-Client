package com.jagex;/* com.jagex.Class137_Sub1 - Decompiled by JODE
...
public class Class137_Sub1 extends Class137 {
	...
	try {
	    this.aClass123_6987 = aClass_ra_Sub3_1520.method5297("com.jagex.Model");
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("yg.com.jagex.m(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("yg.com.jagex.i(").append(')').toString());
	}
    }
