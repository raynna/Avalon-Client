package com.jagex;/* com.jagex.Class391 - Decompiled by JODE
...
public class Class391 {
	...
	try {
		...
		if (GameClient.Godswords && (animationId * -1945308871 == 11989 || animationId * -1945308871 == 11991 || animationId * -1945308871 == 12019 || animationId * -1945308871 == 7070)) //godsword delay
		    aBooleanArray4177 = null;
	    } else if (5 == i)
		anInt4178 = class298_sub53.readUnsignedByte() * -1501035895;
	    else if (6 == i) {
		int id = class298_sub53.readUnsignedShort();
		if (GameClient.Godswords && (id == 11694 || id == 11696 || id == 11698 || id == 11700))
		    id = 556718803;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qe.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qe.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    Class326 class326 = (GameClient.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3516[i][i_34_][i_35_]);
	    if (class326 == null)
		return null;
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qe.com.jagex.m(").append(')').toString());
	}
    }
}
