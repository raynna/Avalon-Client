package com.jagex;/* com.jagex.Class347 - Decompiled by JODE
...
public class Class347 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("om.com.jagex.a(").append(')').toString());
	}
    }
