package com.jagex;/* com.jagex.Class221 - Decompiled by JODE
...
public class Class221 implements Interface24 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jh.com.jagex.a(").append(')').toString());
	}
    }
