package com.jagex;/* com.jagex.Class120 - Decompiled by JODE
...
public class Class120 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ew.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ew.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		RsByteBuffer class298_sub53 = new RsByteBuffer(GameClient.aByteArray8843);
	...
	try {
		...
		if (i_20_ > 0 && i_21_ > 0 && i_20_ < GameClient.aClass283_8716.method2629(-1954958237) && i_21_ < GameClient.aClass283_8716.method2630(-1173220944)) {
		    int i_22_ = (Class287.myPlayer.plane);
		    if (i_22_ < 3 && ((GameClient.aClass283_8716.method2654(936952439).aByteArrayArrayArray2731[1][i_20_][i_21_]) & 0x2) != 0)
			i_22_++;
