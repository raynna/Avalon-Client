package com.jagex;/* com.jagex.Class_xa - Decompiled by JODE
...
public abstract class Class_xa {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("xa.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("xa.com.jagex.ja(").append(')').toString());
	}
    }
