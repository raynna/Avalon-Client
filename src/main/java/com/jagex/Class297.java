package com.jagex;/* com.jagex.Class297 - Decompiled by JODE
...
public class Class297 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("mj.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		if (i_20_ > 0) {
			...
			player.method4420(mark, damage, i_22_, i_24_, 443738891 * GameClient.ticketCycle, hitDelay, hpBarPercentage, (byte) 121);
		    }
		}
	    }
		...
		player.anInt10086 = (1208636921 * GameClient.ticketCycle + -1132907677 * player.anInt10087 + 1195117671 * player.anInt10088);
	    }
		...
		player.anInt10095 = (stream.readUnsignedShort() + GameClient.ticketCycle * 443738891) * 996079737;
		player.anInt10103 = (stream.readUnsignedShort() + GameClient.ticketCycle * 443738891) * 1000906529;
		...
		player.anInt10105 = ((443738891 * GameClient.ticketCycle + stream.readUnsignedShort()) * 1828453179);
		player.anInt10106 = ((GameClient.ticketCycle * 443738891 + stream.readUnsignedShort()) * -473408095);
	    }
	    if ((mask & 0x80000) != 0) {
