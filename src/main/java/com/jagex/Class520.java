package com.jagex;/* com.jagex.Class520 - Decompiled by JODE
...
public class Class520 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("vy.com.jagex.a(").append(')').toString());
	}
    }
}
