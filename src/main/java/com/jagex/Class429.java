package com.jagex;
/* com.jagex.Class429 - Decompiled by JODE
...
public class Class429 implements Interface21 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rt.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		GameClient.aClass105_8652 = Class140.method1558(-440872681 * class105.ihash, class105.anInt1154 * -1309843523, -156511736);
		Tradution.method6054(GameClient.aClass105_8652, 1608408687);
	...
	try {
	    ...
	    return GameClient.aClass25_8711;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (10 == Class301_Sub1.anInt7624 * -1289394455) {
			...
			if (!Class301.idx23.method2312(new StringBuilder().append(Class301.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), -2145213052))
			    return;
			Class301.aClass296_3235 = (WorldMap.getMapKeys(Class301.idx23, new StringBuilder().append(Class301.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), GameClient.isMemberWorld, 565671699));
		    } else
