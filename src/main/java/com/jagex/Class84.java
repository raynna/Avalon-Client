package com.jagex;/* com.jagex.Class84 - Decompiled by JODE
...
public class Class84 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("dk.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.COLOR_ID_PACKET, GameClient.aClass25_8711.aClass449_330, (byte) 54);
	    class298_sub36.out.writeShort(i_13_, 16711935);
	    GameClient.aClass25_8711.method390(class298_sub36, (byte) -99);
	}
	catch (RuntimeException runtimeexception) {
