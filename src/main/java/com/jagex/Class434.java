package com.jagex;/* com.jagex.Class434 - Decompiled by JODE
...
public class Class434 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ry.com.jagex.a(").append(')').toString());
	}
    }
