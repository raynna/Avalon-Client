package com.jagex;/* com.jagex.Class82_Sub19_Sub2 - Decompiled by JODE
...
public class Class82_Sub19_Sub2 extends Class82_Sub19 {
	...
	this.anInt9116 = class298_sub53.readUnsignedShort() * 467167843;
	this.anInt9117 = class298_sub53.readUnsignedByte() * 1155326505;
	this.anInt9115 = class298_sub53.readUnsignedShort() * 624790173;
    }

    static void method932(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[class403.anInt5239 * 681479919 - 2] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[class403.anInt5239 * 681479919 - 2]), 245040087).anIntArrayArray4017[(class403.anIntArray5244[class403.anInt5239 * 681479919 - 1])][1]);
