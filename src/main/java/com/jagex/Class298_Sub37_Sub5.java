package com.jagex;/* com.jagex.Class298_Sub37_Sub5 - Decompiled by JODE
...
public class Class298_Sub37_Sub5 extends Class298_Sub37 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aij.com.jagex.a(").append(')').toString());
	}
    }
