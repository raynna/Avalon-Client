package com.jagex;/* com.jagex.Class212 - Decompiled by JODE
...
public class Class212 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("iy.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("iy.com.jagex.i(").append(')').toString());
	}
    }
