package com.jagex;
/* com.jagex.Class298_Sub47 - Decompiled by JODE
...
public class Class298_Sub47 extends Class298 {
	...
	try {
		...
		if (class365_sub1_sub1_sub2_sub2 == Class287.myPlayer) {
		    if (GameClient.aBoolean8835 && (Class298.anInt3192 * -112110875 & 0x10) != 0)
			...
			String string_3_ = (GameClient.gametype == Class411.game_stellardawn ? (Tradution.aClass470_5928.method6049(Class321.aClass429_3357, -875414210)) : (Tradution.aClass470_5911.method6049(Class321.aClass429_3357, -875414210)));
		    ...
		    if (GameClient.aBoolean8835 && !bool && (-112110875 * Class298.anInt3192 & 0x8) != 0)
			...
			for (int i_4_ = 9; i_4_ >= 0; i_4_--) {
				...
				short i_5_ = 0;
				if ((GameClient.gametype == Class411.game_rs) && (GameClient.aStringArray8820[i_4_].equalsIgnoreCase(Tradution.aClass470_5906.method6049(Class321.aClass429_3357, -875414210)))) {
				    if (GameClient.aBoolean8815 && ((class365_sub1_sub1_sub2_sub2.anInt10206) * 696798311 > (Class287.myPlayer.anInt10206) * 696798311))
					i_5_ = (short) 2000;
				...
				Class234.method2174(GameClient.aStringArray8820[i_4_], new StringBuilder().append(Class285.method2709(16777215, -1822012281)).append(string).toString(), i_7_, i_6_, -1, 1888274983 * (class365_sub1_sub1_sub2_sub2.anInt10064), 0, 0, true, false, (class365_sub1_sub1_sub2_sub2.anInt10064) * 1888274983, false, -1451194858);
			    }
			}
		    } else
