package com.jagex;
/* com.jagex.Class419 - Decompiled by JODE
...
public class Class419 {
	...
	try {
		...
		try {
			...
			GameClient.qa_op = !GameClient.qa_op;
			Class255.method2435("Current value:" + GameClient.qa_op, 1394924823);
		...
		try {
			...
			if (0 == GameClient.anInt8752 * -1233866115)
			    ...
			    GameClient.aClass25_8711.aBoolean347 = true;
			return;
		    }
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.COMMANDS_PACKET, (GameClient.aClass25_8711.aClass449_330), (byte) 6);
			...
			GameClient.aClass25_8711.method390(class298_sub36, (byte) -55);
		    }
		}
		catch (Exception exception) {
