package com.jagex;
/* com.jagex.Class98 - Decompiled by JODE
...
public abstract class Class98 {
	...
	try {
		...
		if (GameClient.aClass283_8716.method2675(-1611682495) != null && (!GameClient.aBoolean8835 || (-112110875 * Class298.anInt3192 & 0x40) != 0)) {
		    int i_18_ = -1;
		    int i_19_ = -1;
			...
			if (i_32_ < 3 && ((GameClient.aClass283_8716.method2654(-86337284).aByteArrayArrayArray2731[1][i_30_ >> 9][i_31_ >> 9]) & 0x2) != 0)
			    i_32_++;
		    }
		    if (-1 != i_18_ && -1 != i_19_) {
			if (GameClient.aBoolean8835 && (-112110875 * Class298.anInt3192 & 0x40) != 0) {
			    IComponentDefinition class105 = Class140.method1558((Class379.anInt4099 * 1262526353), (392084321 * GameClient.anInt8836), -156511736);
			    if (class105 != null)
				Class234.method2174(GameClient.aString8838, new StringBuilder().append(" ").append(Class26.aString351).append(" ").toString(), Class240.anInt2704 * 697885143, 59, -1, 0L, i_18_, i_19_, true, false, i_18_ << 32 | i_19_, true, -1555484950);
			    else
			    ...
			    Class234.method2174(Class82_Sub6.aString6845, "", GameClient.anInt8822 * -1471730241, 23, -1, 0L, i_18_, i_19_, true, false, i_18_ << 32 | i_19_, true, -1114825452);
			}
		    }
		}
		Class324 class324 = (GameClient.aClass283_8716.method2675(-1611682495).aClass324_3528);
		int i_33_ = i;
		int i_34_ = i_14_;
		...
		while (iterator.hasNext()) {
			...
			if (class335.aClass365_Sub1_3616 instanceof Player) {
				...
				for (int i_41_ = 0; i_41_ < -1230451913 * GameClient.anInt8703; i_41_++) {
				    Class298_Sub29 class298_sub29 = ((Class298_Sub29) (GameClient.aClass437_8696.method5812(GameClient.anIntArray8699[i_41_])));
					...
					if (443738891 * GameClient.ticketCycle != (class365_sub1_sub1_sub2_sub1.anInt10070) * 335731285) {
						...
						if (i_43_ >= i_39_ && (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) <= ((class365_sub1_sub1_sub2_sub2.getSize()) - (i_43_ - i_39_ >> 9))) && i_44_ >= i_40_ && (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) <= ((class365_sub1_sub1_sub2_sub2.getSize()) - (i_44_ - i_40_ >> 9)))) {
						    ...
						    class365_sub1_sub1_sub2_sub1.anInt10070 = (-339947553 * GameClient.ticketCycle);
						}
					    }
					}
				    }
				...
				for (int i_46_ = 0; i_46_ < i_45_; i_46_++) {
				    Player class365_sub1_sub1_sub2_sub2_47_ = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_46_]]);
				    if ((null != class365_sub1_sub1_sub2_sub2_47_) && (443738891 * GameClient.ticketCycle != (335731285 * (class365_sub1_sub1_sub2_sub2_47_.anInt10070))) && (class365_sub1_sub1_sub2_sub2 != class365_sub1_sub1_sub2_sub2_47_)) {
					if (!class365_sub1_sub1_sub2_sub2_47_.aBoolean10123) {
						...
						class365_sub1_sub1_sub2_sub2_47_.anInt10070 = (GameClient.ticketCycle * -339947553);
					    }
					}
				    }
				}
			    }
			    if (443738891 * GameClient.ticketCycle == 335731285 * (class365_sub1_sub1_sub2_sub2.anInt10070)) {
				if (i_15_ == 202437353) {
				    /* empty */
				}
				continue;
			    ...
			    class365_sub1_sub1_sub2_sub2.anInt10070 = -339947553 * GameClient.ticketCycle;
			}
			if (class335.aClass365_Sub1_3616 instanceof NPC) {
				...
				if ((0 == ((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) & 0x1) && 0 == ((int) class217.aFloat2451 & 0x1ff) && (((int) class217.aFloat2454 & 0x1ff) == 0)) || (((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) & 0x1) == 1 && (((int) class217.aFloat2451 & 0x1ff) == 256) && (((int) class217.aFloat2454 & 0x1ff) == 256))) {
				    ...
				    for (int i_53_ = 0; (i_53_ < GameClient.anInt8703 * -1230451913); i_53_++) {
					Class298_Sub29 class298_sub29 = ((Class298_Sub29) (GameClient.aClass437_8696.method5812(GameClient.anIntArray8699[i_53_])));
					if (class298_sub29 == null) {
					    ...
					    if (((335731285 * (class365_sub1_sub1_sub2_sub1_54_.anInt10070)) != (GameClient.ticketCycle * 443738891)) && (class365_sub1_sub1_sub2_sub1_54_ != class365_sub1_sub1_sub2_sub1)) {
						if (!class365_sub1_sub1_sub2_sub1_54_.aBoolean10123) {
							...
							class365_sub1_sub1_sub2_sub1_54_.anInt10070 = (-339947553 * (GameClient.ticketCycle));
						    }
						}
					    }
					}
					...
					Player class365_sub1_sub1_sub2_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_59_]]);
					if ((null != class365_sub1_sub1_sub2_sub2) && ((335731285 * (class365_sub1_sub1_sub2_sub2.anInt10070)) != (GameClient.ticketCycle * 443738891))) {
				...
				if ((class365_sub1_sub1_sub2_sub1.anInt10070 * 335731285) == 443738891 * GameClient.ticketCycle) {
				    if (i_15_ == 202437353)
					throw new IllegalStateException();
				    continue;
				}
				Class140.method1555(class365_sub1_sub1_sub2_sub1, ((Class287.myPlayer.plane) != (class335.aClass365_Sub1_3616.plane)), (byte) -73);
				class365_sub1_sub1_sub2_sub1.anInt10070 = GameClient.ticketCycle * -339947553;
			    }
			}
			if (class335.aClass365_Sub1_3616 instanceof Class365_Sub1_Sub4_Sub1) {
			    ...
			    Class298_Sub2 class298_sub2 = ((Class298_Sub2) (GameClient.aClass437_8685.method5812((class335.aClass365_Sub1_3616.plane) << 28 | i_64_ << 14 | i_63_)));
			...
			if (class335.aClass365_Sub1_3616 instanceof Interface3) {
			    ...
			    ObjectDefinitions class432 = (GameClient.aClass283_8716.method2641(-151154213).getObjectDefinitions(interface3.method32((byte) 32)));
