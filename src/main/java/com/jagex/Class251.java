package com.jagex;/* com.jagex.Class251 - Decompiled by JODE
...
public class Class251 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("km.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.anInt8852 = ((class403.anIntArray5244[681479919 * class403.anInt5239 + 2]) * -2045228877);
	    GameClient.anInt8774 = (-546154255 * (class403.anIntArray5244[3 + 681479919 * class403.anInt5239]));
	...
	try {
	    int i_8_ = -933698717 * GameClient.anInt8784;
	    int i_9_ = 1036219865 * GameClient.anInt8785;
	    if (1 == GameClient.anInt8748 * -392325587) {
		Class57 class57 = (Class82_Sub11.aClass57Array6861[GameClient.anInt8786 * 1347929875 / 100]);
		class57.method645(i_8_ - 8, i_9_ - 8);
	    }
	    if (2 == GameClient.anInt8748 * -392325587) {
		Class57 class57 = (Class82_Sub11.aClass57Array6861[4 + GameClient.anInt8786 * 1347929875 / 100]);
		class57.method645(i_8_ - 8, i_9_ - 8);
	    }
	}
	catch (RuntimeException runtimeexception) {
