package com.jagex;/* com.jagex.Class298_Sub6 - Decompiled by JODE
...
public class Class298_Sub6 extends Class298 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aaj.com.jagex.a(").append(')').toString());
	}
    }
