...
public class ClientScriptMap {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tx.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tx.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    String string_14_ = new StringBuilder().append(GameClient.gametype.aString5317).append(".com").toString();
	    return new StringBuilder().append("http://").append(string).append(".").append(string_14_).append("/l=").append(Class321.aClass429_3357).append("/com.jagex.a=").append(GameClient.anInt8665 * -1154804873).append(string_13_).append("/").toString();
	}
	catch (RuntimeException runtimeexception) {
