package com.jagex;/* com.jagex.Class90 - Decompiled by JODE
...
public class Class90 {
    ...
    static final void method995(Class403 class403, int i) {
	try {
    ...
    static final void method996(Class403 class403, int i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub22_7586, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, 869927846);
    ...
    static final void method997(Class403 class403, int i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = Class372.method4589(i_1_, string, 955770805) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
