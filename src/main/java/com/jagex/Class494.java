package com.jagex;/* com.jagex.Class494 - Decompiled by JODE
...
public class Class494 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("uj.com.jagex.a(").append(')').toString());
	}
    }
