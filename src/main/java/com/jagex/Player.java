...
public class Player extends Entity {
	...
	try {
	    ...
	    if (Class242.aClass401_2708 == Class401.aClass401_6557 && 1806357379 * GameClient.playerRights >= 2)
		hidden = false;
		...
		if (1 != Class82_Sub18.aClass405_6892.anIntArray5267[i_6_]) {
			...
			if (firstShort >= 16384) {
			    firstShort -= 16384;
			    // firstShort = com.jagex.Class519.anIntArray6274[firstShort -
			    // 32768];
	    ...
	    if (GameClient.playerIndex * -442628795 == anInt10064 * 1888274983 && null != is_24_) {
	...
	try {
	    ...
	    if (this == Class287.myPlayer) {
		for (int i_30_ = GameClient.aClass19Array8869.length - 1; i_30_ >= 0; i_30_--) {
		    Class19 class19 = GameClient.aClass19Array8869[i_30_];
		    if (null != class19 && class19.anInt263 * 408071539 != -1) {
			if (958933333 * class19.anInt266 == 1) {
			    Class298_Sub29 class298_sub29 = ((Class298_Sub29) (GameClient.aClass437_8696.method5812(-841622081 * class19.anInt256)));
			...
			if (10 == class19.anInt266 * 958933333 && -841622081 * class19.anInt256 >= 0 && (-841622081 * class19.anInt256 < (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805).length)) {
			    Player class365_sub1_sub1_sub2_sub2_35_ = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[class19.anInt256 * -841622081]);
	    ...
	    anInt10066 = GameClient.anInt8777 * -815465993;
	    return class335;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    boolean bool = (0 != aByte10130 && 443738891 * GameClient.ticketCycle >= anInt10105 * 1920148979 && 443738891 * GameClient.ticketCycle < 1953154657 * anInt10106);
	    if (bool)
		i |= 0x80000;
	...
	try {
	    ...
	    anInt10221 = 1530078181;
	    if (i < 0 || i >= GameClient.aClass283_8716.method2629(-1987519551) || i_53_ < 0 || i_53_ >= GameClient.aClass283_8716.method2630(1479162339))
		method4472(i, i_53_, -2049230528);
	    else if (scenePositionXQueue[0] < 0 || (scenePositionXQueue[0] >= GameClient.aClass283_8716.method2629(-1906686754)) || scenePositionYQueue[0] < 0 || (scenePositionYQueue[0] >= GameClient.aClass283_8716.method2630(-964068282)))
	...
	try {
	    ...
	    class217.method2006();
	    if (this == Class287.myPlayer)
		GameClient.aClass283_8716.method2640((byte) 35).method4324(-1515011512);
	    if (null != this.aClass351_10067)
		this.aClass351_10067.method4220();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("akm.com.jagex.h(").append(')').toString());
	}
    }
	...
	if (this == Class287.myPlayer) {
	    for (int i_77_ = GameClient.aClass19Array8869.length - 1; i_77_ >= 0; i_77_--) {
		Class19 class19 = GameClient.aClass19Array8869[i_77_];
		if (null != class19 && class19.anInt263 * 408071539 != -1) {
		    if (958933333 * class19.anInt266 == 1) {
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) (GameClient.aClass437_8696.method5812(-841622081 * class19.anInt256)));
			if (null != class298_sub29) {
		    ...
		    if (10 == class19.anInt266 * 958933333 && -841622081 * class19.anInt256 >= 0 && (-841622081 * class19.anInt256 < (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805).length)) {
			Player class365_sub1_sub1_sub2_sub2_82_ = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[class19.anInt256 * -841622081]);
	...
	try {
		...
		if (null == (this.aClass62_10118).aString608)
		    return null;
		if (0 == GameClient.anInt8837 * -1168328513 || -1168328513 * GameClient.anInt8837 == 3 || (GameClient.anInt8837 * -1168328513 == 1 && Class494.method6192(aString10195, -1511804216)))
	...
	if (null != this.aClass62_10118) {
	    if (null == (this.aClass62_10118).aString608)
		return null;
	    if (0 == GameClient.anInt8837 * -1168328513 || -1168328513 * GameClient.anInt8837 == 3 || (GameClient.anInt8837 * -1168328513 == 1 && Class494.method6192(aString10195, -1800657283)))
		return this.aClass62_10118;
	}
	return null;
    }
