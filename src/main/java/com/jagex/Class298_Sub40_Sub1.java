package com.jagex;/* com.jagex.Class298_Sub40_Sub1 - Decompiled by JODE
...
public class Class298_Sub40_Sub1 extends Class298_Sub40 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("afd.com.jagex.a(").append(')').toString());
	}
    }
