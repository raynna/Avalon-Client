package com.jagex;/* com.jagex.Class431 - Decompiled by JODE
...
public class Class431 implements Interface15 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rv.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_15_] = null;
	    Class287.myPlayer = null;
	    for (int i_16_ = 0; i_16_ < 1962237353 * GameClient.anInt8772; i_16_++) {
		Entity class365_sub1_sub1_sub2 = ((Entity) GameClient.aClass298_Sub29Array8816[i_16_].anObject7366);
