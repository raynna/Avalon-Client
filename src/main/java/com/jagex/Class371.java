package com.jagex;/* com.jagex.Class371 - Decompiled by JODE
...
public class Class371 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pk.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    else if (GameClient.anInt8752 * -1233866115 == 11 || GameClient.anInt8752 * -1233866115 == 7)
	...
	try {
	    ...
	    GameClient.aShort8923 = (short) (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    if (GameClient.aShort8923 <= 0)
		GameClient.aShort8923 = (short) 256;
	    GameClient.aShort8931 = (short) (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]);
