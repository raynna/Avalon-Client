package com.jagex;
/* com.jagex.Class523 - Decompiled by JODE
...
final class Class523 implements Interface17 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("x.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    if (GameClient.aClass105_8850 == null && !Class436.aBoolean5478 && (null != class105 && Class419.method5603(class105, 1470456512))) {
		GameClient.aClass105_8850 = class105;
		GameClient.aClass105_8712 = Class331.method4063(class105, (byte) -122);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("x.com.jagex.i(").append(')').toString());
	}
    }
