package com.jagex;/* com.jagex.Class52_Sub1_Sub1 - Decompiled by JODE
...
public class Class52_Sub1_Sub1 extends Class52_Sub1 {
	...
	try {
	    ...
	    if (this == this.aClass_ra_Sub1_9052.method4992((short) 7140))
		method136();
	}
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aeu.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aeu.com.jagex.h(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    if (this == this.aClass_ra_Sub1_9052.method4992((short) -7778))
		method136();
	}
	catch (RuntimeException runtimeexception) {
	...
	if (this == this.aClass_ra_Sub1_9052.method4992((short) 22848))
	    method136();
    }
	...
	if (this == this.aClass_ra_Sub1_9052.method4992((short) 5099))
	    method136();
    }
	...
	if (this == this.aClass_ra_Sub1_9052.method4992((short) -335))
	    method136();
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aeu.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    class105.aBoolean1196 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) == 1;
