package com.jagex;/* com.jagex.Class252 - Decompiled by JODE
...
public class Class252 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kn.com.jagex.a(").append(')').toString());
	}
    }
