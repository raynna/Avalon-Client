package com.jagex;/* com.jagex.Class469 - Decompiled by JODE
...
public class Class469 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ti.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		class_ra.B(i_10_ - 150, i_11_ + 2, Class301_Sub1.anInt7624 * 426783931, 30, GameClient.aColorArray8689[745003679 * GameClient.anInt8971].getRGB(), 0);
		Class101.aClass264_1084.method2490(Tradution.aClass470_5938.method6049(Class321.aClass429_3357, -875414210), i_10_, i_11_ + i_9_, GameClient.aColorArray8691[GameClient.anInt8971 * 745003679].getRGB(), -1, -863370132);
	    } else {
