package com.jagex;/* com.jagex.Class292 - Decompiled by JODE
...
public class Class292 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("md.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    if (GameClient.qa_op && (GameClient.method2801(class105).anInt7416 * -1266165749 != 0 || 0 == class105.type * -1215239439)) {
