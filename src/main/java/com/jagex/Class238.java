package com.jagex;/* com.jagex.Class238 - Decompiled by JODE
...
final class Class238 implements Interface10 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("k.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("k.com.jagex.ba(").append(')').toString());
	}
    }
}
