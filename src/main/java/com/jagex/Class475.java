package com.jagex;/* com.jagex.Class475 - Decompiled by JODE
...
public class Class475 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("to.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    if (i_1_ == 0) {
		GameClient.aClass283_8716.method2643(null, 1496940593);
