package com.jagex;
/* com.jagex.Class350 - Decompiled by JODE
...
public class Class350 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("op.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		if (i_36_ == 80)
		    ...
		    Class8.aString101 = new StringBuilder().append(Class8.aString101.substring(0, -1182747927 * Class8.anInt99)).append(GameClient.anInterface16Array8710[i_35_].method217((byte) 9)).append(Class8.aString101.substring(Class8.anInt99 * -1182747927)).toString();
		    Class8.anInt99 += 1914783065;
		}
	    }
