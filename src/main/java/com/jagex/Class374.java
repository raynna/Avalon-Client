package com.jagex;
/* com.jagex.Class374 - Decompiled by JODE
...
public abstract class Class374 {
	...
	try {
		...
		if (class298_sub36 != null) {
		    ...
		    GameClient.aClass25_8711.method390(class298_sub36, (byte) -85);
		}
	    }
	    method4618((byte) 1);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("po.com.jagex.a(").append(')').toString());
	}
    }
