package com.jagex;
/* com.jagex.Class316 - Decompiled by JODE
...
public class Class316 implements Runnable {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ne.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ne.com.jagex.a(").append(')').toString());
	}
    }
