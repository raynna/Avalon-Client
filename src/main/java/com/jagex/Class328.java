package com.jagex;/* com.jagex.Class328 - Decompiled by JODE
...
public class Class328 {
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.playerIndex * -442628795;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("nr.com.jagex.a(").append(')').toString());
	}
    }
