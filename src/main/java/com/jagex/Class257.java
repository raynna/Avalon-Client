package com.jagex;/* com.jagex.Class257 - Decompiled by JODE
...
public class Class257 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("kt.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    Class95.method1033(GameClient.WINDOW_PANE_ID * -257444687, -2110394505 * Class462.anInt5683, Class298_Sub40_Sub9.anInt9716 * -1111710645, bool, 1828905535);
	}
	catch (RuntimeException runtimeexception) {
