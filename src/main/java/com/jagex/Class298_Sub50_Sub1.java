package com.jagex;/* com.jagex.Class298_Sub50_Sub1 - Decompiled by JODE
...
public final class Class298_Sub50_Sub1 extends Class298_Sub50 {
	...
	try {
	    return this.anInt9736 * -959647937;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ajn.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    return this.anInt9737 * 658623775;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return -660333015 * this.anInt9738;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return (this.aLong9739 * 3438655524500841893L);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ajn.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    return -1495835541 * this.anInt9740;
	}
	catch (RuntimeException runtimeexception) {
