package com.jagex;/* com.jagex.Class182 - Decompiled by JODE
...
public class Class182 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("hp.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
		...
		for (int i_21_ = 0; i_21_ < i_20_; i_21_++) {
		    Player class365_sub1_sub1_sub2_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_21_]]);
		...
		for (int i_22_ = 0; i_22_ < -1230451913 * GameClient.anInt8703; i_22_++) {
		    int i_23_ = GameClient.anIntArray8699[i_22_];
		    Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(i_23_));
