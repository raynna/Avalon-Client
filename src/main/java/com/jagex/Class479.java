package com.jagex;/* com.jagex.Class479 - Decompiled by JODE
...
public class Class479 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tt.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("tt.com.jagex.a(").append(')').toString());
	}
    }
