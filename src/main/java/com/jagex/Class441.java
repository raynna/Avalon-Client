package com.jagex;/* com.jagex.Class441 - Decompiled by JODE
...
public class Class441 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sf.com.jagex.a(").append(')').toString());
	}
    }
