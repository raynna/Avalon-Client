package com.jagex;/* com.jagex.Class24 - Decompiled by JODE
...
public class Class24 implements Interface8_Impl1_Impl1 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ay.com.jagex.a(").append(')').toString());
	}
    }
