package com.jagex;/* com.jagex.Class422_Sub4 - Decompiled by JODE
...
public class Class422_Sub4 extends Class422 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ade.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ade.com.jagex.i(").append(')').toString());
	}
    }
}
