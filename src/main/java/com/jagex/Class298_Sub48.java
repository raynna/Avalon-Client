package com.jagex;/* com.jagex.Class298_Sub48 - Decompiled by JODE
...
public class Class298_Sub48 extends Class298 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aco.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aco.com.jagex.a(").append(')').toString());
	}
    }
