package com.jagex;/* com.jagex.Class_ta_Sub2 - Decompiled by JODE
...
public class Class_ta_Sub2 extends Class_ta {
	...
	try {
	    ...
	    if (null != GameClient.aString8804 && i_4_ < Class489.anInt6071 * -1801543887)
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("wi.com.jagex.a(").append(')').toString());
	}
    }
}
