package com.jagex;/* com.jagex.Class411 - Decompiled by JODE
...
public class Class411 {
	...
	try {
		...
		GameClient.aClass437_8685.method5817(class298_sub2, l);
	...
	try {
		...
		if (null == class105) {
			...
			if (class105.aClass438_1152.method5822(((GameClient.anInt8961) * 614680345), 1675733273) && class105.aClass438_1152.method5832(1621670182))
	...
	try {
	    ...
	    for (int i_12_ = 0; i_12_ < GameClient.aClass19Array8869.length; i_12_++)
		GameClient.aClass19Array8869[i_12_] = null;
	    ...
	    GameClient.aFloat8949 = (int) (Math.random() * 160.0) - 80 & 0x3fff;
	    Class21.method369(1944021119);
	    for (int i_13_ = 0; i_13_ < 2048; i_13_++)
		GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_13_] = null;
	    Class287.myPlayer = null;
	    GameClient.anInt8703 = 0;
	    GameClient.anInt8772 = 0;
	    GameClient.aClass437_8696.method5811((byte) -7);
	    GameClient.aClass453_8824.method5943((byte) 1);
	    GameClient.aClass437_8825.method5811((byte) -106);
	    GameClient.aClass442_8650.method5869(585418023);
	    GameClient.aClass437_8685.method5811((byte) -42);
		...
		GameClient.GRAND_EXCHANGE_SLOTS[i_17_] = new Class251();
	    GameClient.aClass283_8716.method2640((byte) -46).method4324(-1196946367);
