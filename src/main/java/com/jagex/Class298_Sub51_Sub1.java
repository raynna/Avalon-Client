package com.jagex;/* com.jagex.Class298_Sub51_Sub1 - Decompiled by JODE
...
public class Class298_Sub51_Sub1 extends Interface {
	...
	Player class365_sub1_sub1_sub2_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[-517743867 * this.anInt9776]);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aje.com.jagex.a(").append(')').toString());
	}
    }
