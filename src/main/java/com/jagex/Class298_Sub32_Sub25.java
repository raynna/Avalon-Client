package com.jagex;/* com.jagex.Class298_Sub32_Sub25 - Decompiled by JODE
...
public class Class298_Sub32_Sub25 extends Class298_Sub32 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ahn.com.jagex.i(").append(')').toString());
	}
    }
