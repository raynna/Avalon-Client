...
public final class HashTable implements Iterable {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sa.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sa.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		if (i_9_ < 0) {
			...
			class365_sub1_sub1_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_23_]);
		} else {
		    int i_24_ = i_9_ - 1;
		    Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(i_24_));
	    ...
	    Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(GameClient.aClass283_8716.method2675(-1611682495), i, Class375.basePlane * -191892109, Class375.basePlane * -191892109, i_14_, i_15_, i_12_, GameClient.ticketCycle * 443738891 + i_18_, GameClient.ticketCycle * 443738891 + i_19_, i_20_, i_21_, i_9_, i_10_, i_13_, bool, i_11_));
	    class365_sub1_sub1_sub1.method4405(i_16_, i_17_, Class356.method4271(i_16_, i_17_, Class375.basePlane * -191892109, -968708982) - i_13_, 443738891 * GameClient.ticketCycle + i_18_, 1068285759);
