package com.jagex;
/* com.jagex.Class298_Sub50_Sub2 - Decompiled by JODE
...
public class Class298_Sub50_Sub2 extends Class298_Sub50 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ajw.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ajw.com.jagex.i(").append(')').toString());
	}
    }
