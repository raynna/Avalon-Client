package com.jagex;/* com.jagex.Class298_Sub32_Sub15 - Decompiled by JODE
...
public class Class298_Sub32_Sub15 extends Class298_Sub32 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ahd.com.jagex.i(").append(')').toString());
	}
    }
