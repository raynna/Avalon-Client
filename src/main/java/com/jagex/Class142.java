package com.jagex;/* com.jagex.Class142 - Decompiled by JODE
...
public class Class142 {
	...
	try {
		...
		if (3 != 1596783995 * GameClient.anInt8724) {
			...
			bool_6_ = true;
		} else if ((int) class217.aFloat2451 < 0 || ((int) class217.aFloat2451 >= GameClient.aClass283_8716.method2629(-2116251282) * 512) || (int) class217.aFloat2454 < 0 || ((int) class217.aFloat2454 >= (GameClient.aClass283_8716.method2630(978326552) * 512)))
		    bool_6_ = true;
		if (bool_6_)
		    Class373.aClass_ra4071.method5015(i, i_2_, i_3_, i_4_, -16777216, (byte) 7);
		else {
			...
			if (GameClient.aBooleanArray8684[i_16_]) {
			    int i_17_ = (int) ((Math.random() * (2 * (GameClient.anIntArray8860[i_16_]) + 1)) - (GameClient.anIntArray8860[i_16_]) + ((Math.sin((GameClient.anIntArray8790[i_16_]) * ((GameClient.anIntArray8926[i_16_]) / 100.0))) * (GameClient.anIntArray8925[i_16_])));
			    if (i_16_ == 0)
		    ...
		    if (Class367.anInt4000 * -1740717447 > ((GameClient.aClass283_8716.method2675(-1611682495).anInt3514) * 1988988347 << 9) - 1)
			Class367.anInt4000 = (((GameClient.aClass283_8716.method2675(-1611682495).anInt3514) * 1988988347 << 9) - 1) * 547882953;
		    if (-299812095 * Class146.anInt1575 < 0)
			Class146.anInt1575 = 0;
		    if (-299812095 * Class146.anInt1575 > ((GameClient.aClass283_8716.method2675(-1611682495).anInt3549) * 1340714547 << 9) - 1)
			Class146.anInt1575 = (((GameClient.aClass283_8716.method2675(-1611682495).anInt3549) * 1340714547 << 9) - 1) * 309839105;
		    ...
		    Class385 class385 = GameClient.aClass283_8716.method2640((byte) 15).method4316((byte) -16);
		    int i_18_ = class385.method4709(-461488593);
		    GameClient.aClass222_8871.method2062(-(Class367.anInt4000 * -1740717447), -(1449634147 * Class110.anInt6403), -(Class146.anInt1575 * -299812095));
		    ...
		    Class82_Sub7.method889(GameClient.aClass233_8658, true, i_3_ / 2, i_4_ / 2, -2134375937 * GameClient.anInt8940 << 1, -2134375937 * GameClient.anInt8940 << 1, i_3_, i_4_, 1807453020);
		    Class373.aClass_ra4071.method5182(GameClient.aClass233_8658);
			...
			class385.method4710((byte) -99).method2591(Class373.aClass_ra4071, Class163.anInt1685 * -1285178091 << 3, i, i_2_, i_3_, i_4_, GameClient.anInt8756 * -104436553, Class135.anInt6384 * -1847894591, Class229.anInt6458 * -1466297851, i_18_, true, false, (byte) -49);
		    } else
		    ...
		    GameClient.aClass283_8716.method2640((byte) -11).method4323(GameClient.aClass283_8716, -1036263435);
		    byte i_19_ = (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub17_7565.method5689(-2013953489) == 2 ? (byte) (-1953789277 * GameClient.anInt8777) : (byte) 1);
		    GameClient.aClass283_8716.method2675(-1611682495).method4040(GameClient.ticketCycle * 443738891, Class367.anInt4000 * -1740717447, 1449634147 * Class110.anInt6403, Class146.anInt1575 * -299812095, GameClient.aClass283_8716.method2642(1646760373), GameClient.anIntArray8793, GameClient.anIntArray8670, GameClient.anIntArray8795, GameClient.anIntArray8641, GameClient.anIntArray8797, 1 + (Class287.myPlayer.plane), i_19_, (int) class217.aFloat2451 >> 9, (int) class217.aFloat2454 >> 9, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub9_7555.method5655(2137164627) == 0, true, 0, true);
		    ...
		    GameClient.aClass283_8716.method2675(-1611682495).method4010(843420871);
		    ...
		    Class82_Sub7.method889(GameClient.aClass233_8658, false, i_3_ / 2 + i, i_4_ / 2 + i_2_, -2134375937 * GameClient.anInt8940 << 1, -2134375937 * GameClient.anInt8940 << 1, i_3_, i_4_, -725589740);
		    Class373.aClass_ra4071.method5182(GameClient.aClass233_8658);
