package com.jagex;
/* com.jagex.Class78 - Decompiled by JODE
...
public class Class78 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("dd.com.jagex.a(").append(')').toString());
	}
    }
  ...
  //else if (com.jagex.launcher.Loader.LOBBY_ENABLED && 264 == com.jagex.Class360.anInt3868 * -122629167)
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = GameClient.anIntArray8829[i_8_];
	}
	catch (RuntimeException runtimeexception) {
