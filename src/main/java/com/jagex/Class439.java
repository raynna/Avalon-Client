package com.jagex;/* com.jagex.Class439 - Decompiled by JODE
...
public final class Class439 {
	...
	try {
	    if (i != GameClient.anInt8752 * -1233866115) {
		GameClient.anInt8723 = 0;
		if (i == 5 || 13 == i)
		...
		if (19 == i)
		    Class501.method6227((8 == -1233866115 * GameClient.anInt8752 || -1233866115 * GameClient.anInt8752 == 2 || (747461259 * (HashTable.aClass371_5520.anInt4042) != (GameClient.WINDOW_PANE_ID * -257444687))), -1608675861);
		if (i == 14)
		    IcmpService_Sub1.method6382((GameClient.WINDOW_PANE_ID * -257444687 != (HashTable.aClass371_5520.anInt4031) * 1349088077), -687019075);
		if (i == 4 || 6 == i)
		    Class147.method1601((byte) -8);
		else if (3 == i || i == 18 && -1233866115 * GameClient.anInt8752 != 16)
		    Class473.method6070(1162411214);
		else if (i == 2)
		    Class70.method805((byte) 0);
		if (Class358.method4287(i, -1178041789)) {
		    GameClient.aClass283_8716.method2673((byte) 75);
		...
		boolean bool_8_ = (7 == -1233866115 * GameClient.anInt8752 || Class413.method5584(GameClient.anInt8752 * -1233866115, 2005988447) || Class299.method3682(-1233866115 * GameClient.anInt8752, 1765230881));
		if (bool != bool_8_) {
		    if (bool) {
		...
		GameClient.anInt8752 = -705702187 * i;
	    }
	}
	catch (RuntimeException runtimeexception) {
