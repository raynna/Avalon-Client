package com.jagex;/* com.jagex.Class82_Sub17 - Decompiled by JODE
...
public class Class82_Sub17 extends Class82 {
	...
	try {
	    ...
	    GameClient.aClass283_8716.method2667(732894181);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("yf.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    GameClient.anInt8837 = 1583527743 * (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    ...
	    GameClient.anInt8913 = (-1777248765 * (class403.anIntArray5244[2 + class403.anInt5239 * 681479919]));
	    ...
	    class298_sub36.out.writeByte(-1168328513 * GameClient.anInt8837);
	    class298_sub36.out.writeByte(1790024195 * Class110.aClass459_6404.anInt5673);
	    class298_sub36.out.writeByte(GameClient.anInt8913 * -1710848853);
