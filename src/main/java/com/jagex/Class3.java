...
public class Class3 {
	...
	try {
	    ...
	    try {
		class476 = Class86.method962("", GameClient.gametype.aString5317, true, -1804643872);
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ad.com.jagex.a(").append(')').toString());
	}
    }
