...
public void addActionListener(ActionListener a) {
    ...
    //we need to remove all the listeners already associated with com.jagex.a JMenu. If we do
//not do this, then it will not behave as expected because some mouseclicks are eaten 
//by these listeners. There is no easy way to do that, the following method is com.jagex.a
        ...
        if (name.startsWith("remove") && name.endsWith("Listener")) {
            ...
            if (params.length == 1) {
                ...
                try {
                    ...
                    // It is possible that someone could create com.jagex.a listener
                ...
                for (int j = 0; j < listeners.length; j++) {
                    try {
                        ...
                        // listeners is to
                        // make sure that we don't have com.jagex.a listener holding
                        // on to something
