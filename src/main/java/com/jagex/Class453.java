package com.jagex;
/* com.jagex.Class453 - Decompiled by JODE
...
public class Class453 implements Iterable, Collection {
    ...
    public void add(Class298 class298) {
		/*if (class298 instanceof com.jagex.ScriptEnvironment) {
			com.jagex.ScriptEnvironment e = (com.jagex.ScriptEnvironment) class298;
			if (e.arguements != null) {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sr.com.jagex.i(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("sr.com.jagex.a(").append(')').toString());
	}
    }
