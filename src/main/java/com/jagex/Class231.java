package com.jagex;
/* com.jagex.Class231 - Decompiled by JODE
...
public class Class231 {
	...
	try {
	    byte[][][] is = GameClient.aClass283_8716.method2642(1521051054);
	    if (is == null) {
		is = (new byte[4][GameClient.aClass283_8716.method2629(-1981468107)][GameClient.aClass283_8716.method2630(1256544033)]);
		GameClient.aClass283_8716.method2643(is, 1496940593);
	    }
	    for (int i_1_ = 0; i_1_ < 4; i_1_++) {
		for (int i_2_ = 0; i_2_ < GameClient.aClass283_8716.method2629(-2064419081); i_2_++) {
		    for (int i_3_ = 0; i_3_ < GameClient.aClass283_8716.method2630(764955570); i_3_++)
			is[i_1_][i_2_][i_3_] = i;
		}
	    }
	}
	...
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = GameClient.aStringArray8704[i_6_];
		if (GameClient.aStringArray8945[i_6_] != null)
		    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = GameClient.aStringArray8945[i_6_];
		else
