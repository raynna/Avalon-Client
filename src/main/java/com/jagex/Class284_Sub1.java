package com.jagex;
/* com.jagex.Class284_Sub1 - Decompiled by JODE
...
public class Class284_Sub1 extends Class284 {
	...
	if (this.aBoolean7145) {
	    ...
	    info = (new DataLine.Info(SourceDataLine.class, this.anAudioFormat7144, (this.anInt7143 * -975542179 << (aBoolean3047 ? 2 : 1))));
	...
	try {
		...
		this.aSourceDataLine7142.close();
		this.aSourceDataLine7142 = null;
		DataLine.Info info = (new DataLine.Info(SourceDataLine.class, this.anAudioFormat7144, (this.anInt7143 * -975542179 << (aBoolean3047 ? 2 : 1))));
		this.aSourceDataLine7142 = (SourceDataLine) AudioSystem.getLine(info);
		this.aSourceDataLine7142.open();
		this.aSourceDataLine7142.start();
	    }
	...
	try {
	    DataLine.Info info = (new DataLine.Info(SourceDataLine.class, this.anAudioFormat7144, i << (aBoolean3047 ? 2 : 1)));
	    this.aSourceDataLine7142 = (SourceDataLine) AudioSystem.getLine(info);
	    this.aSourceDataLine7142.open();
	    this.aSourceDataLine7142.start();
