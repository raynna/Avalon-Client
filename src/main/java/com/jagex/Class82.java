package com.jagex;/* com.jagex.Class82 - Decompiled by JODE
...
public abstract class Class82 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("di.com.jagex.i(").append(')').toString());
	}
    }
