package com.jagex;/* com.jagex.Class365_Sub1_Sub1_Sub1 - Decompiled by JODE
...
public class Class365_Sub1_Sub1_Sub1 extends Class365_Sub1_Sub1 {
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aka.com.jagex.a(").append(')').toString());
	}
    }
	...
	try {
		...
		if (0 != (this.anInt10043 * 132125965)) {
			...
			if (-442628795 * GameClient.playerIndex == i_6_)
			    ...
			    class365_sub1_sub1_sub2 = (GameClient.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_6_]);
		    } else {
			int i_7_ = ((132125965 * this.anInt10043) - 1);
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) GameClient.aClass437_8696.method5812(i_7_));
	...
	try {
		...
		this.aClass351_10061 = Class351.method4232(GameClient.ticketCycle * 443738891, true);
	    if (this.aClass351_10061 != null) {
		this.aClass351_10061.method4231(class_ra, 443738891 * GameClient.ticketCycle, class85s, class68s, false);
		this.aClass351_10061.method4227(plane, aShort9798, aShort9796, aShort9795, aShort9797);
	    }
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("aka.com.jagex.i(").append(')').toString());
	}
    }
