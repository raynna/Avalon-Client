...
public abstract class Class127 implements Interface6 {
    int anInt6371;
    Class243 aClass243_6372;
    Class264 aClass264_6373;
    Class243 aClass243_6374;
    Class128 aClass128_6375;
    long aLong6376;
    public static Class243 aClass243_6377;
	...
	boolean bool = true;
	if (!this.aClass243_6372.method2310(((this.aClass128_6375.anInt6329) * 955568089), -457216440))
	    bool = false;
	if (!this.aClass243_6374.method2310((955568089 * (this.aClass128_6375.anInt6329)), -457216440))
	    bool = false;
	return bool;
    }
	...
	try {
	    int i_4_ = ((this.aClass128_6375.aClass139_6322.method1545(-944287579 * this.aClass128_6375.anInt6326, client.anInt8794 * 775068819, -2137791831)) + this.aClass128_6375.anInt6327 * -39975161);
	    int i_5_ = ((this.aClass128_6375.aClass133_6323.method1482(-1387457793 * this.aClass128_6375.anInt6330, -791746413 * client.anInt8803, -1715218341)) + this.aClass128_6375.anInt6325 * 1886882435);
	    ...
	    if ((Class122.method1319((byte) 1) - this.aLong6376 * 109366757865047727L) > 10000L)
	    ...
	    this.aClass264_6373.method2490(string, (-944287579 * this.aClass128_6375.anInt6326 / 2 + i_4_), (4 + ((-1387457793 * this.aClass128_6375.anInt6330 / 2) + i_5_) + this.aClass128_6375.anInt6328 * -684094775), this.aClass128_6375.anInt6324 * 782326281, -1, -370673990);
	}
	catch (RuntimeException runtimeexception) {
	...
	int i = ((this.aClass128_6375.aClass139_6322.method1545(-944287579 * this.aClass128_6375.anInt6326, client.anInt8794 * 775068819, -1925244247)) + this.aClass128_6375.anInt6327 * -39975161);
	int i_8_ = ((this.aClass128_6375.aClass133_6323.method1482(-1387457793 * this.aClass128_6375.anInt6330, -791746413 * client.anInt8803, -1769429058)) + this.aClass128_6375.anInt6325 * 1886882435);
	...
	if ((Class122.method1319((byte) 1) - this.aLong6376 * 109366757865047727L) > 10000L)
	    string = new StringBuilder().append(string).append(" (").append((Class288_Sub1.aClass219_7147.method2034(-1233866115).anInt2548) * -861845079).append(")").toString();
	this.aClass264_6373.method2490(string, -944287579 * this.aClass128_6375.anInt6326 / 2 + i, (4 + (-1387457793 * this.aClass128_6375.anInt6330 / 2 + i_8_) + this.aClass128_6375.anInt6328 * -684094775), this.aClass128_6375.anInt6324 * 782326281, -1, -1547657926);
    }
    ...
    Class127(Class243 class243, Class243 class243_13_, Class128 class128) {
	...
	try {
		...
		if (i_17_ > i_15_) {
		    long l = (109366757865047727L * this.aLong6376 - Class288_Sub1.aClass219_7147.method2040(-2093041337));
		    if (l > 0L) {
			long l_18_ = (l * 10000L / i_15_ * (i_17_ - i_15_));
			long l_19_ = ((Class122.method1319((byte) 1) - (this.aLong6376 * 109366757865047727L)) * 10000L);
			if (l_19_ < l_18_)
			    i_16_ = (int) ((100L * (l_19_ * (i_17_ - i_15_)) / l_18_) + 100 * i_15_);
			else
			    i_16_ = 100 * i_17_;
		    }
		}
		...
		this.aLong6376 = Class122.method1319((byte) 1) * -1063467934392987569L;
	    }
	    return i_16_;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1419(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
    ...
    static final void method1420(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub28_7573.method5724(1673845033) == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1421(Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    int i_20_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_21_ = (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]);
    ...
    static final void method1422(Class403 class403, short i) {
	try {
	    int i_23_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = (GraphicsToolkit.aClass256_5315.method2441(i_23_, 1350033014).aString9596);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1423(IComponentDefinition class105, int i, int i_24_, int i_25_, Class403 class403, int i_26_) {
	try {
